...
const NdsAccordion = class {
    ...
    render() {
        return (index.h(index.Host, { key: '01da65448f862e6e2aef23d82f0a9ecec0d510a9', id: this.componentId, style: this.rootStyles }, index.h("div", { key: '26498f3440dcf8010eccef9d03f1de39c6afc194', class: `dga-accordion-item dga-accordion-item--${this.size} 
          ${this.iconAlignment === 'leading' ? 'dga-accordion-item--icon-leading' : ''}
          ${this.flush ? 'dga-accordion-item--flush' : ''} 
          ${this.disabled ? 'disabled' : ''} ${this.isOpen ? 'active' : ''}` }, index.h("a", { key: '89463b15a17fff7c413ca93be5beed71401306fa', href: "#", onClick: e => this.handleAccordionClick(e), onKeyDown: e => (e.code === 'Space' ? this.handleAccordionClick(e) : null), class: "dga-accordion-item__header" }, this.iconAlignment === 'leading' && (index.h("div", { key: 'cc327a709684754479df746837efb3e3e813fbb0', class: "dga-accordion-item__arrow" }, index.h("dga-icon-v2", { key: '6a139777ee444147cb2a02f6542931cae0950530', name: "arrow-down-01", variant: "stroke", size: 16 }))), index.h("div", { key: 'ec81a96af53a616e1237fc38090745273b723929', class: "dga-accordion-item__title" }, index.h("slot", { key: '4e146d1fa7e4f46c84167e1fa7899a357f2f7149', name: 'title' }, this.title)), this.iconAlignment === 'trailing' && (index.h("div", { key: '3f893e24982c7fecd310329f89aff527d1f038f4', class: "dga-accordion-item__arrow" }, index.h("dga-icon-v2", { key: '3fbb1dc4f48d11df13478772dbfefb4e431a4e4d', name: "arrow-down-01", variant: "stroke", size: 16 })))), index.h("div", { key: '56cdf6237caac665d27fd02901f544b2d5e7296e', ref: el => (this.bodyElement = el), class: "dga-accordion-item__body" }, index.h("slot", { key: '94220b0cf16cd8a25b20a495cd82d8b60ee50bc8', name: 'content' }, this.content)))));
    }
