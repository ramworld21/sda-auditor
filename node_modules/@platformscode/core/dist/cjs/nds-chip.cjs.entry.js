...
const NdsChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c9ac8c63367e77702f8a3ff6a565881e4fa39ae5', id: this.componentId, style: this.rootStyles }, index.h("span", { key: 'b804b9be70e18252633714ad50b18b551626b9d3', tabindex: "0", class: `chip chip--${this.variant} chip--${this.size} ${this.rounded ? 'chip--rounded' : ''} ${this.disabled ? 'disabled' : ''} ${this.pressed ? 'pressed' : ''} ${this.selected ? 'selected' : ''}`, onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), "aria-disabled": this.disabled, onClick: () => {
                if (this.selected) {
            ...
            } }, index.h("slot", { key: '0ee61f1aba69cca35b12ec96889a7dcdf45c584e', name: "trailing-icon" }, this.leadingIcon && (index.h("span", { key: 'eded2bc1768718e21ab54b1056fc20cb3d0da020', class: "chip-icon" }, index.h("dga-icon-v2", Object.assign({ key: 'fdef0481a5d0b000d62f994c3856cf5f2a9b3520', name: this.leadingIcon }, this.leadingIconProps))))), this.label, index.h("slot", { key: '6b8e4b82c7e0be4c63dc762f7bd2d81eec529c2e', name: "trailing-icon" }, this.trailingIcon && (index.h("span", { key: '3ad2c9f1662ccd97de7b9b83bb900f6633e82715', class: "chip-icon" }, index.h("dga-icon-v2", Object.assign({ key: '97c77c0877743e4fe13607d479665601282ef8b2', name: this.trailingIcon }, this.trailingIconProps))))))));
    }
