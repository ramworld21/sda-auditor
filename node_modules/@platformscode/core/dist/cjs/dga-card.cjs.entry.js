...
const DgaCard = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8261ba2914cdf2a5f75807c02cb6aa8a14a360db', id: this.componentId, style: this.rootStyles }, index.h("div", Object.assign({ key: '05520314bec93fd15322af30672a6e0e3b749d5b', class: `card dga-flex-column ${this.disabled ? 'disabled' : ''} ${this.isFocused ? 'focused' : ''} card--${this.effect}` }, (this.type === 'selectable' ? { onClick: this.onCheckboxChange } : {}), { tabIndex: 0 }), this.image && (index.h("div", { key: '2a636e776587b74671b8b0e66a07d70a2f477372', class: "card__image-container" }, index.h("img", { key: 'fec683586ffcad88bae4462c6c8feef916aceebd', src: this.image, alt: "Card" }))), this.showFeaturedIcon && (index.h("dga-featured-icon", { key: '5a6770039768c3e6f5f31366e3eabf1e9d48c3c3', icon: this.featuredIcon, size: 'lg' })), this.type === 'selectable' && (index.h("div", { key: 'eb0da9002baac0cef488cd86cf79bf5b14eb7684', class: "card__checkbox-container" }, index.h("dga-checkbox", { key: '1688b5c48ffe235a66b84c1b78f6d105e9bd79b9', checked: this.isSelected, color: "brand", onChange: this.onCheckboxChange }))), (this.showTitle || this.showDescription) && (index.h("div", { key: '53a67e1e526fcc9e00076bfebb77e2e39fbd07ef', class: "card__content-text dga-flex-column" }, this.showTitle && index.h("h4", { key: '99884fc68c04fac6b999a5487d4d955567e2c1f3', class: "text-lg-bold" }, this.cardTitle, " "), this.showDescription && index.h("p", { key: '181870477d9cb6fc68e7bfdadb3ab86c354224c0', class: "text-md-regular" }, this.description))), index.h("slot", { key: '53d408370d8a6b3ef08ac78c81acdbc0f0981857' }), this.type === 'default' && (this.showPrimaryAction || this.showSecondaryAction) && (index.h("div", { key: 'bbb70fa1fb8e4fe32eef311d5b610d93a457eb64', class: "card__action card__action--default" }, this.showSecondaryAction && index.h("dga-button", { key: 'b1d11e34257876fb1b3860a58853966dffe0a86f', label: this.secondaryActionLabel, onClick: this.onSecondaryAction, size: "lg", variant: "secondary-outline" }), this.showPrimaryAction && index.h("dga-button-v2", { key: '6784cd356f4de682fdb9113ad1f81fde11a959d9', label: this.primaryActionLabel, onClick: this.onPrimaryAction, size: "lg", variant: "primary" }))), this.type === 'expanded' && (index.h("div", { key: '57d9735c731eb75d904e23a3cc26235b8cc42019', class: "card__action card__action--expanded" }, index.h("dga-button-v2", { key: this.expanded ? 'expanded' : 'collapsed', iconOnly: true, onClick: () => this.toggleExpand(), size: "lg", variant: "subtle", leadIcon: true, leadIconProps: {
                name: this.expanded ? 'arrow-up-01' : 'arrow-down-01',
                variant: 'stroke',
                type: 'rounded',
            } }))), index.h("div", { key: '2ec837d8fc00d69d134e480a4ba38d583e3564b6', class: `collapse-content ${this.expanded ? 'expanded' : ''}` }, index.h("slot", { key: '1b5f1d9a5dd28ed4e86781a044336b20d1c033e9', name: "collapse-content" })))));
    }
