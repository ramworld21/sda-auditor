...
const DgaChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bf57c023e912b2faa134eaf9047841f7bc9c412f', id: this.componentId, style: this.rootStyles }, index.h("span", { key: '0eb4ef111e7946ccb7361ae3bd979bf81072511b', tabindex: "0", class: `chip chip--${this.variant} chip--${this.size} ${this.rounded ? 'chip--rounded' : ''} ${this.disabled ? 'disabled' : ''} ${this.pressed ? 'pressed' : ''} ${this.isSelected ? "selected" : ""}`, onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), "aria-disabled": this.disabled, onClick: () => {
                if (this.isSelected) {
            ...
            } }, this.leadIcon ? index.h("span", { class: "chip-icon" }, this.renderIcon(this.leadIcon, this.leadIconProps)) : '', this.label, this.trailIcon ? index.h("span", { class: "chip-icon" }, this.renderIcon(this.trailIcon, this.trailIconProps)) : '', index.h("slot", { key: '3368c8116e95a527cd3543d18310766f75d39bcc' }))));
    }
