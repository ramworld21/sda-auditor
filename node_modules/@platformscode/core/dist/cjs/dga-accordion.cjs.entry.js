...
const DgaAccordion = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6376b3dac9a7529b2960931863cdc8339040575e', id: this.componentId, style: this.rootStyles }, index.h("div", { key: '4904d52f5f08abfeca3ea89f4dd3b6df3843871c', class: `dga-accordion-item dga-accordion-item--${this.size} 
          ${this.iconAlignment === 'leading' ? 'dga-accordion-item--icon-leading' : ''}
          ${this.flush ? 'dga-accordion-item--flush' : ''} 
          ${this.disabled ? 'disabled' : ''} ${this.isOpen ? 'active' : ''}` }, index.h("a", { key: '6317d615256e04a50303ad1ae94f2fb7cd2b7bcd', href: "#", onClick: e => this.handleAccordionClick(e), onKeyDown: e => (e.code === 'Space' ? this.handleAccordionClick(e) : null), class: "dga-accordion-item__header" }, this.iconAlignment === 'leading' && (index.h("div", { key: '9e05866c91dd1694a1158bcc869ad82d93a0ceef', class: "dga-accordion-item__arrow" }, index.h("dga-icon", { key: 'a56ee196cc6d3f67392cb082f579756ebc08bfc2', icon: "arrow-down-01", variant: "stroke", size: 16 }))), index.h("div", { key: '4d6f5f96282015ca73ee41c51e2a1a1a6c7e1ca3', class: "dga-accordion-item__title" }, this.title), this.iconAlignment === 'trailing' && (index.h("div", { key: '09260dc3288a8498aa02260f3ab39383b257d3eb', class: "dga-accordion-item__arrow" }, index.h("dga-icon", { key: '8ad098fc1560a3793c006baaa4280a51aa5f90e6', icon: "arrow-down-01", variant: "stroke", size: 16 })))), index.h("div", { key: '31d794cf87f40610858ad84570a6eb6738ce93cc', ref: el => (this.bodyElement = el), class: "dga-accordion-item__body" }, this.content))));
    }
