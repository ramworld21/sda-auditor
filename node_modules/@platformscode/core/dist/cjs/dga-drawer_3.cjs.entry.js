...
const SidePanelMenu = class {
    ...
    render() {
        return (index.h("ul", { key: '8b2d550775b065135ab6588510c06543776420cd', class: "sidepanel__menu-list" }, this.routes.map((route, index$2) => (index.h("li", { key: index$1.guid() }, index.h("tab-component", { route: route }), index$2 < this.routes.length - 1 && (index.h("div", { class: "sidepanel__menu-tab-divider" })))))));
    }
};
...
const TabComponent = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '84a988c7773cc92055217d331addcfea4a9a7fae' }, index.h("tab-link", { key: '245a2ece23e2ae88473746f3ca43d155c732110a', text: this.route.name, type: this.route.children && this.route.children.length > 0 ? 'parent' : 'child', icon: this.route.icon, link: this.route.path, onExpand: this.handleExpanded.bind(this), disabled: this.route.disabled }), this.route.children && this.route.children.length > 0 && (index.h("ul", { key: '1f265c9a4c731351b3bc0ae85b8486156da08755', class: "sidepanel__submenu-list", ref: el => (this.submenuElement = el) }, this.route.children.map((childRoute, index$1) => (index.h("submenu-component", { key: index$1, route: this.route, childRoute: childRoute, onChildExpanded: expanded => {
                if (expanded) {
                    this.submenuElement.style.maxHeight = 'fit-content';
                }
            } })))))));
