...
const DgaGridUsage = class {
    ...
    render() {
        return (index.h("div", { key: '6f451f67fb4853d2c8785c09f34668e7a5280f98', class: "flexible-gap-usage", style: {
                display: 'flex',
                flexDirection: 'column',
                gap: '20px',
            } }, index.h("h2", { key: 'ca14e1fac659cd63223d2533af5e45c67a32a71a' }, "Grid Component with Flexible Gap Examples"), index.h("section", { key: '06ab77105c63da0422c0fca8313149d1d68e6773' }, index.h("h3", { key: '9622f7a9d5a37b1a7d2106d68368847b3b6f8ac1' }, "Simple String Gap"), index.h("dga-grid-container", { key: 'd9a1717a94a4523cd88a9d8b8289cdaf66a8ca23', gap: "16px" }, index.h("dga-grid-item", { key: 'd3d2081186a3d3809fcf210c5c0d5606f7f5d93d', xs: 12, sm: 6, md: 4 }, index.h("div", { key: '8dabea1575d4fb6ef4be5e33ce030132316739a6', class: "demo-content" }, "16px gap between all items")), index.h("dga-grid-item", { key: 'e3497bf25aa52b003ca6ae0d7309d71420e94b8d', xs: 12, sm: 6, md: 4 }, index.h("div", { key: 'b843487ccbe7e2cdc82ee61ce776a2715b60dd03', class: "demo-content" }, "16px gap between all items")), index.h("dga-grid-item", { key: '91bbbe993b7f8b482b8ed13dc779079fb9ffb49f', xs: 12, sm: 6, md: 4 }, index.h("div", { key: '937dd468e17f2e36da18768613199d4ea05bb083', class: "demo-content" }, "16px gap between all items")), index.h("dga-grid-item", { key: 'd51f3c30b52505b27be7dd59dd8210485a41e63d', xs: 12, sm: 6 }, index.h("div", { key: 'aea366da1bbb4eadd84e6dfca0f04c7b7b54bba2', class: "demo-content" }, "16px gap between all items")), index.h("dga-grid-item", { key: '331681e46175617c89adbcabf252bb29aefd8f35', xs: 12, sm: 6 }, index.h("div", { key: '7d5518f17374f7080070665b56593f9446376fd3', class: "demo-content" }, "16px gap between all items")), index.h("dga-grid-item", { key: '26672161c75e8bf12c70b7b5c65ae335d1659c74', xs: 12 }, index.h("div", { key: '7b22c99ff38e46449f28d3e60fee89263b6ea5e7', class: "demo-content" }, "16px gap between all items"))))));
    }
};
