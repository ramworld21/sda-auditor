...
const DgaSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3ad152e5f19cc466295ae461e52c890147c250fd', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, index.h("label", { key: 'f793423dbfdd8e8b15c2d7b5bf826722f66fc105', ref: el => (this.labelRef = el), class: `switch ${this.color ? `switch--${this.color}` : ''}`, onMouseDown: this.handleActive, onChange: this.handleRemoveActive }, index.h("div", { key: '844713ab78fe988e5dfca4b2f8e0662491560c0d', class: "switch-main" }, index.h("div", { key: '894ac6ec71f9ae9fe7e3aea234f3c365204602d4', class: `switch-main__content ${this.disabled ? 'disabled' : ''}` }, index.h("div", { key: 'd009fddbff1587071a53daa9867556d547d8c4fe', class: "switch-wrapper" }, index.h("input", { key: 'a33202a9703e80dd62a33f1c84075b0abd89238b', type: "checkbox", name: this.name, value: this.value, id: this.id, disabled: this.disabled, onFocus: this.handleFocus, onBlur: this.handleFocusOut, onChange: this.onChange, onInput: this.onInput, checked: this.isChecked }), index.h("span", { key: '77f7a22b0e0ffef81acec90eca5536ec5c50c856', class: `slider round ${this.isChecked ? 'slider--active' : 'slider--inactive'}` })), !this.hasHelperText && !this.helperText ? (this.label && index.h("span", { class: "switch__label" }, this.label)) : (index.h("div", { class: "dga-flex-column" }, index.h("span", { class: "switch__label" }, this.label), index.h("span", { class: "switch__helper-text" }, this.helperText)))), this.alertMessage && (index.h("div", { key: 'd1a5b8c0c211407aa7a125404204fefd2ea84151', class: "switch__warning" }, index.h("span", { key: '70a93128592211a2ae9b545f4b32698f6072bf46', class: "switch__warning-icon" }, index.h("svg", { key: '0664dccb388af471dad77ab764d34f70e291de70', width: "16", height: "16", viewBox: "0 0 16 16", fill: "none" }, index.h("path", { key: '1a44ce8c181244f3351ffec4eba873c99d396e72', d: "M8 1.33333C4.324 1.33333 1.33333 4.324 1.33333 8C1.33333 11.676 4.324 14.6667 8 14.6667C11.676 14.6667 14.6667 11.676 14.6667 8C14.6667 4.324 11.676 1.33333 8 1.33333ZM8 13.3333C5.05467 13.3333 2.66667 10.9453 2.66667 8C2.66667 5.05467 5.05467 2.66667 8 2.66667C10.9453 2.66667 13.3333 5.05467 13.3333 8C13.3333 10.9453 10.9453 13.3333 8 13.3333ZM7.33333 4H8.66667V8H7.33333V4ZM7.33333 9.33333H8.66667V10.6667H7.33333V9.33333Z", fill: "currentColor" }))), index.h("span", { key: 'b1ac2193040ce73d888e3a39d1179e953718710f', class: "switch__warning-text" }, this.alertText)))))));
    }
