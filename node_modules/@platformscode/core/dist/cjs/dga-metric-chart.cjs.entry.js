...
const DgaMetricChart = class {
    ...
    render() {
        ...
        return (index.h("svg", { key: '2ad9c2c0939a122d3e3c1e727e9f33fe52ecd376', width: this.width, height: this.height, viewBox: `0 0 ${this.width} ${this.height}` }, index.h("defs", { key: '1dcfbe63f895bf76d6a8e8e4e54c9b2d6fa9fafb' }, index.h("linearGradient", { key: 'c7461f4ddf4587d347f132523448a025f9b1a017', id: "areaGradient", x1: "0", x2: "0", y1: "0", y2: "1" }, index.h("stop", { key: 'fa5fc33dbe033170dc884c122e403ab4ec316093', offset: "0%", "stop-color": this.fillColor, "stop-opacity": "0.25" }), index.h("stop", { key: 'c234bf4bedd32b97edef1bb0e69d7b8ca7b3fd7f', offset: "100%", "stop-color": this.fillColor, "stop-opacity": "0" }))), index.h("path", { key: '85aca411c2c387929308fa2814f47b4ab5b02271', d: areaPath, fill: "url(#areaGradient)" }), index.h("path", { key: '28018df6b9951eef64277075d0686bfe51176f07', d: linePath, fill: "none", stroke: this.lineColor, "stroke-width": "2" }), this.showMarker && this.getPoints().map((point) => (index.h("circle", { cx: point.x, cy: point.y, r: "4", fill: "white", stroke: this.lineColor, "stroke-width": "2" })))));
    }
