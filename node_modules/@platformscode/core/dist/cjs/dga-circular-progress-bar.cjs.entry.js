...
const DgaCircularProgressBar = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '070667ec9a0e72631b65378bcaf9fb09d5cbbd7b', class: "circular-progress-bar", "aria-size": this.size, dir: this.RTL ? 'rtl' : 'ltr' }, index.h("div", { key: '859b2ecb05fd37c0aa30336796bbac9894ec14d8', class: "circular-progress-bar__label" }, this.variant === 'success' && index.h("i", { key: '07d34627d42e8456ec06b6d6ef531898f594698b', class: `circular-progress-bar__label--icon hgi-solid hgi-checkmark-circle-02` }), this.variant === 'error' && index.h("i", { key: '095e4483cad22d878d7a1b9df9be94163a457f9c', class: `circular-progress-bar__label--icon hgi-solid hgi-multiplication-sign-circle` }), this.variant !== 'success' && this.variant !== 'error' && index.h("h4", { key: '382ecb8376d1e099ec7566270971ca63efd66b60', class: "circular-progress-bar__label--percentage" }, this.percentage, "%"), this.text && index.h("h5", { key: '9e98c94452f6b00c9273725943aa0f438ced1331', class: `circular-progress-bar__label--text ${this.variant}` }, this.text)), index.h("svg", { key: '7c8f7542cd0488e2b6bb63f1859a28ebd532fb75', width: this.sizes[this.size], height: this.sizes[this.size], viewBox: `0 0 ${this.sizes[this.size]} ${this.sizes[this.size]}` }, index.h("circle", { key: 'e95f6b028bc5ec60d88d2421c42b5a9c5b1db098', class: "track", fill: "none", stroke: "#e6e6e6", r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth }), index.h("circle", { key: '941e34ca8d6f9ea3b1d67f4f3f27c79ca0218de0', class: `tail tail--${this.variant}`, fill: "none", stroke: "currentColor", r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth, "stroke-linecap": 'round', "stroke-dasharray": dashArray, "stroke-dashoffset": dashOffset, transform: `rotate(-180 ${this.sizes[this.size] / 2} ${this.sizes[this.size] / 2})`, style: {
