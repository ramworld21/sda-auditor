...
const CodeSnippet = class {
    ...
    render() {
        return (index.h("div", { key: 'd956081ad5e9447527e19bb54230239351be3591', class: "code-snippet-container" }, this.showTabList && (index.h("div", { key: 'cbaac6ed73b1d3a04afb33c19ee9bbe082403bbe', class: "code-snippet-tabs" }, index.h("dga-tabs", { key: '11e74c6f975da810bb4091a1db6b117f9acac275', divider: true, orientation: "horizontal", size: "lg", tabsList: Object.keys(this.snippets).map(tab => ({
                label: tab,
                onClick: () => this.handleTabClick(tab),
            })) }))), index.h("pre", { key: '72b752f74ca5b3dd3eb4f75a191102b48964d193', class: "code-snippet-code-display" }, index.h("dga-button-v2", { key: '07d7d58f13132c4a0dd5ab44bcf01b88bd857137', size: "lg", iconOnly: true, variant: 'subtle', leadIcon: true, leadIconProps: {
                name: 'copy-01',
                size: 24,
                color: '#161616',
                variant: 'stroke',
            }, class: `code-snippet-icon ${this.type}`, onClick: () => this.handleCopy(), onColor: false }), index.h("code", { key: '83ff0cc16564fe090046c18e128ca0c7a634716a', style: {
                height: this.showButton && this.type === 'multi-line' && !this.showMore ? '150px' : 'auto',
            } }, this.renderWithLineNumbers(this.snippets[this.activeTab])), this.showButton && this.type === 'multi-line' && (index.h("div", { key: '9d130a5dfaf6e51cd496ddc6e086b0c4f9ce55b5', class: "code-snippet-wrapper" }, index.h("dga-button-v2", { key: '84d734acb82a90cbcb7410bcf7f692ae89695207', label: this.showMore ? 'Show Less' : 'Show More', size: "md", trailIcon: true, variant: 'subtle', trailIconProps: { name: !this.showMore ? 'arrow-down-01' : 'arrow-up-01', size: 20, color: '#161616', variant: 'stroke' }, onClick: () => (this.showMore = !this.showMore), onColor: false }))))));
    }
};
