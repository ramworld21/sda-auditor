...
const DgaMenuGroup = class {
    ...
    render() {
        return (index.h("div", { key: '033cb49487c4fb3cc604e648c7b31e5361fe2204', class: "menu-group" }, this.groupLabel && index.h("span", { key: '3e76a316631d2c2c357c11665964f6b8041f3580', class: "menu-group__label" }, this.groupLabel), index.h("ul", { key: '04e3c873f501a23c4fb8361fd7032bd38634b0b8', class: "menu-group__items" }, index.h("slot", { key: '6136472d284b663587bbf234bda8f10414f53915' }))));
    }
};
...
const DgaMenuItem = class {
    ...
    render() {
        return (index.h("li", { key: 'e9e6ad78b0bb69ac64d7cedb4856811eb9d6e575', class: `menu-item ${this.disabled ? 'disabled' : ''} ${this.pressed ? "pressed" : ""}`, onMouseDown: () => this.pressed = true, onMouseUp: () => this.pressed = false, tabindex: "0", onClick: this.handleClick }, this.hasLeadIcon && index.h("span", { key: '6e24789a1b046f4b8bd05511324ff993c15fe985', class: "menu-item__icon" }, index.h("slot", { key: 'f895954faacba565b11d003a7c5b05766f632cbb', name: "lead-icon" })), index.h("span", { key: '872697fc273b3dc7243298d52a44c2a313efd88f', class: "menu-item__label" }, this.label), this.hasTrailElement && index.h("div", { key: '81c51a280440562f908e1e305049f1719a61c2e9', class: "menu-item__trail-element" }, index.h("slot", { key: 'fd7e1564b144f2fb5cb472e7b63e2b6bd8193349', name: "trail-element" }))));
    }
};
