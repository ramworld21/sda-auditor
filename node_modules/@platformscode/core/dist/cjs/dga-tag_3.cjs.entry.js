...
const DgaTag = class {
    ...
    render() {
        if (this.iconOnly)
            return (index.h(index.Host, { id: this.componentId, style: this.rootStyles }, index.h("span", { class: `tag tag--${this.variant} ${this.outlined ? `tag--${this.variant}-outlined` : ''} tag--${this.size} ${this.rounded ? 'tag--rounded' : ''}  tag--icon` }, this.leadIcon && index.h("span", { class: "tag-icon" }, index.h("dga-icon-v2", Object.assign({}, this.leadIcon))), !this.leadIcon && index.h("slot", null))));
        return (index.h(index.Host, { id: this.componentId, style: this.rootStyles }, index.h("span", { class: `tag tag--${this.variant} ${this.outlined ? `tag--${this.variant}-outlined` : ''} tag--${this.size} ${this.rounded ? 'tag--rounded' : ''}` }, this.leadIcon ? index.h("span", { class: "tag-icon" }, index.h("dga-icon-v2", Object.assign({}, this.leadIcon))) : '', this.label, this.trailIcon ? index.h("span", { class: "tag-icon" }, index.h("dga-icon-v2", Object.assign({}, this.trailIcon))) : '', index.h("slot", null))));
    }
...
const TabLink = class {
    ...
    render() {
        ...
        if (this.externalLink) {
            return (index.h("a", Object.assign({ href: this.link }, commonProps, { tabindex: "0" }), this.icon && index.h("span", { class: "sidepanel__menu-tab-icon" }, index.h("dga-icon-v2", Object.assign({}, this.icon))), index.h("span", { class: "sidepanel__menu-tab-label" }, this.text), this.type === 'parent' && (index.h("span", { class: "sidepanel__menu-tab-arrow" }, index.h("i", { class: "hgi-stroke hgi-arrow-down-01", style: { fontSize: '16px' } }), " ")), this.badge !== undefined && index.h("dga-tag", { color: this.onColor ? 'on-color' : 'gray', label: this.badge >= 100 ? '+99' : this.badge.toString(), size: "sm" })));
        }
        // Parent tab case
        if (this.type === 'parent') {
            console.log(this.icon, "this.iconthis.icon");
            return (index.h("a", Object.assign({ href: "#" }, commonProps, { onClick: e => this.toggleTab(e), tabindex: "0" }), this.icon && index.h("span", { class: "sidepanel__menu-tab-icon" }, index.h("dga-icon-v2", Object.assign({}, this.icon))), index.h("span", { class: "sidepanel__menu-tab-label" }, this.text), index.h("span", { class: "sidepanel__menu-tab-arrow" }, index.h("i", { class: "hgi-stroke hgi-arrow-down-01", style: { fontSize: '16px' } }), " "), this.badge !== undefined && index.h("dga-tag", { color: this.onColor ? 'on-color' : 'gray', label: this.badge >= 100 ? '+99' : this.badge.toString(), size: "sm" })));
        }
        // Child tab case (regular link)
        return (index.h("stencil-route-link", Object.assign({ url: this.link }, commonProps, { tabindex: "0" }), this.icon && index.h("span", { class: "sidepanel__menu-tab-icon" }, index.h("dga-icon-v2", Object.assign({}, this.icon))), index.h("span", { class: "sidepanel__menu-tab-label" }, this.text), this.badge !== undefined && index.h("dga-tag", { color: this.onColor ? 'on-color' : 'gray', label: this.badge >= 100 ? '+99' : this.badge.toString(), size: "sm" })));
    }
};
