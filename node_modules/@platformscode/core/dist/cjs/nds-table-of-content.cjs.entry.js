...
const NdsTableOfContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ec60e709c24321a2e1462e551fe1bf7bb3d9c534', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, index.h("aside", { key: 'b7ceec21f8bf9e1371d7889d370b2678b9349f25', class: `table-of-content ${this.rtl ? 'rtl' : ''}`, dir: this.rtl ? 'rtl' : 'ltr' }, index.h("div", { key: '52faf9412af2b39961a5925f6eca8c8b89c412d3', class: "table-of-content__header" }, index.h("p", { key: '1d12255adcd8a7242bab9f6470e9e4a557489275', class: "text-sm-regular" }, this.subTitle), index.h("h4", { key: 'ad1516cdaedb598c456a1175b17858fa8e028743', class: "text-xl-semibold" }, this.tocTitle)), index.h("div", { key: '590c6a19d801d25308c2b96140aeb2da9b4fd287', class: "table-of-content__body" }, index.h("ul", { key: '97d3def5821b47ebfc128da1ceb8a2a3c06da6d9', class: "table-of-content__tab-list" }, this.sections.map(tab => tab.Children ? (index.h("div", null, this.renderTab(tab), tab.Children.map(subTab => this.renderSubTabs(subTab)))) : (this.renderTab(tab))))))));
    }
