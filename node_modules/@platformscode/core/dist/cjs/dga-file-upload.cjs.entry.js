...
const DgaFileUpload = class {
    ...
    renderFile(file, index$1) {
        if (file.uploadStatus === 'error') {
            return (index.h("div", { class: "file-upload__file-item--error" }, index.h("div", { class: "file-upload__file-item" }, index.h("span", { class: "file-upload__file-status file-upload__file-status--error" }, index.h("i", { class: "hgi-solid hgi-alert-circle", style: { fontSize: "20px" } })), index.h("span", { class: "file-upload__file-name" }, file.name), index.h("button", { class: "btn btn--close btn--icon btn--sm", onClick: () => this.handleDeleteFile(index$1, file) }, index.h("span", { class: "btn-icon" }, index.h("i", { class: "hgi-stroke hgi-multiplication-sign", style: { fontSize: "20px" } })))), index.h("div", { class: "file-upload__file-item-msg" }, file.errorMessage ? file.errorMessage : 'Here goes the helper text.')));
        }
        return (index.h("div", { class: "file-upload__file-item" }, index.h("span", { class: `file-upload__file-status file-upload__file-status--${file.uploadStatus}` }, file.uploadStatus === 'uploading' && file.progress && index.h("dga-loading", { size: "tiny", variant: "neutral" }), file.uploadStatus === 'complete' && index.h("i", { class: 'hgi-solid hgi-checkmark-circle-02' })), index.h("span", { class: "file-upload__file-name" }, file.name), index.h("button", { class: "btn btn--close btn--icon btn--sm", onClick: () => this.handleDeleteFile(index$1, file) }, index.h("span", { class: "btn-icon" }, index.h("i", { class: "hgi-stroke hgi-multiplication-sign", style: { fontSize: "20px" } })))));
    }
    render() {
        return (index.h("div", { key: '354db699e2ca9a983d346ba99a4d3f62ffb1ffb9', class: `file-upload ${this.dragState ? 'file-upload--drag-over' : ''} ${this.disabled ? 'file-upload--disabled' : ''}` }, index.h("input", { key: 'bd0f9af9418fc728ce3e24664b5d9fb72baed9d9', type: "file", id: this.id, name: this.name, class: "file-upload__input", accept: this.accept, multiple: this.multiple, "aria-hidden": "true", onChange: this.handleFileSelection, ref: el => (this.fileInputRef = el) }), index.h("label", { key: '8d44991a59f4e4ca4f4f35721abf9a0289bf475d', htmlFor: this.id, class: "file-upload__drop-area" }, index.h("span", { key: '5b1c048c681bed8aa96c3b78fa36a068ce563fd0', class: "file-upload__icon" }, index.h("i", { key: '8db9cfe179a6f07a2488a97b773a8326943f6f27', class: "hgi-stroke hgi-file-upload", style: { fontSize: "20px" } })), index.h("div", { key: 'bd1584e0eaa583f9b65f1543c3788a4b19c231b1', class: "file-upload__content" }, index.h("p", { key: '0f63c39033091ffc4b4b76084b0a5cf857aa3387', class: "file-upload__instructions" }, this.title), index.h("p", { key: 'b9c895fd5c4295384a7b2dee8a676bea19ae4d9f', class: "file-upload__formats" }, this.fileTypesText)), index.h("button", { key: 'b23ed88d60bf16cf05393e55779e568ffb486bc5', class: "btn btn--md btn--secondary", "aria-label": "Browse Files", disabled: this.dragState || this.disabled, type: "button", onClick: () => { var _a; return (_a = this.fileInputRef) === null || _a === void 0 ? void 0 : _a.click(); } }, index.h("span", { key: '9839293615be1e0059def33533f540c3b5f06d8e' }, this.actionName))), index.h("div", { key: '856088f7656a35c90b4652cba90c67ecd26a2680', class: "file-upload__files-list" }, this.files.map((file, index) => this.renderFile(file, index)))));
    }
};
