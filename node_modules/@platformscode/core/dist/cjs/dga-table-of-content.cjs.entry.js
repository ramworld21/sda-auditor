...
const DgaTableOfContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'db353adc7d30b22d9bf9141c97256970f5999318', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, index.h("aside", { key: '88678c2a577cf7ca5db1c2da355fe0a98191cfc5', class: `table-of-content ${this.rtl ? 'rtl' : ''}`, dir: this.rtl ? 'rtl' : 'ltr' }, index.h("div", { key: '62276b99ad64048930d38c142ade4a87b1aa01d3', class: "table-of-content__header" }, index.h("p", { key: '231ea7500bed46ccd686243b9e3c3936b8f22929', class: "text-sm-regular" }, this.subTitle), index.h("h4", { key: 'cec37a15457518eab9a94ea34b0c652067218424', class: "text-xl-semibold" }, this.tocTitle)), index.h("div", { key: '105c24aae4ab6dbe00871b8f420458c9c48f0d5e', class: "table-of-content__body" }, index.h("ul", { key: 'f83bd1593c3f3f2e7a5eba3744f3ef77128552ad', class: "table-of-content__tab-list" }, this.sections.map(tab => tab.Children ? (index.h("div", null, this.renderTab(tab), tab.Children.map(subTab => this.renderSubTabs(subTab)))) : (this.renderTab(tab))))))));
    }
