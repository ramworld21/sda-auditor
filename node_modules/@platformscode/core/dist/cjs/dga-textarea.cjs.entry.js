...
const feedbackIconTypes = {
    success: index.h("dga-icon", { icon: "CheckmarkCircle02Icon", variant: "solid" }),
    error: index.h("dga-icon", { icon: "AlertCircleIcon", variant: "solid" }),
    warning: index.h("dga-icon", { icon: "Alert02Icon", variant: "solid" }),
};
