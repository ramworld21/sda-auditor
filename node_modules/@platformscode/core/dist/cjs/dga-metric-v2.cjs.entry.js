...
const DgaMetric = class {
    constructor(hostRef) {
        ...
        this.featuredIcon = (index.h("i", { class: "hgi-stroke hgi-trade-up", style: { fontSize: '24px' } })); // Default icon
        this.showChart = true;
        this.showInfo = true;
    ...
    render() {
        return (index.h("div", { key: '92f80e348eddf6327503dd72be758e986bd8d818', class: `dga-metric`, "data-chart-size": this.Style }, index.h("div", { key: 'd191341f2c90e6d8d1e74ba9684241d41d084452', class: "dga-metric__head" }, index.h("div", { key: 'e38708b84d90b6afd57422483e0891524ce808f5', class: "dga-metric__head-content" }, this.showFeaturedIcon && index.h("div", { key: '397573191ae6326cada9d62f6e99049c6039f92d', class: "featured-icon featured-icon--light-brand featured-icon--circle featured-icon--sm" }, this.featuredIcon), this.label && index.h("span", { key: 'e7567e64af718a8b2522e338fc58a52e8a4cef18', class: "dga-metric__head-content-text" }, this.label)), this.showMoreButton && (index.h("dga-button-v2", { key: 'd47e2879081664cdb8432be6c4d2fdcc6554c440', variant: "subtle", iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'more-vertical',
                variant: 'stroke',
                type: 'rounded',
            }, onClick: this.onExpandAction }))), index.h("div", { key: 'f76aae8b2469fe139a536947d23b3e6afac8cb26', class: "dga-metric__body" }, index.h("div", { key: 'e5465dc4e2aef6180dd23afca8cc82988ad6010f', class: "dga-metric__content" }, index.h("h3", { key: 'd95bd45f6b68481b928fb91bb5223c6cff8c7662', class: "dga-metric__content-percentage" }, this.percentage), this.showInfo && (index.h("div", { key: '62dd04ac0c119722e3d571454cea1810ba5d40de', class: "dga-metric__content-change", "data-change-trend": this.changeProps.trend }, index.h("span", { key: 'd105d122422f859d1a44791ef3d93fbc172695bf', class: "dga-metric__content-change-icon" }, index.h("dga-icon", { key: '59831e33c983da4b5d68ffc8e26928a8537bb157', icon: this.changeIcons[this.changeProps.type][this.changeProps.trend], type: "rounded", variant: "stroke", size: 24 })), index.h("span", { key: '556a0239acf65808167206f3dc462ab8972dc5da', class: "dga-metric__content-change-value" }, Math.abs(100), "%"), index.h("span", { key: '4759647f05f60abe60b8966853aeb05e16d14f93', class: "dga-metric__content-change-period" }, "vs last month")))), this.showChart && (index.h("div", { key: '2f6aab40ec57bdacd7f879485dce2137c99a26fd', class: "dga-metric__chart" }, index.h("dga-metric-chart", Object.assign({ key: 'b370efaa6a8932670c6f293e9344e94e9ab6f10e' }, this.chartProps, { size: this.Style === 'small-chart' ? 'sm' : 'lg' }))))), this.showActions && (index.h(index.Fragment, { key: '15ed5a73011ddac9fa76d01af1b8918ba68f4ce0' }, index.h("div", { key: '2d61a50e0eac7db19cc682a6426f9fcd118577b8', class: "dga-metric__divider" }), index.h("div", { key: '253604012bb6c5275503bd64648f745059bfa9d3', class: "dga-metric__actions" }, this.showSecondaryAction && (index.h("dga-button-v2", { key: 'ea87a7ad97a2e7d60f1f87df1a185bd8a79fdc5c', variant: "subtle", iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'settings-02',
                variant: 'stroke',
                type: 'rounded',
            }, onClick: this.onSecondaryAction })), index.h("dga-button-v2", { key: '1ca4e7d282609e5ee89fb8c75adbcdd83f09b1e8', variant: "secondary-outline", class: "dga-metric__actions--primary", label: "View Report", onClick: this.onPrimaryAction }))))));
    }
};
