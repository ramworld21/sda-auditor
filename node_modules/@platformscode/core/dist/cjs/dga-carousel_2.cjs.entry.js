...
const DgaCarousel = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'deb53f7aa2ed9c998b90d1d92874b923e0bc8f61', class: `KCarousel KCarousel--${this.variant} KCarousel--${this.size}`, dir: this.Dir }, this.variant !== 'dots-only' && (index.h("div", { key: '174a343f7a17428f6b2c807f9046bb310796f1cf', class: "KCarousel-body" }, this.variant === 'arrows' && (index.h("a", { key: '078d4e6c9b2c8b3f1d7e6b63970ee098a62f8d96', class: {
            ...
            }, onClick: () => this.changeSlide(this.DIRECTION.LEFT) }, index.h("dga-icon", { key: '8add7c7d5db123b77a2370f31df1b1cd77d8a245', icon: this.isRTL() ? 'arrow-right-01' : 'arrow-left-01', variant: "stroke", type: "rounded", size: 24 }))), index.h("div", { key: 'a33ba5ffc1f96fb8c3cb73969061b4fc23e16ee8', class: "KCarousel-container", style: { overflow: 'hidden', maxWidth: `${this.childWidth}px` } }, index.h("div", { key: '085cf45f315ac232d6365ab760362a0525a1448c', style: {
                display: 'flex',
                transition: `transform ${this.transitionDuration}ms ease-in-out`,
            }, class: "KCarousel-slides", ref: (el) => (this.slidesContainer = el) }, index.h("slot", { key: '34407b5227c2ae2270d6bdffb2c6c947a71a2790' }))), this.variant === 'arrows' && (index.h("a", { key: '34614a582c2cbc62664f0a015cf8fab6a3ea86ec', class: {
                'KCarousel-arrow': true,
                'KCarousel-arrow--active': this.showRightArrow(),
                [this.isRTL() ? 'left' : 'right']: true,
                [`KCarousel-arrow--${this.arrowsVariant}`]: true,
            }, onClick: () => this.changeSlide(this.DIRECTION.RIGHT) }, index.h("dga-icon", { key: '3af6a213320a9c57b6e72801a681d39b6585af3a', icon: this.isRTL() ? 'arrow-left-01' : 'arrow-right-01', variant: "stroke", type: "rounded", size: 24 }))))), ['dots', 'dots-only'].includes(this.variant) && (index.h("div", { key: '14caa543cfc882219849a5f1b00af5a863eb5c88', class: "KCarousel-dots" }, Array.from({ length: this.childrenLength }).map((_, index$1) => (index.h("span", { class: {
                'KCarousel-dot': true,
...
const CarouselItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8e5becd80d23f87ca5640613bb683d8fed840957' }, index.h("slot", { key: 'fa6c88d26750b613e565c1b236e1c04a4c754c4b' })));
    }
};
