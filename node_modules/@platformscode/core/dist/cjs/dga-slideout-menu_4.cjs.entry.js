...
const DgaSlideoutMenu = class {
    ...
    render() {
        return (index.h("div", { key: '98140cd1dbe34d38162faf7c6dd23fc6a2a3c452', class: `dga-slideout-menu dga-slideout-menu--${this.anchor} dga-slideout-menu--${this.backgroundColor} ${this.open ? "active" : ""}` }, index.h("slot", { key: 'baee78d547dbd06abcd81684a1f350b790bd4981', name: "slideout-menu-header" }), index.h("div", { key: '208c2b075354dd700841190ebc705ec0e1109afc', class: "dga-slideout-menu__body" }, index.h("div", { key: '8fcc135dd6cacafb3462940f3a6b0577b2538944', class: {
                'dga-slideout-menu__items': true,
                'dga-slideout-menu__items--hide-scrollbar': !this.scrollbar,
            } }, index.h("slot", { key: '4550a438c062d7061ca673affe726d30a0b02b44', name: "slideout-menu-items" })), index.h("dga-divider", { key: '5631f6f3b94b178394dd33275c7f5c962ee665d6' }), index.h("slot", { key: '1a19f53ef76f34957e68467b81a13b3fc5dc4681', name: "slideout-menu-actions" }))));
    }
...
const DgaSlideoutMenuActions = class {
    ...
    render() {
        return (index.h("div", { key: '65a60f471a4ab213f4c1c3dab9c7ef6b510a8829', class: "dga-slideout-menu__actions" }, index.h("slot", { key: '39e921a4c59466a815ae1c10b67148b2b0df77f4' })));
    }
};
...
const DgaSlideoutMenuHeader = class {
    ...
    render() {
        ...
        index.h("div", { key: '644974162d8b708862d95a5de7777aae6b3b8b86', class: "dga-slideout-menu__header" }, index.h("dga-featured-icon", { key: '0e17b150bed933e50780e4ac92e141126f2b8b60', icon: {
                name: 'add-circle',
                variant: 'stroke',
                type: 'standard',
            }, size: 'sm', color: 'brand', variant: 'light' }), index.h("dga-flex", { key: 'ae14285fdecd65e9e15b044ded49897c0284c9c3', direction: "column", spacing: 4, class: "dga-slideout-menu__header-content" }, index.h("h3", { key: '1f17b0aa3e39fd4cb5776853a8ce0603d23547de', class: "dga-slideout-menu__header-title" }, this.title), index.h("p", { key: 'eaa482126c0d3b51120e99bb80d4754b2836ac0e', class: "dga-slideout-menu__header-description" }, this.description)), index.h("dga-button-v2", { key: '2565bbfc3ec38da30aa43571eb462a00a12f28cd', iconOnly: true, leadIcon: true, leadIconProps: {
...
const DgaSlideoutMenuItems = class {
    ...
    render() {
        return (index.h(index.Host, { key: '39b333416ece26616362d3a5d02d39ae1853ed8d' }, index.h("slot", { key: '0c5bfc89d412375c136bd7493755de61663b0215' })));
    }
};
