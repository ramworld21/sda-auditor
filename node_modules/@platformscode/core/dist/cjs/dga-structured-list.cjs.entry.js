...
const DgaStructuredList = class {
    ...
    render() {
        return (index.h("div", { key: '6625ecac9ef78d57cac9ccaf43a6da0446b73f2d', class: `table-wrapper ${this.contained ? 'table-contained' : ''}` }, index.h("table", { key: '0e0df97cffe6f200a61655b1d693a68fc4536d30', class: `azm-structured-table ${this.contained ? 'table-contained' : ''}`, style: { direction: this.direction ? 'rtl' : 'ltr' } }, index.h("thead", { key: '5da7eed1eabbcea929925f0a225def3cbd043590' }, index.h("tr", { key: '31f990b5191727dbcf4b2a0fe0c52dbffbb27228', class: `${this.rowDivider ? 'row-divider' : ''}` }, this.cells.map(({ title }, index$1) => (index.h("th", { key: index$1 }, title))))), index.h("tbody", { key: '2a36258b3a5d14be0c9fa06d2726f7ae9d9dd8bb' }, this.sortedData.map((row, rowIndex) => (index.h("tr", { class: `${this.rowDivider ? 'row-divider' : ''} ${this.alternate ? 'alternate' : ''}`, key: rowIndex }, this.cells.map(({ El, customAttribute, propertyName, type, colSpan }, cellIndex) => (index.h("td", Object.assign({ key: cellIndex, colSpan: colSpan || 1 }, ((customAttribute === null || customAttribute === void 0 ? void 0 : customAttribute.key) && {
