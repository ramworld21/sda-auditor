...
const DgaProgressIndicator = class {
    ...
    render() {
        return (index.h("div", { key: '9aac6756fbcd96576c6fa53e1b65fa41cb71e2ac', class: "progress-indicator dga-flex", "data-alignment": this.alignment, "data-progress-key": this.componentKey }, index.h("slot", { key: '8ab20e00781e8adbdd500dc66c777accede2cb6a', name: 'progress-indicator-step' })));
    }
...
const DgaProgressIndicatorStep = class {
    ...
    render() {
        return (index.h("div", { key: 'aa2b391709be61ff1473bcb8f93fdb63f4a36fad', class: "progress-indicator__step", onMouseDown: this.handleFocus, onMouseUp: this.handleFocusOut }, index.h("div", { key: '5ba08654a25a057153ae10d3184d98f731037747', class: "progress-indicator__step-content dga-flex-column", ref: el => (this.stepContentRef = el) }, index.h("div", { key: '05a7c51dd95dbacac231ce7074d19af8e0c3f99d', class: "step-label", "data-state": this.labelState }, index.h("span", { key: 'a4cdc98da09dd99d27d3a8fb264902b1d2b1e4ab', class: `step-label--${this.labelStyle}` }, this.labelStyle === 'circle' && this.labelChildren(this.currentStep))), index.h("div", { key: '1b0337ecc12a3a7b8f8ab69257eb021d0f2492aa', class: "step-text dga-flex-column" }, this.showStepName && index.h("span", { key: '9ce21a3e31430c593f0fdcd7a3bd9fd5a32a91f4', class: this.isActive ? 'text-md-medium' : 'text-md-regular' }, this.title), this.showStepDescription && index.h("p", { key: '6b766b90fe43b6e5c31fd1a5d073a4876ea68ba3', class: "text-sm-regular" }, this.description))), this.nextStep && index.h("span", { key: '3ea208356da35d3ce26ef659d676ad4ae793dc5c', class: `progress-indicator__step-connector ${this.isActive ? 'progress-indicator__step-connector--active' : ''}` })));
    }
    get el() { return index.getElement(this); }
};
