...
const DgaTabs = class {
    ...
    renderIcon(iconName, iconProps) {
        return index.h("dga-icon", Object.assign({ icon: iconName }, iconProps));
    }
    handleSxChange() {
        this.processStyling();
    }
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'd4c100a858f343767cd42f74b835ac552700cc9e', id: this.componentId, style: this.rootStyles }, index.h("ul", { key: '9d5137ce2f4db4b7289fedebe5c832c63cb634d5', class: `dga-tabs-list dga-tabs-list--${this.orientation} ${this.divider ? 'dga-tabs-list--divider' : ''} ${this.flush ? 'flush' : ''} ${this.extraClass}` }, (_a = this.tabsList) === null || _a === void 0 ? void 0 :
            _a.slice(0, 5).map((tab, index$1) => (index.h("li", { key: index$1 }, this.external ? (index.h("a", { href: tab.link, class: `dga-tabs-list__item dga-tabs-list__item--${this.size} ${this.activeTab === index$1 ? 'dga-tabs-list__item--active' : ''} ${this.disabled ? 'disabled' : ''}`, onClick: e => {
                ...
                } }, (tab === null || tab === void 0 ? void 0 : tab.tabIcon) && index.h("div", { class: "dga-tabs-list__icon" }, this.renderIcon(tab === null || tab === void 0 ? void 0 : tab.tabIcon, tab === null || tab === void 0 ? void 0 : tab.iconProps)), index.h("div", { class: "dga-tabs-list__label" }, tab === null || tab === void 0 ? void 0 : tab.label)))))), this.orientation === 'horizontal' && this.tabsList.length > 5 && (index.h("li", { key: '684ca170c27a46a3b2422b36b3cad03cef234e64', class: "breadcrumb-item ellipsis" }, index.h("dga-button", { key: 'f5b8de44990bebdd771a29ab3ffaac0dc22f7b56', iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'MoreHorizontalCircle01Icon',
                size: 17,
                variant: 'solid',
            }, label: "Button", onClick: () => {
                this.toggleMenu();
            }, size: "md", variant: "subtle", disabled: this.disabled, "aria-haspopup": "true", "aria-expanded": this.isMenuOpen ? 'true' : 'false' }), this.isMenuOpen && (index.h("div", { key: 'ef2d0d35f9171d84b880cb90fa91e372716bda3f', class: "breadcrumb-dropdown" }, index.h("dga-tabs", { key: '6a199bd9259938abca01a8197677b020bab03788', size: "md", orientation: "vertical",
            // tabIcons: true,
