...
const DgaMenu = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '69bdc2e98bd65dfd11de009b1c1b3f514fee4dfa' }, this.open && this.anchorEl && (index.h("ul", { key: 'fafbdec7bf4ef68b4d79fb54d38883260665e154', class: "menu", style: this.getMenuStyle() }, index.h("slot", { key: '6fb989d29109ac200f53ff8a2d3ec7069797b702' })))));
    }
};

exports.dga_menu = DgaMenu;
