...
const NdsButton = class {
    ...
    render() {
        const classList = [
            ...
            .filter(Boolean)
            .join(' ');
        return (index.h(index.Host, { key: 'ebeca4f28c5a87c301e042905ee18a8b7d2f1505' }, index.h("button", { key: 'c8a81ce9af113d22cefa6d3ed91f42420f550aa7', type: this.type, class: classList, disabled: this.disabled, "aria-label": this.iconOnly && !this.label ? 'Button with icon' : this.label, role: "button", onClick: (event) => this.handleClick(event) }, index.h("slot", { key: '1d1914fd2c34fe48d2ecf553741d998307b9cda0', name: "leading-icon" }, this.leadingIcon && (index.h("span", { key: 'a506a68366aed76e4845e925f8c6ff12728b292f', class: "dga-btn-icon", "aria-hidden": "true" }, index.h("dga-icon-v2", Object.assign({ key: '4624ec4a6677859d58af5780813252c3bec862a8', name: this.leadingIcon }, this.leadingIconProps))))), !this.iconOnly && this.label && index.h(index.Fragment, { key: '4125fe9858186548c7f312973f9f4d5303c61b95' }, this.label), !this.iconOnly && (index.h("slot", { key: '07d5f692f6544da8c8a9b6bb6ce929d2df0ac4d2', name: 'trailing-icon' }, this.trailingIcon && (index.h("span", { key: 'f36a401adee0d7e43edb388f7c3d824e59659d8c', class: "dga-btn-icon", "aria-hidden": "true" }, index.h("dga-icon-v2", Object.assign({ key: 'b2efa2738efd2ce49f1557facd34dd59b539199c', name: this.trailingIcon }, this.trailingIconProps)))))))));
    }
