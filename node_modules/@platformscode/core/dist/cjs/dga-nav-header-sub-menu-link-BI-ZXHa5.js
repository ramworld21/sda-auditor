...
const DgaNavHeaderSubMenuColumn = class {
    ...
    render() {
        return (index.h("div", { key: 'c177b87c9075cf517d169d395374009c0c357d42', class: "sub-menu__column" }, this.label && index.h("h2", { key: '642af1dea89f17c70a2e83112ad365110158f017', class: "sub-menu__column__label" }, this.label), index.h("slot", { key: '6432d519aa14e1f87c0ad2b164c1f90538ab6af6' })));
    }
};
...
const DgaNavHeaderSubMenuLink = class {
    ...
    render() {
        ...
        return (index.h("a", { key: '7d3b7916fd803bc5010fab6b5b3fd95178d93e63', href: this.link, class: `sub-menu__link ${backgroundClass}` }, this.linkStyle && this.linkStyle > 0 ? index.h("div", { class: linkStyleClass }, this.icon && index.h("dga-icon", { icon: this.icon })) : null, index.h("div", { key: '69a8ab3f28e6a7260a7856210033a0d7b153aad9', class: "dga-flex-column" }, index.h("span", { key: '8037b4f170a9183b0e2c07baa4537a3d2c9d79b9', class: "sub-menu__link-label" }, this.label), this.helperText && index.h("span", { key: '73773999026ab6fedfde5ce9a2331323b3518aa8', class: "sub-menu__link-helper" }, this.helperText))));
    }
};
