...
const DgaBreadcrumbs = class {
    ...
    getArrowIcon() {
        const isRTL = rtlUtils.isElementRTL(this.el);
        return isRTL ? 'ArrowLeft01Icon' : 'ArrowRight01Icon';
    }
    render() {
        return (index.h(index.Host, { key: 'f70c3caf028d192593c4ab2b30a71a91d10a7f89', id: this.componentId, style: this.rootStyles }, index.h("nav", { key: '91dcb806dda0eab30c97394d658843c52cf5e8f1', "aria-label": "breadcrumb" }, index.h("ul", { key: '66cf48985443b0da2f1d2c0bfd6cd47aa0e1956e', class: "dga-breadcrumb" }, this.breadcrumbItems.map((item, index$1) => {
            if (this.isEllipsisItem(item)) {
                return (index.h("li", { key: index$1, class: "dga-breadcrumb-item ellipsis" }, index.h("span", { class: "dga-breadcrumb-icon" }, index.h("dga-icon", { icon: this.getArrowIcon(), variant: "stroke", type: "rounded" })), index.h("a", { onClick: () => {
                        this.toggleMenu();
                        return false;
            ...
            return (index.h("li", { key: index$1, class: {
                    ...
                    'active': isLastItem,
                }, "aria-current": isLastItem ? 'page' : undefined }, item.path && !isLastItem ? (index.h(index.Fragment, null, !first && (index.h("span", { class: "dga-breadcrumb-icon" }, index.h("dga-icon", { icon: this.getArrowIcon(), variant: "stroke", type: "rounded" }))), index.h("a", { onClick: e => this.handleClick(e, item.path, item), class: {
                    'link link--md link--neutral': true,
                    'disabled-link': item.disabled,
                }, href: item.disabled ? undefined : item.path, "aria-disabled": item.disabled ? 'true' : 'false' }, index.h("span", { class: "link__label" }, item.label)))) : (index.h(index.Fragment, null, index.h("span", { class: "dga-breadcrumb-icon" }, index.h("dga-icon", { icon: this.getArrowIcon(), variant: "stroke", type: "rounded" })), index.h("a", { onClick: e => this.handleClick(e, item.path, item), class: {
                    'link link--md link--neutral': true,
                    'disabled-link': item.disabled,
                    'link_empty': true,
