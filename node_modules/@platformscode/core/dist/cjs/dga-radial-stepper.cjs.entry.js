...
const DgaRadialStepper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '64ed9b018cc60a6df620a01c6407ed0b91fb386f' }, index.h("dga-flex", { key: '6e97c1979c02957f59c8e7648de03997e264e71d', spacing: 8, align: 'center', dir: this.RTL ? "rtl" : "ltr", class: `dga-radial-stepper--${this.size} dga-radial-stepper--${this.variant}`, "aria-size": this.size }, index.h("div", { key: '0bdc1f4abc89c6b9db6d6cafb7ae39033fae9be6', class: "dga-circular-stepper", "aria-size": this.size }, index.h("div", { key: 'd1b21815ead4687ea17e1d191bb8c6fb7ecd21d0', class: "dga-circular-stepper__label" }, this.showText && this.steps.length > 0 && index.h("h4", { key: '71e155fc8b6dd10065a6bfdda2065f4da2a105d5', class: `dga-circular-stepper__label--text ${this.variant}` }, this.RTL ? `${this.internalActiveStep} من ${this.steps.length}` : `${this.internalActiveStep} of ${this.steps.length}`)), index.h("svg", { key: 'ba0e123d3016ad6e29bb19cb781c6dd2d4f46c42', width: this.sizes[this.size], height: this.sizes[this.size], viewBox: `0 0 ${this.sizes[this.size]} ${this.sizes[this.size]}` }, index.h("circle", { key: 'fab4d864d6e356192c329e5f53304e0ce0cbb063', class: `track track--${this.variant}`, fill: "none", stroke: "#e6e6e6",
            // stroke="currentColor"
            r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth }), index.h("circle", { key: '19b203de05f2ef9051437a6f74fefbfe45c38928', class: `tail tail--${this.variant}`, fill: "none", stroke: "currentColor", r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth, "stroke-linecap": 'round', "stroke-dasharray": dashArray, "stroke-dashoffset": dashOffset, transform: `rotate(-90 ${this.sizes[this.size] / 2} ${this.sizes[this.size] / 2})`, style: {
                transition: 'stroke-dashoffset 0.5s ease',
            } }))), index.h("dga-flex", { key: '85b855c467c5418e95b6ebf94e143e7e29b48723', direction: 'column', spacing: 4 }, ((_a = this.steps[this.internalActiveStep - 1]) === null || _a === void 0 ? void 0 : _a.showPreStep) && index.h("span", { key: '88fe0e0bb5265377a581517c98cc9bdc6b2337a1', class: "dga-radial-stepper__pre-name" }, "Previous: ", (_b = this.steps[this.internalActiveStep - 1]) === null || _b === void 0 ? void 0 :
            _b.stepName), this.showStepName && ((_c = this.steps[this.internalActiveStep - 1]) === null || _c === void 0 ? void 0 : _c.stepName) && index.h("h3", { key: '19c5390d637e90fe754b171a671a37c877a657f1', class: "dga-radial-stepper__name" }, (_d = this.steps[this.internalActiveStep - 1]) === null || _d === void 0 ? void 0 : _d.stepName), this.showStepDescription && ((_e = this.steps[this.internalActiveStep - 1]) === null || _e === void 0 ? void 0 : _e.stepDescription) && index.h("h5", { key: 'ac296823e7dafc242f2f7e430796b67121b61b3c', class: "dga-radial-stepper__desc" }, (_f = this.steps[this.internalActiveStep - 1]) === null || _f === void 0 ? void 0 : _f.stepDescription), ((_g = this.steps[this.internalActiveStep - 1]) === null || _g === void 0 ? void 0 : _g.showNextStep) && index.h("span", { key: 'f996e0a11cf7ac90fcf4b15a1619b8186178b7e9', class: "dga-radial-stepper__next-name" }, "Next: ", (_h = this.steps[this.internalActiveStep]) === null || _h === void 0 ? void 0 :
            _h.stepName)))));
    }
