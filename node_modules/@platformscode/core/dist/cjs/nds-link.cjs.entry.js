...
const NdsLink = class {
    ...
    render() {
        return (index.h("a", { key: '061460e1bea53e88885bed5c862295ef43e51094', href: this.href, target: this.target, onClick: event => this.handleClick(event), class: `dga-link dga-link--${this.size} dga-link--${this.variant} ${this.inline ? 'dga-link--inline' : ''} ${this.disabled ? 'dga-link--disabled' : ''}` }, index.h("span", { key: '8107c87c9165ddb05d5f3d239d921ab9788eb405', class: "dga-link__label" }, index.h("slot", { key: '9e38f56d72a0549a104c05402b303aea18d26ba6' }, this.label)), this.icon && index.h("span", { key: 'd51e592d0ea0f22bb90d849869a2ef51642ba3ee', className: "dga-link__icon" }, index.h("dga-icon-v2", Object.assign({ key: 'a0b0be328dc8a85ebfe382ea4f7e8a392bc10750', name: this.icon }, this.iconProps)))));
    }
};
