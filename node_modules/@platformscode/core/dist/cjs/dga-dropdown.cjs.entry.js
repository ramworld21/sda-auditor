...
const DgaDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd651a7cb82c151bba79bf73ef85cfa4add3fb262', id: this.componentId, style: this.rootStyles, dir: document.documentElement.getAttribute('dir') }, index.h("div", { key: 'c0012ad24c5205b67621e0972e6ec25e7145fe24', id: this.id, ref: el => (this.containerRef = el), class: Object.keys(dropdownClasses)
                .filter(key => dropdownClasses[key])
                .join(' ') }, index.h("button", { key: 'c29e8669df0ee78317aa373f135a570aa886bd84', class: "dropdown__btn", ref: el => (this.btnRef = el), disabled: this.disabled || this.readonly, onClick: this.handleToggleDropdown.bind(this), onMouseDown: this.handleAddPressed.bind(this), onMouseUp: this.handleRemovePressed.bind(this), onMouseOut: this.handleRemovePressed.bind(this), type: "button" }, index.h("span", { key: '16019ec80aba2168df89a13ec773179f8c5e11c4', class: "dropdown__label" }), index.h("span", { key: 'eb8ef06bf1ddfc3f8397bed7a6e09fa1717e6682', class: "dropdown__label-placeholder" }, this.placeholder), index.h("span", { key: 'de902988adc5005a152753671a9848ec2cc034b7', class: "dropdown__chevron" }, index.h("dga-icon", { key: 'd0099c51b488a5ba24ab7d458d6920cc4160253b', icon: 'ArrowDown01Icon', variant: "stroke" }))), index.h("ul", { key: '8fec16f4e194ecc5e607f1f3b599975d07e2a875', class: "dropdown__list" }, this.optionList.map((option, index$2) => (index.h("li", { key: option[this.trackBy] || index$1.guid() }, index.h("button", { class: {
                'dropdown__option': true,
                'dropdown__option--checkbox': this.multiSelect,
                'selected': option.selected
            }, "data-value": option[this.trackBy], onClick: e => this.handleOptionClick(e, option, index$2), onMouseDown: this.handleAddPressed.bind(this), onMouseUp: this.handleRemovePressed.bind(this), onMouseOut: this.handleRemovePressed.bind(this), type: "button" }, this.multiSelect && (index.h("div", { class: "dropdown__option-icon-container" }, index.h("span", { class: "dropdown__option-icon" }, index.h("i", { class: "hgi-solid hgi-tick-02", style: { fontSize: "20px" } })))), index.h("span", { class: "dropdown__option-label" }, option[this.optionLabel] || ''), !this.multiSelect && option.selected && (index.h("span", { class: "dropdown__option-icon" }, index.h("dga-icon", { icon: 'Tick02Icon', variant: "solid" })))))))))));
    }
