...
const DgaCardActions = class {
    ...
    render() {
        return (index.h("div", { key: '70381ac30bb2cc7dc082965284b6b7ce73d37d86', class: "card__action card__action--default" }, index.h("slot", { key: '0c9e7ed2c8f89e79169b4dee00334753d145aea8' })));
    }
};
...
const DgaCardContent = class {
    ...
    render() {
        return (index.h("div", { key: '446e0c52bf0969f5bf211a549cf744873adbe959', class: `card__content` }, index.h("slot", { key: '851f7596d4c3b7113d3762f74c2b00e94e38e00a' })));
    }
};
...
const DgaCardExpandableContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7cbad33220fd6b68cb5287cf7a3b5db502f9cf71' }, index.h("slot", { key: 'af92af6702e370fae6a053ae073df722f32628b1' })));
    }
};
...
const DgaCardV2 = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dc0c881744e6458953c9becdbcb2a4fa1556d81f', id: this.componentId, style: this.rootStyles }, index.h("div", Object.assign({ key: 'd26ff98d8700c7731729bde7281d148963fd0a35', class: `card ${this.disabled ? 'disabled' : ''} ${this.isFocused ? 'focused' : ''} card--${this.effect}`, onMouseEnter: this.onMouseEnterHandler, onMouseLeave: this.onMouseLeaveHandler }, (this.type === 'selectable' ? { onClick: this.onCheckboxChange } : {}), { style: this.cardStyles }), this.type === 'selectable' && (index.h("div", { key: 'ee47d3c745d0510cbf0a5c7b98b09a5d5e51c75d', class: "card__checkbox-container" }, index.h("dga-checkbox", { key: '83c21946cf0f86e76dc97abb3e140b732dd11087', checked: this.isSelected, color: "brand", onChange: this.onCheckboxChange }))), index.h("slot", { key: '350d32fdd7354aed8a86fc93defc0430070637ac', name: 'card-content' }), this.type === 'default' && index.h("slot", { key: '24d507cc53e8d80a35374a73d6583dca45417050', name: 'card-actions' }))));
    }
