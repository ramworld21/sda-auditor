...
.flexible-gap-usage section {
  margin-bottom: 40px;
}
.flexible-gap-usage h3 {
  margin-bottom: 16px;
  font-size: 18px;
  color: #333;
}
.flexible-gap-usage h4 {
  margin-top: 0;
  margin-bottom: 12px;
  font-size: 16px;
}
.flexible-gap-usage .demo-content {
  padding: 16px;
...
.flexible-gap-usage .demo-content.nested {
  background-color: #e3f2fd;
  border-color: #bbdefb;
}
.flexible-gap-usage .demo-card {
...
.flexible-gap-usage .demo-card .demo-card-media {
  height: 140px;
  background-color: #bbdefb;
}
.flexible-gap-usage .demo-card .demo-card-content {
  padding: 16px;
}
.flexible-gap-usage .demo-card .demo-card-content h3 {
  margin-top: 0;
  margin-bottom: 8px;
  font-size: 18px;
}
.flexible-gap-usage .demo-card .demo-card-content p {
  color: #666;
  margin-bottom: 0;
  font-size: 14px;
}