...
.text-md-regular, .dga-search-box--lg .input__prefix-label, .dga-search-box--lg .input__suffix-label, .dga-search-box__prefix-label, .dga-search-box__prefix-icon, .dga-search-box__prefix-chevron, .dga-search-box__suffix-label, .dga-search-box__suffix-icon, .dga-search-box__suffix-chevron, .dga-search-box__field::placeholder, .dga-search-box__field {
  font: 400 16px/24px "IBMPlexSansArabic";
}

.text-sm-regular, .dga-search-box--md .input__prefix-label, .dga-search-box--md .input__suffix-label, .dga-search-box--md .dga-search-box__field, .dga-search-box--md .dga-search-box__field::placeholder, .dga-search-box--lg .dga-search-box__field, .dga-search-box--lg .dga-search-box__field::placeholder, .dga-search-box__prefix .dropdown__label--selection, .dga-search-box__suffix .dropdown__label--selection, .dga-form-control > .dga-label {
...
.dga-shadow-md, .dga-search-box.focus {
...
.dga-search-box--readonly .dga-search-box__field, .dga-search-box--readonly .dga-search-box__field::placeholder, .dga-search-box--disabled .dga-search-box__field, .dga-search-box--disabled .dga-search-box__field::placeholder {
  color: var(--form-field-text-readonly);
}
.dga-search-box--disabled {
  border-color: var(--border-disabled);
}
.dga-search-box--disabled .dga-search-box__field {
  color: var(--text-default-disabled);
}
.dga-search-box--disabled .dga-search-box__field, .dga-search-box--disabled .dga-search-box__field::placeholder {
  color: var(--text-default-disabled);
}
...
.dga-search-box__prefix--solid, .dga-search-box__suffix--solid {
  background-color: var(--background-neutral-50);
}
.dga-search-box__prefix--solid-text, .dga-search-box__suffix--solid-text {
  background-color: var(--background-neutral-50);
}
...
.dga-search-box__prefix--subtle, .dga-search-box__suffix--subtle {
  background-color: transparent;
}
.dga-search-box__prefix--subtle-text, .dga-search-box__suffix--subtle-text {
  background-color: transparent;
}
...
.dga-search-box__prefix.selected .input__prefix-icon, .dga-search-box__prefix.selected .input__prefix-label, .dga-search-box__prefix.selected .input__prefix-chevron, .dga-search-box__suffix.selected .input__prefix-icon, .dga-search-box__suffix.selected .input__prefix-label, .dga-search-box__suffix.selected .input__prefix-chevron {
  color: var(--colors-text-primary_on-brand);
}
.dga-search-box__prefix.selected .dropdown__label, .dga-search-box__suffix.selected .dropdown__label {
  color: var(--colors-text-primary_on-brand);
}
...
.dga-search-box--lighter:hover {
  border: 1px solid var(--form-field-border-default);
}
.dga-search-box--lighter.focus {
  border: 1px solid var(--form-field-border-default);
}
.dga-search-box--lighter.active {
  border: 1px solid var(--form-field-border-default);
}
