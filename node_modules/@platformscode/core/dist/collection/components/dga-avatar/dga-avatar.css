...
.display-sm-regular, .dga-avatar--80 .dga-avatar__text {
...
.text-xl-medium, .dga-avatar--68 .dga-avatar__text {
...
.text-md-medium, .dga-avatar--48 .dga-avatar__text {
...
.text-sm-semibold, .dga-avatar--40 .dga-avatar__text {
  font: 600 14px/20px "IBMPlexSansArabic";
}

.text-xs-semibold, .dga-avatar--32 .dga-avatar__text {
...
.text-2xs-bold, .dga-avatar--24 .dga-avatar__text {
...
.dga-avatar--square.dga-avatar--border::after {
  border-radius: var(--radius-8);
}
.dga-avatar--border::after {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
  ...
  right: 0;
  border-radius: var(--radius-full);
  border: 1px solid var(--alpha-black-20, rgba(22, 22, 22, 0.2));
}
.dga-avatar--120 {
  width: 120px;
  height: 120px;
...
.dga-avatar--120.dga-avatar--border::after {
  border-width: 2px;
}
.dga-avatar--120 .dga-avatar__text {
  text-transform: uppercase;
}
.dga-avatar--120 .dga-avatar__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 80px;
...
.dga-avatar--80 .dga-avatar__text {
  text-transform: uppercase;
}
.dga-avatar--80 .dga-avatar__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 56px;
...
.dga-avatar--68 .dga-avatar__text {
  text-transform: uppercase;
}
.dga-avatar--68 .dga-avatar__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 40px;
...
.dga-avatar--48 .dga-avatar__text {
  text-transform: uppercase;
}
.dga-avatar--48 .dga-avatar__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
.dga-avatar--40 .dga-avatar__text {
  text-transform: uppercase;
}
.dga-avatar--40 .dga-avatar__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
.dga-avatar--32 .dga-avatar__text {
  text-transform: uppercase;
}
.dga-avatar--32 .dga-avatar__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 24px;
...
.dga-avatar--24 .dga-avatar__text {
  text-transform: uppercase;
}
.dga-avatar--24 .dga-avatar__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 16px;
