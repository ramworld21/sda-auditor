...
.text-sm-regular, .dga-metric__content-change-period, .dga-metric[data-chart-size=small-chart] .dga-metric__content-change-period {
...
.text-sm-medium, .dga-metric__content-change-value, .dga-metric[data-chart-size=small-chart] .dga-metric__content-change-value, .dga-metric__head-content-text {
...
.display-md-bold, .dga-metric__content-percentage, .dga-metric[data-chart-size=small-chart] .dga-metric__content-percentage {
