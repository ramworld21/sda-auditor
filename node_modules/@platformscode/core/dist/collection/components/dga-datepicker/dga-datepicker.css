...
.text-md-regular, .date-cell__label {
  font: 400 16px/24px "IBMPlexSansArabic";
}

.text-sm-regular, .dga-breadcrumb-dropdown-item {
...
.text-md-medium, .date-picker__navigator-label {
...
.text-md-bold, .date-cell--today .date-cell__label span {
...
.dga-shadow-2xl, .date-picker-root {
...
.date-picker__navigator-buttons {
  display: flex;
  align-items: center;
}
...
.date-cell:hover .date-cell__label span {
  background: var(--form-datecell-today-background-hovered);
}
...
.date-cell--selected:hover .date-cell__label span {
  background: var(--form-datecell-background-hovered);
}
.date-cell--selected:active .date-cell__label span, .date-cell--selected.pressed .date-cell__label span {
...
[dir=rtl] .date-cell--mid-range--first-child .date-cell__label::before {
...
[dir=rtl] .date-cell--mid-range--last-child .date-cell__label::before {
  border-radius: 50% 0 0 50%;
  right: 0;
  left: unset;
}

[dir=rtl] .date-picker__navigator-buttons dga-button-v2 {
...
.year-selector .dropdown-arrow.open {
  transform: rotate(180deg);
}

/* RTL support for the dropdown */
[dir=rtl] .year-selector .dropdown-arrow {
  margin-left: 0;
  margin-right: 4px;
}
...
.dga-breadcrumb-dropdown-item.selected-year {
  background: var(--button-background-neutral-pressed, #e5e7eb);
  mix-blend-mode: multiply;
}
.dga-breadcrumb-dropdown-item > .dropdown__option-icon {
  opacity: 0;
}
.dga-breadcrumb-dropdown-item.selected-year > .dropdown__option-icon {
  opacity: 1;
}