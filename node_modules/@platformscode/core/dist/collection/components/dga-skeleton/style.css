...
.line_text.type1 {
  background: linear-gradient(90deg, rgba(229, 231, 235, 0.2) 0%, rgba(210, 214, 219, 0.2) 50%, rgba(157, 164, 174, 0.2) 100%);
}
.line_text.type2 {
  background: linear-gradient(90deg, rgba(157, 164, 174, 0.2) 0%, rgba(210, 214, 219, 0.2) 49.5%, rgba(229, 231, 235, 0.2) 100%);
}
.line_text.lg {
  height: 22px;
}
...
.rectangle_text.type1 {
  background: linear-gradient(90deg, rgba(229, 231, 235, 0.2) 0%, rgba(210, 214, 219, 0.2) 50%, rgba(157, 164, 174, 0.2) 100%);
}
.rectangle_text.type2 {
  background: linear-gradient(90deg, rgba(157, 164, 174, 0.2) 0%, rgba(210, 214, 219, 0.2) 49.5%, rgba(229, 231, 235, 0.2) 100%);
}
.rectangle_text.lg {
  height: 40px;
...
.circle_skeleton.type1 {
  background: linear-gradient(90deg, rgba(229, 231, 235, 0.2) 0%, rgba(210, 214, 219, 0.2) 50%, rgba(157, 164, 174, 0.2) 100%);
}
.circle_skeleton.type2 {
  background: linear-gradient(90deg, rgba(157, 164, 174, 0.2) 0%, rgba(210, 214, 219, 0.2) 49.5%, rgba(229, 231, 235, 0.2) 100%);
}
...
.square_skeleton.type1 {
  background: linear-gradient(90deg, rgba(229, 231, 235, 0.2) 0%, rgba(210, 214, 219, 0.2) 50%, rgba(157, 164, 174, 0.2) 100%);
}
.square_skeleton.type2 {
  background: linear-gradient(90deg, rgba(157, 164, 174, 0.2) 0%, rgba(210, 214, 219, 0.2) 49.5%, rgba(229, 231, 235, 0.2) 100%);
}

.chart_and_content,
.image_content_and_button,
.image_profile_content {
  width: fit-content;
}
.chart_and_content .wrapper,
.image_content_and_button .wrapper,
.image_profile_content .wrapper {
  display: flex;
  flex-direction: column;
  gap: 24px;
  justify-content: center;
...
.chart_and_content .wrapper .line_wrapper,
.image_content_and_button .wrapper .line_wrapper,
.image_profile_content .wrapper .line_wrapper {
  display: flex;
  flex-direction: column;
  gap: 12px;
}
.chart_and_content .wrapper .last,
.image_content_and_button .wrapper .last,
.image_profile_content .wrapper .last {
  margin-inline-end: auto;
}
.chart_and_content .wrapper .first,
.image_content_and_button .wrapper .first,
.image_profile_content .wrapper .first {
  margin-inline-end: auto;
  display: flex;
  gap: 4px;
  align-items: center;
...
.image_button_and_text,
.icon_and_list {
  width: fit-content;
}
.image_button_and_text .wrapper,
.icon_and_list .wrapper {
  display: flex;
  gap: 11px;
  align-items: center;
}
.image_button_and_text .wrapper .right,
.icon_and_list .wrapper .right {
  display: flex;
  flex-direction: column;
  gap: 10px;
}
