...
.text-sm-regular, dialog .modal__content {
...
@media only screen and (max-width: 56.25em) {
  ...
  dialog .modal__actions .dga-btn, dialog .modal__actions-btn-group .dga-btn {
    width: 100%;
  }
}
@media only screen and (max-width: 56.25em) {
