...
.text-md-regular, .input--lg .input__prefix-label, .input--lg .input__suffix-label, .input__prefix-label, .input__prefix-icon, .input__prefix-chevron, .input__suffix-label, .input__suffix-icon, .input__suffix-chevron, .input__field::placeholder, .input__field {
  font: 400 16px/24px "IBMPlexSansArabic";
}

.text-sm-regular, .breadcrumb-dropdown-item, .input--md .input__prefix-label, .input--md .input__suffix-label, .input--md .input__field, .input--md .input__field::placeholder, .input--lg .input__field, .input--lg .input__field::placeholder, .input__prefix .dropdown__label--selection, .input__suffix .dropdown__label--selection, .dga-form-control > .dga-label {
...
.input__prefix--solid, .input__suffix--solid {
  background-color: var(--background-neutral-50);
}
.input__prefix--solid-text, .input__suffix--solid-text {
  background-color: var(--background-neutral-50);
}
...
.input__prefix--subtle, .input__suffix--subtle {
  background-color: transparent;
}
.input__prefix--subtle-text, .input__suffix--subtle-text {
  background-color: transparent;
}
...
.input__prefix.selected .input__prefix-icon, .input__prefix.selected .input__prefix-label, .input__prefix.selected .input__prefix-chevron, .input__suffix.selected .input__prefix-icon, .input__suffix.selected .input__prefix-label, .input__suffix.selected .input__prefix-chevron {
  color: var(--colors-text-primary_on-brand);
}
.input__prefix.selected .dropdown__label, .input__suffix.selected .dropdown__label {
  color: var(--colors-text-primary_on-brand);
}
