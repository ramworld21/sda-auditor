...
.dga-loading--neutral .loading__circle {
  border-color: var(--background-neutral-100);
  border-top-color: var(--background-black);
}
.dga-loading--neutral .loading__circle::after, .dga-loading--neutral .loading__circle::before {
  background-color: var(--background-black);
}
.dga-loading--brand .dga-loading__circle {
  border-color: var(--background-neutral-100);
  border-top-color: var(--background-primary);
}
.dga-loading--brand .dga-loading__circle::after, .dga-loading--brand .dga-loading__circle::before {
  background-color: var(--background-primary);
}
.dga-loading--on-color .dga-loading__circle {
  border-color: var(--alpha-white-30);
  border-top-color: var(--background-surface-oncolor);
  mix-blend-mode: normal;
}
.dga-loading--on-color .dga-loading__circle::after, .dga-loading--on-color .dga-loading__circle::before {
