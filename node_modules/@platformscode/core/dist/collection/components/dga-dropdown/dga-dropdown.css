...
.text-md-regular, .dropdown--lg .dropdown__option-label, .dropdown--lg .dropdown__label, .dropdown--lg .dropdown__label-placeholder, .dropdown__btn, .dropdown__label {
  font: 400 16px/24px "IBMPlexSansArabic";
}

.text-sm-regular, .dropdown--md .dropdown__option-label, .dropdown--md .dropdown__label, .dropdown--md .dropdown__label-placeholder, .dropdown__option-label {
...
.text-sm-semibold, .dropdown__list-group-label {
...
.dga-shadow-md, .dropdown__btn.open {
...
.dropdown--readonly .dropdown__chevron, .dropdown--disabled .dropdown__chevron {
  color: var(--colors-gray-neutral-300);
}
.dropdown--disabled .dropdown__btn, .dropdown--disabled .dropdown__label, .dropdown--disabled .dropdown__label-placeholder {
  color: var(--colors-gray-neutral-300);
}
.dropdown__list {
  display: flex;
...
.dropdown--md .dropdown__list {
  top: 32px;
}
.dropdown--md .dropdown__option-icon {
  font-size: 20px;
}
:host([dir=rtl]) .dropdown__chevron {
  right: auto;
  left: var(--spacing-xl);
}