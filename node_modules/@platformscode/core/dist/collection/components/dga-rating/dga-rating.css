...
.dga-rating__star--pressed {
  background-color: var(--background-neutral-100);
  border-radius: 100%;
}
.dga-rating__star__label {
  cursor: inherit;
}
.dga-rating__star__label-icon {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.dga-rating__star__label-icon > svg {
...
.dga-rating__star__label-text, .dga-rating__star__label-input {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
