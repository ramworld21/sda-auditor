...
.filteration *::-webkit-scrollbar {
  width: 8px;
  height: 8px;
}
.filteration *::-webkit-scrollbar-track {
  background: var(--color-neutral-100);
  border-radius: 4px;
}
.filteration *::-webkit-scrollbar-thumb {
  background: var(--color-neutral-300);
  border-radius: 4px;
  transition: background 0.3s ease;
}
.filteration *::-webkit-scrollbar-thumb:hover {
...
.filteration__block-content--checkbox {
  flex-direction: column;
  gap: var(--spacing-2xl);
}
.filteration__block-content--radio {
  flex-direction: column;
  gap: var(--spacing-sm);
  margin-left: -10px;
  font-weight: 400;
}
.filteration__block-content--slider {
  flex-direction: column;
  width: 92%;
  padding-left: 8px;
}
...
.filteration__block-content--select {
  flex-direction: column;
  gap: var(--spacing-2xl);
}
...
.filteration__range > span {
  color: var(--color-neutral-500);
  margin: 0 var(--spacing-sm);
}
.filteration__range dga-text-input {
  max-width: 125px;
}
.filteration__search {
  width: 100%;
...
.filteration__actions dga-button {
  min-width: 120px;
}
@keyframes slideDown {
  from {
...
.checkbox_check_box_container {
  display: flex;
  align-items: center;
  gap: 5px;
  color: var(--text-secondary-paragraph, #6C737F);
  /* Text sm/Regular */
  font-family: var(--Family-font-family-text, "IBM Plex Sans Arabic");
  font-size: var(--Text-typo-size-text-sm, 14px);
  font-style: normal;
  font-weight: 400;
  line-height: var(--Line-Height-Text-line-heights-text-sm, 20px);
}

.filteration__block-actions button {
  padding: 0;
}
