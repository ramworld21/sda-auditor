...
.tag--on-color {
  ...
  background: var(-tag-background-on-color, rgba(255, 255, 255, 0.2));
}
.tag--on-color-outlined {
  border: 1px solid var(-tag-border-on-color, rgba(255, 255, 255, 0.6));
  background-color: transparent;
