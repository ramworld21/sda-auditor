...
.text-md-medium, .status-tag--lg, .status-tag {
  font: 500 16px/24px "IBMPlexSansArabic";
}

.text-sm-medium, .status-tag--md {
...
.status-tag--subtle.status-tag--neutral {
  background: var(--tag-background-neutral-light, #f9fafb);
  color: var(--tag-text-neutral, #1f2a37);
}
.status-tag--subtle.status-tag--neutral > .status-tag__indicator {
  background: var(--tag-background-neutral, #4d5761);
}
.status-tag--subtle.status-tag--blue {
  background: var(--tag-background-info-light, #EFF8FF);
  color: var(--tag-text-info, #1849A9);
}
.status-tag--subtle.status-tag--blue > .status-tag__indicator {
  background: var(--tag-icon-info, #1849A9);
}
.status-tag--subtle.status-tag--green {
  background: var(--tag-background-success-light, #ECFDF3);
  color: var(--tag-text-success, #085D3A);
}
.status-tag--subtle.status-tag--green > .status-tag__indicator {
  background: var(--tag-icon-success, #085D3A);
}
.status-tag--subtle.status-tag--yellow {
  background: var(--tag-background-warning-light, #FFFAEB);
  color: var(--tag-text-warning, #93370D);
}
.status-tag--subtle.status-tag--yellow > .status-tag__indicator {
  background: var(--tag-icon-warning, #93370D);
}
.status-tag--subtle.status-tag--red {
  background: var(--tag-background-error-light, #FEF3F2);
  color: var(--tag-text-error, #912018);
}
.status-tag--subtle.status-tag--red > .status-tag__indicator {
  background: var(--tag-icon-error, #912018);
}
.status-tag--inverted.status-tag--neutral {
  background: var(--tag-background-neutral, #4d5761);
  color: var(--text-oncolor-primary, #FFF);
}
.status-tag--inverted.status-tag--neutral > .status-tag__indicator {
  background: var(--tag-dot, rgba(255, 255, 255, 0.6));
}
.status-tag--inverted.status-tag--blue {
  background: var(--tag-background-info, #1570EF);
  color: var(--text-oncolor-primary, #FFF);
}
.status-tag--inverted.status-tag--blue > .status-tag__indicator {
  background: var(--tag-dot, rgba(255, 255, 255, 0.6));
}
.status-tag--inverted.status-tag--green {
  background: var(--tag-background-success, #067647);
  color: var(--text-oncolor-primary, #FFF);
}
.status-tag--inverted.status-tag--green > .status-tag__indicator {
  background: var(--Tag-tag-dot, rgba(255, 255, 255, 0.6));
}
.status-tag--inverted.status-tag--yellow {
  background: var(--tag-background-warning, #B54708);
  color: var(--text-oncolor-primary, #FFF);
}
.status-tag--inverted.status-tag--yellow > .status-tag__indicator {
  background: var(--tag-dot, rgba(255, 255, 255, 0.6));
}
.status-tag--inverted.status-tag--red {
  background: var(--tag-background-error, #D92D20);
  color: var(--text-oncolor-primary, #FFF);
}
.status-tag--inverted.status-tag--red > .status-tag__indicator {
  background: var(--Tag-tag-dot, rgba(255, 255, 255, 0.6));
}
.status-tag--ghost.status-tag--neutral {
  background: transparent;
  color: var(--tag-text-neutral, #1f2a37);
  padding: var(--spacing-none, 0px);
}
.status-tag--ghost.status-tag--neutral > .status-tag__indicator {
  background: var(--tag-background-neutral, #4d5761);
}
.status-tag--ghost.status-tag--blue {
  background: transparent;
  color: var(--tag-text-neutral, #1F2A37);
}
.status-tag--ghost.status-tag--blue > .status-tag__indicator {
  background: var(--tag-icon-info, #1849A9);
}
.status-tag--ghost.status-tag--green {
  background: transparent;
  color: var(--tag-text-neutral, #1F2A37);
}
.status-tag--ghost.status-tag--green > .status-tag__indicator {
  background: var(--Tag-tag-icon-success, #085D3A);
}
.status-tag--ghost.status-tag--yellow {
  background: transparent;
  color: var(--tag-text-neutral, #1F2A37);
}
.status-tag--ghost.status-tag--yellow > .status-tag__indicator {
  background: var(--tag-icon-warning, #93370D);
}
.status-tag--ghost.status-tag--red {
  background: transparent;
  color: var(--tag-text-neutral, #1F2A37);
}
.status-tag--ghost.status-tag--red > .status-tag__indicator {
  background: var(--Tag-tag-icon-error, #912018);
}