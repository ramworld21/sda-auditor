...
.text-xs-regular, .dga-slideout-menu__header-description {
...
.dga-slideout-menu--right {
  left: auto;
  right: 0;
  transform: translate3d(100vw, 0, 0);
}
.dga-slideout-menu.active {
...
.dga-slideout-menu--white {
  background: var(--background-menu, #FFF);
}
.dga-slideout-menu--white > .dga-slideout-menu__header {
  background: var(--background-neutral-50, #F9FAFB) !important;
}
.dga-slideout-menu--gray {
  background: var(--background-neutral-100, #F3F4F6);
}
.dga-slideout-menu--gray > .dga-slideout-menu__header {
  background: var(--background-neutral-50, #F9FAFB) !important;
}
...
.dga-slideout-menu__items dga-slideout-menu-items {
  display: flex;
  flex-direction: column;
  gap: 16px;
}
.dga-slideout-menu__items::-webkit-scrollbar {
  width: 8px;
}
.dga-slideout-menu__items::-webkit-scrollbar-track {
  background: #f1f1f1;
}
...
.dga-slideout-menu__items::-webkit-scrollbar-thumb:hover {
  background: #555;
}
.dga-slideout-menu__items--hide-scrollbar {
  scrollbar-width: none;
}
.dga-slideout-menu__items--hide-scrollbar::-webkit-scrollbar {
  display: none;
}
