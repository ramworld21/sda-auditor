...
.dga-btn--neutral:active::after {
  display: none !important;
}
.dga-btn--neutral:disabled, .dga-btn--neutral[disabled] {
  background: var(--background-disabled);
  color: var(--text-default-disabled);
}
.dga-btn--neutral--on-color {
  background-color: var(--button-background-oncolor-default);
  color: var(--text-default);
}
.dga-btn--neutral--on-color:hover {
  background-color: var(--button-background-oncolor-hovered);
}
.dga-btn--neutral--on-color:visited, .dga-btn--neutral--on-color.selected {
  background-color: var(--button-background-oncolor-selected);
}
.dga-btn--neutral--on-color:active {
  background-color: var(--button-background-oncolor-pressed);
}
.dga-btn--neutral--on-color:disabled, .dga-btn--neutral--on-color[disabled] {
...
.dga-btn--primary:active::after {
  display: none !important;
}
.dga-btn--primary:disabled, .dga-btn--primary[disabled] {
  background: var(--background-disabled);
  color: var(--text-default-disabled);
}
.dga-btn--primary--on-color {
  background-color: var(--button-background-oncolor-default);
  color: var(--text-default);
}
.dga-btn--primary--on-color:hover {
  background-color: var(--button-background-oncolor-hovered);
}
.dga-btn--primary--on-color:visited, .dga-btn--primary--on-color.selected {
  background-color: var(--button-background-oncolor-pressed);
}
.dga-btn--primary--on-color:active {
  background-color: var(--button-background-oncolor-pressed);
}
.dga-btn--primary--on-color:disabled, .dga-btn--primary--on-color[disabled] {
  background-color: var(--button-background-disabled-on-color);
  color: var(--text-default-oncolor-disabled);
}
