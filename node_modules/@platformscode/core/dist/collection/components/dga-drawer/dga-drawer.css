...
.text-sm-regular, .sidepanel__submenu--sublevel .sidepanel__submenu-tab-label, .sidepanel__menu-tab, .sidepanel__submenu-tab {
...
.text-sm-semibold, .sidepanel__submenu-tab-label, .sidepanel__menu-tab-label {
...
.text-sm-bold, .sidepanel__menu-tab.active > .sidepanel__menu-tab-label, .active.sidepanel__submenu-tab > .sidepanel__menu-tab-label, .sidepanel__menu-tab.selected, .selected.sidepanel__submenu-tab, .sidepanel__menu-tab.active, .active.sidepanel__submenu-tab {
...
.sidepanel__header {
  display: flex;
  padding: 16px var(--spacing-4xl, 32px);
  align-items: center;
  width: 100%;
}
...
.sidepanel--bg-gray .sidepanel__header {
...
.sidepanel--bg-brand .sidepanel__header {
  background: var(--background-nav-header, #14573A);
}
.sidepanel--border {
