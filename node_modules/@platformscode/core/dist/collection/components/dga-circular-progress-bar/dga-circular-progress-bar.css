...
.text-xl-regular, .circular-progress-bar[aria-size="200px"] .circular-progress-bar__label--text {
  font: 400 20px/30px "IBMPlexSansArabic";
}

.text-lg-regular, .circular-progress-bar[aria-size="80px"] .circular-progress-bar__label--percentage {
  font: 400 18px/28px "IBMPlexSansArabic";
}

.text-md-regular, .circular-progress-bar[aria-size="160px"] .circular-progress-bar__label--text {
  font: 400 16px/24px "IBMPlexSansArabic";
}

.text-sm-regular, .circular-progress-bar[aria-size="120px"] .circular-progress-bar__label--text {
...
.display-md-bold, .circular-progress-bar[aria-size="200px"] .circular-progress-bar__label--percentage {
...
.text-sm-bold, .circular-progress-bar[aria-size="64px"] .circular-progress-bar__label--percentage {
...
.circular-progress-bar .circular-progress-bar__label--text.error {
  color: var(--text-error) !important;
}
.circular-progress-bar .circular-progress-bar__label--icon.hgi-checkmark-circle-02 {
  color: var(--icon-success);
}
.circular-progress-bar .circular-progress-bar__label--icon.hgi-multiplication-sign-circle {
...
.tail--error {
  stroke: var(--background-error) !important;
}
