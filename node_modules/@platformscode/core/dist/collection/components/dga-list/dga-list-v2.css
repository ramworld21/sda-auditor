...
.text-md-regular, .list-title, .list-item {
...
.list--unordered .list-item--level-one::before {
  content: "-";
}
.list--unordered > ul {
...
.list-item--unordered.list-item--level-one::before {
  content: "-";
}
.list-item--unordered.list-item--level-two::before {
  content: "•";
}
...
.list-item--with-icon .list-item__icon :global(i) {
  width: 16px;
  height: 16px;
}