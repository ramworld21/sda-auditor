...
.floating-button-onColor-true {
  --primary-brand: var(--button-background-primary-default, #1b8354);
  --primary-brand-hover: var(--button-background-primary-hovered, #166a45);
  --primary-brand-pressed: var(--button-background-primary-pressed, #104631);
  --primary-brand-selected: var(--button-background-primary-selected, #14573a);
  --primary-brand-focused: var(--button-background-primary-focused, #1b8354);
  --primary-brand-color: var(--text-oncolor-primary, #fff);
  --primary-neutral: var(--button-background-oncolor-default, #fff);
  --primary-neutral-hover: var(
    --button-background-oncolor-hovered,
    rgba(255, 255, 255, 0.8)
  );
  --primary-neutral-pressed: var(--button-background-oncolor-pressed, rgba(255,255,255,0.60));
  --primary-neutral-selected: var(
    --button-background-oncolor-selected,
    rgba(255, 255, 255, 0.7)
  );
  --primary-neutral-focused: var(--button-background-oncolor-focused, #fff);
  --primary-neutral-color: var(--text-default, #161616);
  --secondary-solid: var(
    --button-background-transparent-hovered,
    rgba(255, 255, 255, 0.2)
  );
  --secondary-solid-color: var(--text-oncolor-primary, #fff);
  --secondary-solid-hover: var(
    --button-background-transparent-hovered,
    rgba(255,255,255,0.2)
  );
  ...
  --outline-color: var(--icon-oncolor, #fff);
}

.floating-button-onColor-false {
  --primary-brand: var(--button-background-primary-default, #1b8354);
  --primary-brand-hover: var(--button-background-primary-hovered, #166a45);
  --primary-brand-pressed: var(--button-background-primary-pressed, #104631);
  --primary-brand-selected: var(--button-background-primary-selected, #14573a);
  --primary-brand-focused: var(--button-background-primary-focused, #1b8354);
  --primary-brand-color: var(--text-oncolor-primary, #fff);
  --primary-neutral: #0d121c;
  --primary-neutral-hover: var(--button-background-black-hovered, #1f2a37);
  --primary-neutral-pressed: var(--button-background-black-pressed, #4d5761);
  --primary-neutral-selected: var(--button-background-black-selected, #384250);
  --primary-neutral-focused: #0d121c;
  --primary-neutral-color: var(--text-oncolor-primary, #fff);
  --secondary-solid: var(--button-background-neutral-default, #f3f4f6);
  --secondary-solid-color: var(--text-default, #161616);
  --secondary-solid-hover: var(--button-background-neutral-pressed, #e5e7eb);
  --secondary-solid-pressed: var(--button-background-neutral-pressed, #e5e7eb);
  --secondary-solid-selected: var(
    --button-background-neutral-selected,
    #e5e7eb
  );
  --secondary-solid-focused: var(--button-background-neutral-focused, #f3f4f6);
  --disabled-color: var(--background-disabled, #e5e7eb);
  --outline-color: var(--icon-default, #161616);
}
...
.floating-button-btn.large {
  padding: 20px;
}
.floating-button-btn .floating-button-icon {
  display: flex;
  justify-content: center;
  align-items: center;
}
.floating-button-btn .floating-button-icon svg {
  width: 17.5px;
  height: 17.5px;
}
.floating-button-btn.primary-brand {
  color: var(--primary-brand-color);
  background-color: var(--primary-brand);
}
.floating-button-btn.primary-brand .icon svg {
  fill: var(--primary-brand-color);
}
.floating-button-btn.primary-brand:hover {
  background-color: var(--primary-brand-hover);
}
.floating-button-btn.primary-brand:visited {
  background-color: var(--primary-brand-selected);
}
.floating-button-btn.primary-brand:focus {
  background-color: var(--primary-brand-focused);
  outline: 3px solid var(--outline-color);
  outline-offset: 2px;
}
.floating-button-btn.primary-brand:active {
  background-color: var(--primary-brand-pressed);
  outline: none;
}
.floating-button-btn.primary-neutral {
  color: var(--primary-neutral-color);
  background-color: var(--primary-neutral);
}
.floating-button-btn.primary-neutral .icon svg {
  fill: var(--primary-neutral-color);
}
.floating-button-btn.primary-neutral:hover {
  background-color: var(--primary-neutral-hover);
}
.floating-button-btn.primary-neutral:visited {
  background-color: var(--primary-neutral-selected);
}
.floating-button-btn.primary-neutral:focus {
  background-color: var(--primary-neutral-focused);
  outline: 3px solid var(--outline-color);
  outline-offset: 2px;
}
.floating-button-btn.primary-neutral:active {
  background-color: var(--primary-neutral-pressed);
  outline: none;
}
.floating-button-btn.secondary-solid {
  color: var(--secondary-solid-color);
  background-color: var(--secondary-solid);
}
.floating-button-btn.secondary-solid .icon svg {
  fill: var(--secondary-solid-color);
}
.floating-button-btn.secondary-solid:hover {
  background-color: var(--secondary-solid-hover);
}
.floating-button-btn.secondary-solid:visited {
  background-color: var(--secondary-solid-selected);
}
.floating-button-btn.secondary-solid:focus {
  background-color: var(--secondary-solid-focused);
  outline: 3px solid var(--outline-color);
  outline-offset: 2px;
}
.floating-button-btn.secondary-solid:active {
  background-color: var(--secondary-solid-pressed);
  outline: none;
}
.floating-button-btn:disabled, .floating-button-btn[disabled] {
  background-color: var(--disabled-color);
  color: var(--text-default-disabled, #9da4ae);
  cursor: not-allowed;
}
.floating-button-btn:disabled .icon svg, .floating-button-btn[disabled] .icon svg {
  fill: var(--text-default-disabled, #9da4ae);
}
.floating-button-btn:disabled:hover, .floating-button-btn[disabled]:hover {
  background-color: var(--disabled-color, #e5e7eb);
}
.floating-button-btn:disabled:visited, .floating-button-btn[disabled]:visited {
  background-color: var(--disabled-color, #e5e7eb);
}
.floating-button-btn:disabled:focus, .floating-button-btn[disabled]:focus {
  background-color: var(--disabled-color, #e5e7eb);
  outline: none;
}
.floating-button-btn:disabled:active, .floating-button-btn[disabled]:active {
  background-color: var(--disabled-color, #e5e7eb);
  outline: none;
}