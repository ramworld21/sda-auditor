...
.text-md-regular, div.table-wrapper .azm-structured-table tbody td {
...
.text-xs-medium, div.table-wrapper .azm-structured-table thead th {
...
div.table-wrapper .azm-structured-table thead {
  ...
  background: var(--background-neutral-50, #f3f4f6);
}
...
div.table-wrapper .azm-structured-table tbody tr.alternate:nth-child(even):not(div.table-wrapper .azm-structured-table tbody tr:hover, div.table-wrapper .azm-structured-table tbody tr.row-selected) {
