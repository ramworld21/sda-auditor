...
.text-sm-regular, .dga-radial-stepper--80px .dga-radial-stepper__pre-name, .dga-radial-stepper--80px .dga-radial-stepper__next-name, .dga-radial-stepper--80px .dga-radial-stepper__desc, .dga-radial-stepper--120px .dga-radial-stepper__pre-name, .dga-radial-stepper--120px .dga-radial-stepper__next-name, .dga-radial-stepper--120px .dga-radial-stepper__desc {
  font: 400 14px/20px "IBMPlexSansArabic";
}

.text-xs-regular, .dga-radial-stepper--48px .dga-radial-stepper__pre-name, .dga-radial-stepper--48px .dga-radial-stepper__next-name, .dga-radial-stepper--48px .dga-radial-stepper__desc, .dga-radial-stepper--64px .dga-radial-stepper__pre-name, .dga-radial-stepper--64px .dga-radial-stepper__next-name, .dga-radial-stepper--64px .dga-radial-stepper__desc {
  font: 400 12px/18px "IBMPlexSansArabic";
}

.text-2xs-regular, .dga-radial-stepper--40px .dga-radial-stepper__pre-name, .dga-radial-stepper--40px .dga-radial-stepper__next-name, .dga-radial-stepper--40px .dga-radial-stepper__desc {
...
.text-xl-semibold, .dga-radial-stepper--120px .dga-radial-stepper__name {
...
.text-md-semibold, .dga-radial-stepper--80px .dga-radial-stepper__name {
  font: 600 16px/24px "IBMPlexSansArabic";
}

.text-sm-semibold, .dga-radial-stepper--48px .dga-radial-stepper__name, .dga-radial-stepper--64px .dga-radial-stepper__name {
  font: 600 14px/20px "IBMPlexSansArabic";
}

.text-xs-semibold, .dga-radial-stepper--40px .dga-radial-stepper__name {
...
.display-xs-bold, .dga-radial-stepper--120px .dga-circular-stepper__label--text {
...
.text-lg-bold, .dga-radial-stepper--80px .dga-circular-stepper__label--text {
...
.text-sm-bold, .dga-radial-stepper--64px .dga-circular-stepper__label--text {
...
.dga-circular-stepper {
  position: relative;
  width: fit-content;
}
.dga-circular-stepper__label {
  position: absolute;
  top: 50%;
  left: 50%;
...
.dga-circular-stepper__label--text {
  color: var(--text-primary-paragraph);
  text-align: center;
}
.dga-circular-stepper__label--text.success {
  color: var(--text-success) !important;
}
.dga-circular-stepper__label--icon.hgi-checkmark-circle-02 {
  color: var(--icon-success);
}

.track {
  stroke: var(--background-neutral-200);
}

.track--on-color {
  stroke: var(--alpha-white-30, rgba(255, 255, 255, 0.3)) !important;
}
...
.tail--on-color {
  stroke: var(--surface-oncolor, #FFF) !important;
}

.dga-radial-stepper--120px .dga-circular-stepper__label {
  text-align: center;
}
.dga-radial-stepper--120px .dga-circular-stepper__label--text {
  text-align: center;
}
.dga-radial-stepper--120px .dga-radial-stepper__name {
  color: var(--stepper-text-primary);
}
.dga-radial-stepper--120px .dga-radial-stepper__desc {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--120px .dga-radial-stepper__pre-name, .dga-radial-stepper--120px .dga-radial-stepper__next-name {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--80px .dga-radial-stepper__name {
  color: var(--stepper-text-primary);
}
.dga-radial-stepper--80px .dga-radial-stepper__desc {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--80px .dga-radial-stepper__pre-name, .dga-radial-stepper--80px .dga-radial-stepper__next-name {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--64px .dga-radial-stepper__name {
  color: var(--stepper-text-primary);
}
.dga-radial-stepper--64px .dga-radial-stepper__desc {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--64px .dga-radial-stepper__pre-name, .dga-radial-stepper--64px .dga-radial-stepper__next-name {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--48px .dga-circular-stepper__label--text {
...
.dga-radial-stepper--48px .dga-radial-stepper__name {
  color: var(--stepper-text-primary);
}
.dga-radial-stepper--48px .dga-radial-stepper__desc {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--48px .dga-radial-stepper__pre-name, .dga-radial-stepper--48px .dga-radial-stepper__next-name {
  color: var(--stepper-text-tertiary, #6C737F);
}
.dga-radial-stepper--40px .dga-circular-stepper__label--text {
  color: var(--text-primary-paragraph, #384250);
  font-family: "IBM Plex Sans Arabic";
  font-size: 8.75px;
  font-style: normal;
  font-weight: 700;
  line-height: 12.5px; /* 142.857% */
}
.dga-radial-stepper--40px .dga-radial-stepper__name {
  color: var(--stepper-text-primary);
}
.dga-radial-stepper--40px .dga-radial-stepper__desc {
  color: var(--stepper-text-tertiary);
}
.dga-radial-stepper--40px .dga-radial-stepper__pre-name, .dga-radial-stepper--40px .dga-radial-stepper__next-name {
  color: var(--stepper-text-tertiary);
}
.dga-radial-stepper--on-color .dga-circular-stepper__label--text {
  color: var(--text-oncolor-primary);
}
.dga-radial-stepper--on-color .dga-radial-stepper__name {
  color: var(--text-oncolor-primary);
}
.dga-radial-stepper--on-color .dga-radial-stepper__desc {
  color: var(--text-oncolor-secondary);
}
.dga-radial-stepper--on-color .dga-radial-stepper__pre-name, .dga-radial-stepper--on-color .dga-radial-stepper__next-name {
