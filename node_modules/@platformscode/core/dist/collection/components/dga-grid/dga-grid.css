...
@media (min-width: 0) {
  .dga-grid-container.xs-gap {
    --grid-column-gap: var(--grid-column-gap-xs, var(--grid-column-gap));
    --grid-row-gap: var(--grid-row-gap-xs, var(--grid-row-gap));
    column-gap: var(--grid-column-gap);
    row-gap: var(--grid-row-gap);
  }
}
@media (min-width: 600px) {
  .dga-grid-container.sm-gap {
    --grid-column-gap: var(--grid-column-gap-sm, var(--grid-column-gap));
    --grid-row-gap: var(--grid-row-gap-sm, var(--grid-row-gap));
    column-gap: var(--grid-column-gap);
    row-gap: var(--grid-row-gap);
  }
}
@media (min-width: 960px) {
  .dga-grid-container.md-gap {
    --grid-column-gap: var(--grid-column-gap-md, var(--grid-column-gap));
    --grid-row-gap: var(--grid-row-gap-md, var(--grid-row-gap));
    column-gap: var(--grid-column-gap);
    row-gap: var(--grid-row-gap);
  }
}
@media (min-width: 1280px) {
  .dga-grid-container.lg-gap {
    --grid-column-gap: var(--grid-column-gap-lg, var(--grid-column-gap));
    --grid-row-gap: var(--grid-row-gap-lg, var(--grid-row-gap));
    column-gap: var(--grid-column-gap);
    row-gap: var(--grid-row-gap);
  }
}
@media (min-width: 1920px) {
  .dga-grid-container.xl-gap {
    --grid-column-gap: var(--grid-column-gap-xl, var(--grid-column-gap));
    --grid-row-gap: var(--grid-row-gap-xl, var(--grid-row-gap));
    column-gap: var(--grid-column-gap);
    row-gap: var(--grid-row-gap);
  }
}
.dga-grid-container:not(.dga-grid-container--fluid) {
  margin-left: auto;
  margin-right: auto;
}
.dga-grid-container.dga-grid-container--no-gutters {
  padding-left: 0;
  padding-right: 0;
  gap: 0;
}
...
@media (min-width: 0) {
  ...
  .dga-grid-order-xs-10 {
    order: 10;
  }
  .dga-grid-order-xs-11 {
    order: 11;
  }
  .dga-grid-order-xs-12 {
    order: 12;
  }
}
@media (min-width: 600px) {
  ...
  .dga-grid-order-sm-10 {
    order: 10;
  }
  .dga-grid-order-sm-11 {
    order: 11;
  }
  .dga-grid-order-sm-12 {
    order: 12;
  }
}
@media (min-width: 960px) {
  ...
  .dga-grid-order-md-10 {
    order: 10;
  }
  .dga-grid-order-md-11 {
    order: 11;
  }
  .dga-grid-order-md-12 {
    order: 12;
  }
}
@media (min-width: 1280px) {
  ...
  .dga-grid-order-lg-10 {
    order: 10;
  }
  .dga-grid-order-lg-11 {
    order: 11;
  }
  .dga-grid-order-lg-12 {
    order: 12;
  }
}
@media (min-width: 1920px) {
  ...
  .dga-grid-order-xl-10 {
    order: 10;
  }
  .dga-grid-order-xl-11 {
    order: 11;
  }
  .dga-grid-order-xl-12 {
    order: 12;
  }
}
.dga-grid-item--grow {
...
.dga-grid-item[align-self=flex-start] {
  align-self: start;
}

.dga-grid-item[align-self=center] {
  align-self: center;
}

.dga-grid-item[align-self=flex-end] {
  align-self: end;
}

.dga-grid-item[align-self=stretch] {
  align-self: stretch;
}