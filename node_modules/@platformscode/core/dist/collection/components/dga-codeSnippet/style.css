...
.code-snippet-tabs ul li a {
  ...
  padding: var(--horizontal-tab-md-button-h-padding, 16px);
}
.code-snippet-tabs button {
  display: none;
}
...
.code-snippet-code-display .code-snippet-icon {
  position: absolute;
  inset-inline-end: 30px;
  inset-block-start: 30px;
  cursor: pointer;
}
.code-snippet-code-display .code-snippet-icon.single {
  inset-inline-end: 24px;
  inset-block-start: 24px;
}
.code-snippet-code-display .code-snippet-wrapper {
  display: flex;
  justify-content: end;
...
.code-snippet-code-display .code-snippet-wrapper .code-snippet-show_more p {
  background-color: transparent;
  padding: 0;
  margin: 0;
  color: var(--text-default, #161616);
...
.code-snippet-code-display code {
  display: block;
  overflow-y: hidden;
  height: auto;
}
...
.code-snippet-code-line:first-child .code-snippet-number_container span {
  padding-top: 24px;
}
.code-snippet-code-line:last-child .code-snippet-number_container span {
  padding-bottom: 24px;
}
.code-snippet-code-line:first-child .code-snippet-line-content {
  padding-top: 24px;
}
.code-snippet-code-line:last-child .code-snippet-line-content {
  padding-bottom: 24px;
}

.code-snippet-number_container {
  min-width: 70px;
  display: flex;
  justify-content: center;
  align-items: center;
  border-inline-end: 1px solid var(--border-neutral-secondary, #e5e7eb);
  background: var(--background-neutral-50, #f9fafb);
}
.code-snippet-number_container span {
...
.code-snippet-line-content.green {
