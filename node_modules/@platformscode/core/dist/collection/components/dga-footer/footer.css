...
.text-lg-semibold, .footer__nav-links-column-title {
...
.footer {
  display: flex;
  padding: var(--spacing-none, 0px) var(--spacing-4xl, 32px);
  justify-content: center;
  align-items: flex-start;
...
.footer-title-description {
  ...
  align-items: start;
  justify-content: space-between;
  margin-block: var(--spacing-7xl, 64px);
}
...
.footer .icons-container a {
  ...
  border: 1px solid var(--border-oncolor-transparent-30, rgba(255, 255, 255, 0.3019607843));
}
.footer .icons-container a.DarkGreen {
  border: 1px solid var(--border-oncolor-transparent-30, rgba(255, 255, 255, 0.3019607843));
}
.footer .icons-container a.Light {
...
.footer__nav-links-column-title {
  ...
  flex-direction: column;
  align-items: flex-start;
  border-bottom: 1px solid var(--border-neutral-primary, #d2d6db);
}
.footer__basic {
  display: flex;
  padding: var(--spacing-xl, 16px) var(--spacing-none, 0px);
...
.footer--bg-brand {
  ...
  color: var(--link-oncolor, #ffffff);
}
.footer--bg-brand .footer__nav-links-column-title {
  color: var(--text-oncolor-primary, #ffffff);
  border-color: var(--border-oncolor-transparent-30, rgba(255, 255, 255, 0.2980392157));
}
.footer--bg-brand .footer__copyright {
  color: var(--text-oncolor-primary, #ffffff);
}
@media only screen and (max-width: 600px) {
  .footer .footer__nav-links .footer__nav-links-column {
