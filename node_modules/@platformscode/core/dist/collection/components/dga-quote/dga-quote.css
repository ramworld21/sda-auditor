...
.text-xl-regular, .dga-quote__body-desc {
  font: 400 20px/30px "IBMPlexSansArabic";
}

.text-lg-regular, .dga-quote__auther-details .auther-desc {
...
.display-xs-medium, .dga-quote__body-title {
  font: 500 24px/32px "IBMPlexSansArabic";
}

.text-xl-medium, .dga-quote__auther-details .auther-title {
...
[dir=rtl] .dga-quote__body .quote-icon {
  transform: scaleX(1);
}
