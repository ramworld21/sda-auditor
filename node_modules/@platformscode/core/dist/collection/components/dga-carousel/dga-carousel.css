...
.KCarousel--arrows > .KCarousel-body {
  display: flex;
  align-items: center;
  gap: 44px;
}
.KCarousel--sm .KCarousel-arrow {
  width: 32px !important;
  height: 32px !important;
}
.KCarousel--sm .KCarousel-dot {
  width: 8px !important;
  height: 8px !important;
}
.KCarousel--md .KCarousel-arrow {
  width: 40px !important;
  height: 40px !important;
}
.KCarousel--md .KCarousel-dot {
  width: 12px !important;
  height: 12px !important;
}
.KCarousel--lg .KCarousel-arrow {
  width: 48px !important;
  height: 48px !important;
}
.KCarousel--lg .KCarousel-dot {
...
.KCarousel-container .KCarousel-slides {
  display: flex;
  height: 100%;
