...
.text-md-regular, .dga-textarea__field::placeholder, .dga-textarea__field {
  font: 400 16px/24px "IBMPlexSansArabic";
}

.text-sm-regular, .dga-textarea--lg .dga-textarea__field, .dga-textarea--lg .dga-textarea__field::placeholder, .dga-form-control > .dga-label {
...
.dga-shadow-md, .dga-textarea.focus {
...
.dga-textarea__field::placeholder {
  color: var(--form-field-text-placeholder);
}
.dga-textarea__field[disabled] {
  cursor: not-allowed;
}
.dga-textarea__field--hidden-scrollbar ::-webkit-scrollbar {
  display: none;
}
.dga-textarea__field--hidden-scrollbar {
...
.dga-textarea.focus::after {
  width: 100%;
}
.dga-textarea.active::after {
  width: 50%;
}
.dga-textarea--readonly, .dga-textarea--readonly:hover, .dga-textarea--disabled, .dga-textarea--disabled:hover {
  border-color: var(--input-text-disabled);
  box-shadow: none !important;
}
.dga-textarea--readonly::after, .dga-textarea--disabled::after {
  display: none;
}
.dga-textarea--readonly .dga-textarea__field, .dga-textarea--readonly .dga-textarea__field::placeholder, .dga-textarea--disabled .dga-textarea__field, .dga-textarea--disabled .dga-textarea__field::placeholder {
  color: var(--colors-text-primary);
}
.dga-textarea--disabled .dga-textarea__field, .dga-textarea--disabled .dga-textarea__field::placeholder {
  color: var(--input-text-disabled);
}
.dga-textarea--disabled .dga-textarea__icon span, .dga-textarea--disabled .dga-textarea__prefix--subtle-text, .dga-textarea--disabled .dga-textarea__prefix--solid-text {
  color: var(--input-text-disabled);
}
.dga-textarea__icon {
  height: 100%;
...
.dga-textarea__icon span {
  color: var(--colors-gray-neutral-700);
  font-size: 20px;
}
.dga-textarea__feedback-icon {
  height: fit-content;
  display: inline-flex;
  align-items: center;
  position: absolute;
...
.dga-textarea__feedback-icon span {
  font-size: 20px;
  position: relative;
  z-index: 0;
}
.dga-textarea__feedback-icon--success {
  color: var(--text-success);
}
.dga-textarea__feedback-icon--success span::after {
  background-color: var(--colors-brand-100);
}
.dga-textarea__feedback-icon--error {
  color: var(--form-field-border-error);
}
.dga-textarea__feedback-icon--error span::after {
  background-color: var(--form-field-border-error);
}
.dga-textarea__feedback-icon--warning {
  color: var(--text-warning);
}
.dga-textarea__feedback-icon--warning span::after {
  background-color: var(--colors-warning-100);
}
.dga-textarea__feedback-icon--warning-triangle {
  color: var(--text-warning);
}
.dga-textarea__feedback-icon--warning-triangle span::after {
  width: 0 !important;
  height: 0 !important;
...
.dga-textarea__feedback-icon--ring span::after {
  content: "";
  display: block;
  width: 100%;
  height: 100%;
...
[dir=rtl] .dga-textarea__feedback-icon {
  right: auto;
  left: 16px;
}
.dga-textarea__dropdown-btn.open + .dga-textarea__dropdown-list {
  z-index: 2;
  opacity: 1;
...
.dga-textarea--lighter {
  border: 0;
}
.dga-textarea--lighter:hover {
  border: 1px solid var(--form-field-border-default);
}
.dga-textarea--lighter.focus {
  border: 1px solid var(--form-field-border-default);
  background-color: var(--form-field-background-default);
}
.dga-textarea--lighter.active {
  border: 1px solid var(--form-field-border-default);
...
.dga-textarea--darker:hover {
  border: 1px solid var(--form-field-border-default);
}
.dga-textarea--darker.focus {
  border: 1px solid var(--form-field-border-default);
  background-color: var(--form-field-background-default);
}
.dga-textarea--darker.active {
  border: 1px solid var(--form-field-border-default);
  background-color: var(--form-field-background-default);
}
.dga-textarea--error, .dga-textarea--error:hover {
  outline-color: var(--form-field-border-error);
  border: 1px solid var(--form-field-border-error);
}
.dga-textarea--error::after {
  background-color: var(--form-field-border-error);
}
.dga-textarea--lg {
  height: auto;
...
.dga-textarea--lg__feedback-icon span {
  font-size: 20px;
}
