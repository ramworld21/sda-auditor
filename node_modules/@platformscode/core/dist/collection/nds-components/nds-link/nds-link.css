...
.text-md-regular, .dga-link--md, .dga-link {
  font: 400 16px/24px "IBMPlexSansArabic";
}

.text-sm-regular, .dga-link--sm {
...
.dga-link:hover .dga-link__label {
  text-decoration: underline;
}
.dga-link--inline .dga-link__label {
  text-decoration: underline;
}
.dga-link, .dga-link--primary {
  color: var(--link-primary);
}
.dga-link:hover, .dga-link--primary:hover {
  color: var(--link-primary-hovered);
}
.dga-link:active, .dga-link--primary:active {
  color: var(--link-primary-pressed);
}
.dga-link--neutral {
  color: var(--link-neutral);
}
.dga-link--neutral:hover {
  color: var(--link-neutral-hovered);
}
.dga-link--neutral:active {
...
.dga-link--disabled:hover {
  color: var(--link-oncolor-disabled);
}
.dga-link--disabled:hover .dga-link__label {
  text-decoration: none;
}
.dga-link--md .dga-link__icon, .dga-link--md .dga-link__icon svg {
  width: 20px;
  height: 20px;
}
.dga-link--sm .dga-link__icon, .dga-link--sm .dga-link__icon svg {
  width: 16px;
  height: 16px;
}

:is(html[lang=ar], html[dir=rtl]) .dga-link {
