...
.text-md-medium, .NdsFloatingButton-root {
...
.NdsFloatingButton-sm {
  padding: var(--spacing-xl, 16px);
}
.NdsFloatingButton-lg {
  padding: var(--spacing-2xl, 20px);
}
.NdsFloatingButton-primary-brand {
  color: var(--text-oncolor-primary);
  background-color: var(--button-background-primary-default);
}
.NdsFloatingButton-primary-brand:hover {
  background-color: var(--button-background-primary-hovered);
}
.NdsFloatingButton-primary-brand:active {
  background-color: var(--button-background-primary-pressed);
}
.NdsFloatingButton-primary-brand--inverted {
  color: var(--text-oncolor-primary);
  background-color: var(--button-background-primary-default);
}
.NdsFloatingButton-primary-brand--inverted:hover {
  background-color: var(--button-background-primary-hovered);
}
.NdsFloatingButton-primary-brand--inverted:active {
  background-color: var(--button-background-primary-pressed);
}
.NdsFloatingButton-primary-neutral {
  color: var(--text-oncolor-primary);
  background-color: var(--button-background-black-default, #0D121C);
}
.NdsFloatingButton-primary-neutral:hover {
  background-color: var(--button-background-black-hovered);
}
.NdsFloatingButton-primary-neutral:active {
  background-color: var(--button-background-black-pressed);
  outline: none;
}
.NdsFloatingButton-primary-neutral--inverted {
  color: var(--text-default);
  background-color: var(--button-background-oncolor-default);
}
.NdsFloatingButton-primary-neutral--inverted:hover {
  background-color: var(--button-background-oncolor-hovered);
}
.NdsFloatingButton-primary-neutral--inverted:active {
  background-color: var(--button-background-oncolor-pressed);
}
.NdsFloatingButton-secondary-solid {
  color: var(--text-default);
  background-color: var(--button-background-neutral-default);
}
.NdsFloatingButton-secondary-solid:hover {
  background-color: var(--button-background-neutral-pressed);
}
.NdsFloatingButton-secondary-solid:active {
  background-color: var(--button-background-neutral-pressed);
}
.NdsFloatingButton-secondary-solid--inverted {
  color: var(--text-oncolor-primary);
  background-color: var(--button-background-transparent-hovered);
}
.NdsFloatingButton-secondary-solid--inverted:hover {
  background-color: var(--button-background-transparent-hovered);
}
.NdsFloatingButton-secondary-solid--inverted:active {
