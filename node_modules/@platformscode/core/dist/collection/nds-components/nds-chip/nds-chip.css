...
.chip--neutral.selected {
  color: var(--text-oncolor-primary);
  background: var(--chip-background-neutral-selected, #384250);
}
.chip--success {
...
.chip--on-color.selected {
  color: var(--text-default);
  background: var(--chip-background-on-color-selected, rgba(255, 255, 255, 0.7));
}
.chip--neutral.disabled, .chip--success.disabled, .chip--on-color.disabled {
  color: var(--text-default-disabled);
  background-color: var(--background-disabled);
}
.chip--neutral:focus-visible, .chip--success:focus-visible, .chip--on-color:focus-visible {
  border: 3px solid var(--icon-default, #161616);
}