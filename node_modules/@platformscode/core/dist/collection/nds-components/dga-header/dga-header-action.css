...
.text-sm-regular, .dga-breadcrumb-dropdown-item, .sub-menu__link-helper {
...
.text-md-medium, .header-menu__item-label, .header-menu__item-icon, .header-menu__item-arrow {
...
.text-md-semibold, .sub-menu__link-label, .header-menu__item--disabled .header-menu__item-label,
.header-menu__item--disabled .header-menu__item-icon,
.header-menu__item--disabled .header-menu__item-arrow, .header-menu__item--disabled:hover .header-menu__item-label,
.header-menu__item--disabled:hover .header-menu__item-icon,
.header-menu__item--disabled:hover .header-menu__item-arrow, .header-menu__item--disabled:focus .header-menu__item-label,
.header-menu__item--disabled:focus .header-menu__item-icon,
.header-menu__item--disabled:focus .header-menu__item-arrow, .header-menu__item--disabled:active .header-menu__item-label,
.header-menu__item--disabled:active .header-menu__item-icon,
.header-menu__item--disabled:active .header-menu__item-arrow, .header-menu__item--active:hover .header-menu__item-label,
.header-menu__item--active:hover .header-menu__item-icon,
.header-menu__item--active:hover .header-menu__item-arrow, .header-menu__item--active:focus .header-menu__item-label,
.header-menu__item--active:focus .header-menu__item-icon,
.header-menu__item--active:focus .header-menu__item-arrow, .header-menu__item--active:active .header-menu__item-label,
.header-menu__item--active:active .header-menu__item-icon,
.header-menu__item--active:active .header-menu__item-arrow, .header-menu__item--active .header-menu__item-label,
...
.text-lg-bold, .sub-menu__column-title, .sub-menu__column__label {
...
.dga-shadow-lg, .header__sub-menu {
  box-shadow: var(--shadow-lg);
}

.dga-shadow-xl, .dga-breadcrumb-dropdown {
...
.header-menu__item--active:hover::after, .header-menu__item--active:focus::after, .header-menu__item--active:active::after {
  content: "";
  display: block;
  width: calc(100% - var(--spacing-md) * 2);
  height: 6px;
...
.header-menu__item--active:hover::before, .header-menu__item--active:focus::before, .header-menu__item--active:active::before {
  border: 0;
}
...
.header-menu__item--disabled:focus .header-menu__item-arrow, .header-menu__item--disabled:active .header-menu__item-label,
.header-menu__item--disabled:active .header-menu__item-icon,
.header-menu__item--disabled:active .header-menu__item-arrow {
...
.dga-breadcrumb-dropdown [dir=rtl] {
  right: auto;
  left: 0;
}
.dga-breadcrumb-dropdown-item {
  display: flex;
...
.dga-breadcrumb-dropdown-item:hover {
  border-radius: var(--radius-xs);
  background: var(--button-background-neutral-hovered);
  mix-blend-mode: multiply;
}
.dga-breadcrumb-dropdown-item:active {
  border-radius: var(--radius-xs);
