...
.text-md-medium, .logo-placeholder--lg .logo-text {
  font: 500 16px/24px "IBMPlexSansArabic";
}

.text-sm-medium, .logo-placeholder--md .logo-text {
  font: 500 14px/20px "IBMPlexSansArabic";
}

.text-xs-medium, .logo-placeholder--sm .logo-text {
...
.logo-placeholder--side {
  display: inline-flex;
  padding: 5px 4px;
  align-items: center;
  gap: 8px;
}
.logo-placeholder--sm .logo-image {
  width: auto;
  height: 32px;
}
...
.logo-placeholder--md .logo-image {
  width: auto;
  height: 48px;
}
.logo-placeholder--md .logo-text {
  color: var(--Text-text-secondary-paragraph, #6c737f);
  text-align: right;
}
.logo-placeholder--lg .logo-image {
  width: auto;
  height: 64px;
}
.logo-placeholder--lg .logo-text {
  color: var(--Text-text-secondary-paragraph, #6c737f);
  text-align: right;
}