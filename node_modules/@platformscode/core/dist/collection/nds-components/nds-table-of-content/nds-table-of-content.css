...
.text-sm-regular, .table-of-content__tab-label {
...
.text-sm-semibold, .table-of-content__tab.selected .table-of-content__tab-label, .table-of-content__tab.active .table-of-content__tab-label {
...
.table-of-content__tab-list {
  list-style: none;
  padding: 0;
}
.table-of-content__tab-sublist {
  list-style: none;
  padding: 0;
}
...
.table-of-content__tab-sublist .table-of-content__tab.active::before, .table-of-content__tab-sublist .table-of-content__tab.active::after {
...
.table-of-content__tab.active::before {
  display: block;
  background-color: var(--background-primary);
}
...
.table-of-content.rtl .table-of-content__tab-sublist .table-of-content__tab {
  padding-left: unset;
  padding-right: calc(var(--spacing-xl) * 2);
}
.table-of-content.rtl .table-of-content__tab-sublist .table-of-content__tab::before {
  left: unset;
  right: 16px;
}
.table-of-content.rtl .table-of-content__tab-sub-sublist .table-of-content__tab {
  padding-left: unset;
  padding-right: calc(var(--spacing-xl) * 3);
}
.table-of-content.rtl .table-of-content__tab-sub-sublist .table-of-content__tab::before {
  left: unset;
  right: 16px;
}
.table-of-content.rtl .table-of-content__tab-sub-sublist .table-of-content__tab::after {
  left: unset;
  right: 32px;
}
.table-of-content.rtl .table-of-content__tab::before {
  left: unset;
  right: 0;
  top: 0;
}