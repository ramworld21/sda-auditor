...
.dga-btn--primary-neutral--selected {
...
.dga-btn--primary-brand--selected {
...
.dga-btn--secondary-solid:visited {
  background: var(--button-background-neutral-default-pressed);
}
.dga-btn--secondary-solid--selected {
...
.dga-btn--secondary-solid:disabled, .dga-btn--secondary-solid[disabled] {
  background: var(--background-disabled);
  color: var(--text-default-disabled);
}
.dga-btn--secondary-solid--on-color {
  background-color: var(--button-background-transparent-hovered);
  color: var(--text-oncolor-primary);
}
.dga-btn--secondary-solid--on-color:hover {
  background-color: var(--button-background-transparent-hovered);
}
...
.dga-btn--secondary-solid--on-color:active {
  background-color: var(--Button-button-background-transparent-pressed);
  color: var(--text-oncolor-primary);
}
.dga-btn--secondary-solid--on-color:disabled, .dga-btn--secondary-solid--on-color[disabled] {
  background-color: var(--button-background-disabled-on-color);
  color: var(--text-default-oncolor-disabled);
}
...
.dga-btn--secondary-outline--selected {
...
.dga-btn--subtle--selected, .dga-btn--close--selected, .dga-btn--sort--selected {
  background: var(--button-background-neutral-selected);
}
...
.dga-btn--des-primary-brand, .dga-btn--des-primary-neutral {
  background-color: var(--button-background-danger-primary-default);
  color: var(--text-oncolor-primary);
}
.dga-btn--des-primary-brand:hover, .dga-btn--des-primary-neutral:hover {
  background: var(--button-background-danger-primary-hovered);
}
.dga-btn--des-primary-brand:visited, .dga-btn--des-primary-neutral:visited {
  background: var(--button-background-danger-primary-pressed);
}
.dga-btn--des-primary-brand:active, .dga-btn--des-primary-neutral:active {
  background: var(--button-background-danger-primary-selected);
  outline: none;
}
.dga-btn--des-primary-brand:active::after, .dga-btn--des-primary-neutral:active::after {
  display: none !important;
}
.dga-btn--des-primary-brand:disabled, .dga-btn--des-primary-brand[disabled], .dga-btn--des-primary-neutral:disabled, .dga-btn--des-primary-neutral[disabled] {
  background: var(--background-disabled);
  color: var(--text-default-disabled);
}
.dga-btn--des-secondary-solid {
  background-color: var(--button-background-danger-secondary-default);
  color: var(--text-error);
}
.dga-btn--des-secondary-solid:hover {
  background: var(--button-background-danger-secondary-hovered);
}
.dga-btn--des-secondary-solid:visited {
  background: var(--button-background-danger-secondary-pressed);
}
.dga-btn--des-secondary-solid:active {
  background: var(--button-background-danger-secondary-selected);
  outline: none;
}
.dga-btn--des-secondary-solid:active::after {
  display: none !important;
}
.dga-btn--des-secondary-solid:disabled, .dga-btn--des-secondary-solid[disabled] {
  background: var(--background-disabled);
  color: var(--text-default-disabled);
}
