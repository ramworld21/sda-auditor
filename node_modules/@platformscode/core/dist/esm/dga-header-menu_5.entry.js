import { r as registerInstance, h, a as getElement, F as Fragment } from './index-D0dWnGvB.js';
export { D as dga_nav_header_sub_menu_column, a as dga_nav_header_sub_menu_link } from './dga-nav-header-sub-menu-link-Bs-kOTHt.js';
...
const DgaHeaderMenu = class {
    ...
    render() {
        return (h("div", { key: '15b15e7d62b7acbe589d9c574267ea34a9079291', style: { position: 'relative' } }, h("dga-button-v2", { key: '5b76efcea2c2b55a4fbdaf589c84a3b46a32c6d6', "aria-haspopup": "true", "aria-expanded": this.isMenuOpen ? 'true' : 'false', iconOnly: true, leadIcon: true, leadIconProps: {
                name: this.icon,
                size: 24,
                variant: 'solid',
                type: 'rounded',
            }, variant: "transparent", onClick: this.toggleMenu, class: "header-menu__btn" }), this.isMenuOpen && (h("ul", { key: '81d73d14fbe4e1ea897b365fb7db6e749de203f9', class: "dga-breadcrumb-dropdown" }, this.actions.map(action => (h("li", { key: action === null || action === void 0 ? void 0 : action.label, class: "dga-breadcrumb-dropdown-item" }, h("a", { onClick: action.onClick }, h("span", { class: "link__label" }, action.label)))))))));
    }
...
const DgaHeaderMobileActions = class {
    ...
    render() {
        return (h(Fragment, { key: '3f308c3ad8c285b216a01c090528d77f0c78a87a' }, h("div", { key: '3112e8aac9c3e03ba8843d87086760e3feba2f5a', style: { position: 'relative' } }), h("ul", { key: '2672ead1d0e195cb91fe72649b93e3fc1b60c2a6', class: "header-nav__mobile-actions" }, h("slot", { key: '43190fc1bad4d2280e2ef9d7bb0db7738f2e51c1' }))));
    }
    get el() { return getElement(this); }
};
...
const DgaNavHeaderSubMenu = class {
    ...
    render() {
        ...
        return (h("div", { key: 'eb4c31ab7d7f52a8760300629882e38c85c7c69a', class: `header__sub-menu header__sub-menu--bg-${this.background} ${fullWidthClass}`, ref: el => (this.submenu = el) }, h("div", { key: '34a2361361d6fd63cabf76d5f52e9b4db9e2a809', class: "sub-menu__container" }, h("slot", { key: 'b323c3a7ea1546596fa13ea9c46579c4ff5d8ecf' }))));
    }
    get el() { return getElement(this); }
