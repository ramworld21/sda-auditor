...
const CircleSkeleton = class {
    ...
    render() {
        return (h("div", { key: '1c4aba90588b8e23561c6999447db5a2bceccff4', style: { width: this.width, height: this.width }, class: `circle_skeleton type${this.type}` }));
    }
};
...
const LineSkeleton = class {
    ...
    render() {
        return (h("div", { key: 'a531aa32cc62a525b2026fdf0ab940b04e6b8928', class: `line_text ${this.size} type${this.type}` }));
    }
};
...
const RectangleSkeleton = class {
    ...
    render() {
        return (h("div", { key: '06beaee8ae43981602ad4274fcecdd7841e3e590', class: `rectangle_text ${this.size} type${this.type} ${this.width}` }));
    }
};
...
const SquareSkeleton = class {
    ...
    render() {
        return (h("div", { key: '800fd0011d6ce7f4b2b608f6f4b1694453e6a549' }, h("div", { key: '0781af9c657c121922acf68654c18b4e0d737fff', style: { width: this.width, height: this.width }, class: `square_skeleton type${this.type} ${this.getBorderRadius()}` })));
    }
};
