...
const DgaListItem = class {
    ...
    render() {
        return (h("li", { key: 'ee5d363e9395b593ff80371ea1a65861fd70afac', class: this.getListClass() }, this.type === 'with-icon' && (h("span", { key: '1ea9d4de5e16598d56bdf75d9fe8012c11d16568', class: "list-item__icon", innerHTML: this.icon })), this.renderMarker(), h("span", { key: '9845921287938f5bf82cfa03cddbcbe659a3f59f', class: "list-item__text" }, this.itemText)));
    }
...
const DgaListV2 = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '1a9abdf72c04b885df645dc0bb360c6cfee1e124', class: `list list--${this.type} list--${this.color}` }, h("slot", { key: 'f4766b759415bbcd1ecaa3d0868cfd63f09b4117' })));
    }
};
