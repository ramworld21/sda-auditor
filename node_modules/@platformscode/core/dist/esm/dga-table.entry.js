...
const DgaTable = class {
    ...
    render() {
        return (h("div", { key: '052ab0152b8551f26a20b18a1ef77d48b9862873', class: `table-wrapper ${this.contained ? 'table-contained' : ''}` }, h("table", { key: 'da609690b436f6fb54b098ee0ce6482bd6e4f247', class: ` azm-table ${this.contained ? 'table-contained' : ''}`, style: { direction: this.direction ? 'rtl' : 'ltr' } }, h("slot", { key: '248067b86031f1589d37fa6f9dd82f1ef9aca54c' }))));
    }
};

export { DgaTable as dga_table };
