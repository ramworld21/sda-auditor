...
const RadioButton = class {
    ...
    render() {
        ...
        return (h("label", { key: '9a755b8617511153cd0a885dad357de5fbf592b5', ref: el => (this.radioLabelRef = el), id: this.id, class: `radio ${this.color ? 'radio--' + this.color : ''}`, style: inlineStyles, onMouseDown: this.handleActive, onMouseUp: this.handleRemoveActive, onMouseOut: this.handleRemoveActive, onChange: this.handleRemoveActive }, h("div", { key: 'c7d2c762ba9493b9a84eeb2214ee4464c5f610cd', class: "radio-main" }, h("div", { key: '39e5cbe65ee62831302baad96b4c0a38632f11ed', class: "radio-main__content" }, h("input", { key: '5ebb2aeb712ffa3c721da54cddd1a109ddf5926c', type: "radio", name: this.name, value: this.value,
            // id={this.id}
            onChange: this.onChange, onInput: this.onInput, disabled: this.disabled,
            // onFocus={this.handleFocus}
            // onBlur={this.handleFocusOut}
            checked: this.checked }), h("div", { key: '1d9eae662de9eadb522924c2532f2e31503d773f', class: "radio-container" }), (this.label || this.hasHelperText) && h("div", { key: 'bb763cadd2c195c4a5fddbfdda9e636eef9be74b', class: "dga-flex-column" }, this.label && h("span", { key: '0b418223e1f88bae0576bce5b7b771252a18c6e9', class: "radio__label" }, this.label), this.hasHelperText && this.helperText && h("span", { key: 'f1ec4b5ce0c7ed21e14b0d14acabae8c14dccffc', class: "radio__helper-text" }, this.helperText))), this.alertMessage && this.alertText && (h("div", { key: '5bca517fe1f30df010a6c4df382f8ef10e8c307c', class: "radio__warning" }, h("span", { key: '33dc678c28b43fab6acf69f4750f71e579507665', class: "radio__warning-icon" }, h("i", { key: '27629f21c6d473f6962ea8c26314d605b0b0bfaa', class: 'hgi-stroke hgi-alert-circle', style: { fontSize: "16px" } })), h("span", { key: 'b931b654501164a157ce9ef4c5f30e3d31b92095', class: "radio__warning-text" }, this.alertText))))));
    }
...
export { RadioButton as dga_radio_button };
