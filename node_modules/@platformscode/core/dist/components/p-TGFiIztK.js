...
const FloatingButton = /*@__PURE__*/ proxyCustomElement(class FloatingButton extends H {
    ...
    render() {
        return (h("button", { key: '39ce5fcf1cd40cc83e8bfd064ab3fc752efe6c6b', dir: this.RTL ? 'rtl' : 'ltr', disabled: this.disabled, class: `floating-button-onColor-${this.onColor} floating-button-btn ${this.variant} ${this.size} `, onClick: (event) => this.handleClick(event) }, this.icon && (h("div", { key: '16152d01eb9bb1849a430d93872774a2f9991c49', class: "floating-button-icon" }, this.renderIcon(this.icon, this.iconProps))), this.label && !this.iconOnly && h("p", { key: '033685fc8e45c75d90bd8f6dc91aba1a2651e68f' }, this.label)));
    }
