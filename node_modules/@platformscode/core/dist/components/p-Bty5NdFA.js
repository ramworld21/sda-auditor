...
import { d as defineCustomElement$1 } from './p-D3vljtDG.js';
...
const DgaFileUpload = /*@__PURE__*/ proxyCustomElement(class DgaFileUpload extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaFileUploadCss; }
}, [1, "dga-file-upload", {
        "id": [1],
        "name": [1],
        "accept": [1],
        "multiple": [4],
        "title": [1],
        "fileTypesText": [1, "file-types-text"],
        "actionName": [1, "action-name"],
        "maximumFilesSize": [2, "maximum-files-size"],
        "disabled": [4],
        "getUploadedFile": [16, "get-uploaded-file"],
        "uploadFileOverSize": [16, "upload-file-over-size"],
        "onChange": [16, "on-change"],
        "emitDeleteFile": [16, "emit-delete-file"],
        "files": [32],
        "dragState": [32]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-file-upload", "dga-loading"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-file-upload":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaFileUpload);
            }
            break;
        case "dga-loading":
            if (!customElements.get(tagName)) {
...
export { DgaFileUpload as D, defineCustomElement as d };
