...
import { d as defineCustomElement$4 } from './p-ByzFFJgL.js';
import { d as defineCustomElement$3 } from './p-CCimZGO2.js';
...
function defineCustomElement() {
    ...
    const components = ["dga-slideout-menu-header", "dga-button-v2", "dga-featured-icon", "dga-flex", "dga-icon", "dga-icon-v2"];
