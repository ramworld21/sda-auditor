import { p as proxyCustomElement, H, c as createEvent, h } from './p-BhqVmlhr.js';
...
function defineCustomElement() {
    ...
    const components = ["dga-button-v2", "dga-icon-v2"];
