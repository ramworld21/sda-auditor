...
import { d as defineCustomElement$1 } from './p-Dh42HLiJ.js';
...
const DgaDigitalSignature = /*@__PURE__*/ proxyCustomElement(class DgaDigitalSignature extends H {
    constructor() {
        super();
        this.__registerHost();
        this.language = 'en';
...
function defineCustomElement() {
    ...
    const components = ["dga-digital-signature", "dga-icon", "dga-link"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-digital-signature":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaDigitalSignature);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaDigitalSignature as D, defineCustomElement as d };
