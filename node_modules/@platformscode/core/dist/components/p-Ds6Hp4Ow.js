...
import { d as defineCustomElement$a } from './p-B4U0lY4y.js';
import { d as defineCustomElement$9 } from './p-ChhNw26D.js';
import { d as defineCustomElement$8 } from './p-DTQNJ3_g.js';
import { d as defineCustomElement$7 } from './p-BDegpq_a.js';
import { d as defineCustomElement$6 } from './p-DN3DJd5E.js';
import { d as defineCustomElement$5 } from './p-DBTOrdV2.js';
import { d as defineCustomElement$4 } from './p-Cxhq_uxn.js';
import { d as defineCustomElement$3 } from './p-BldfN9G_.js';
import { d as defineCustomElement$2 } from './p-BE95gJkd.js';
import { d as defineCustomElement$1 } from './p-C99Dr3jt.js';
...
const DgaFilteration = /*@__PURE__*/ proxyCustomElement(class DgaFilteration extends H {
    constructor() {
        super();
        this.__registerHost();
        this.onFilterChange = createEvent(this, "onFilterChange");
        ...
        switch (block.type) {
            ...
            case 'range':
                return (h("div", { class: "filteration__range" }, h("dga-text-input", { type: "number", size: "md", placeholder: "Min", value: ((_e = this.rangeValues[block.id]) === null || _e === void 0 ? void 0 : _e.min) || null, onChange: e => {
                    ...
                    } }), h("i", { class: 'hgi-duotone hgi-solid-line-01', style: { fontSize: '20px' } }), h("dga-text-input", { type: "number", size: "md", placeholder: "Max", value: ((_f = this.rangeValues[block.id]) === null || _f === void 0 ? void 0 : _f.max) || null, onChange: e => {
                        var _a;
    ...
    static get style() { return dgaFilterationCss; }
}, [0, "dga-filteration", {
        "initvalue": [16],
        "buttonLabel": [1, "button-label"],
        "filterBlocks": [16, "filter-blocks"],
        "maxBlockHeight": [2, "max-block-height"],
        "isFilterPanelOpen": [32],
        "selectedFilters": [32],
        "expandedBlocks": [32],
        "tempFilters": [32],
        "sliderValues": [32],
...
function defineCustomElement() {
    ...
    const components = ["dga-filteration", "dga-button-v2", "dga-checkbox", "dga-chip", "dga-helper-text", "dga-icon", "dga-icon-v2", "dga-label", "dga-radio-button", "dga-slider", "dga-text-input"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-filteration":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaFilteration);
            }
            break;
        case "dga-button-v2":
            if (!customElements.get(tagName)) {
...
export { DgaFilteration as D, defineCustomElement as d };
