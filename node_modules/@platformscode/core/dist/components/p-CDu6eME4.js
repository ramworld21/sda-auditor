...
const DgaNumberInput = /*@__PURE__*/ proxyCustomElement(class DgaNumberInput extends H {
    ...
    render() {
        return (h(Host, { key: 'f5bdaa59b58f1f829d798b558dbac602fe5117f9', id: this.componentId, style: this.rootStyles }, h("div", { key: '7db80d23339daf4beab8f0c2eba0d9d86cd36c53', class: "dga-form-control" }, this.label && h("dga-label", { key: '057607b6fe032d3b4306ac9d46d9f61307527485', label: this.label, size: this.size, required: this.required, disabled: this.disabled }), h("div", { key: 'eaffaedc94003b3c34c7f5891eebfc395f453dad', class: `dga-number-input dga-number-input--${this.size} ${this.error ? 'dga-number-input--error' : ''} ${this.fullwidth ? 'dga-number-input--full-width' : ''} ${this.variant !== 'default' ? `dga-number-input--${this.variant}` : ''} ${this.isActive ? 'active' : ''} ${this.isFocused ? 'focus' : ''} ${this.disabled ? 'dga-number-input--disabled' : ''} ${this.readonly ? 'readOnly' : ''}`, ref: el => (this.inputContainerRef = el) }, h("button", { key: '6f4cc28f61fa2e3672565abc388e6edd6e941097', class: `dga-number-input__prefix`, onClick: this.handleIncrement, disabled: this.disabled || this.readonly }, h("span", { key: 'fd9bd43c62d8e64ec09ad6a78160971aab163f77', class: "dga-number-input__prefix-icon" }, h("dga-icon", { key: 'a052b44a7ebbf78b664e0363e01e4281774094bf', icon: "plus-sign", variant: "stroke", type: "rounded" }))), h("input", { key: '0078eed2af7970e2bc7e44fb54eaa4bbbced7629',
            // id={id}
            value: this.value, name: this.name, type: 'number', onFocus: () => (this.isFocused = true), onBlur: e => {
                this.isFocused = false;
                this.onBlur(e);
            }, class: "dga-number-input__field", placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onMouseDown: () => (this.isActive = true), onMouseUp: () => (this.isActive = false), onMouseOut: () => (this.isActive = false), onChange: this.onChange, onInput: this.onInput }), h("button", { key: 'c0cf4b1775ebc48d632eb804c3f57cdab65ceb1d', class: `dga-number-input__suffix`, onClick: this.handleDecrement, disabled: this.disabled || this.readonly }, h("span", { key: 'e7749fefebc37305323b8f3a4104c0965be7b50a', class: "dga-number-input__suffix-icon" }, h("dga-icon", { key: 'a0339f89ccf78e20baf67baa4b6b9a5f9f785004', icon: "minus-sign", variant: "stroke", type: "rounded" })))), this.helperText && h("dga-helper-text", { key: 'cdfda5eb65940b57dd74627e1d7f8b803686ef9f', helperText: this.helperText, helperTextIcon: this.helperTextIcon, error: this.error }))));
    }
    get el() { return this; }
