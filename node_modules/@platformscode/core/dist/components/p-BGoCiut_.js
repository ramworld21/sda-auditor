...
const NdsFloatingButton = /*@__PURE__*/ proxyCustomElement(class NdsFloatingButton extends H {
    ...
    render() {
        return (h("button", { key: '5a3680ba3a86e6ec15013080ee780dbf9a6598be', dir: this.RTL ? 'rtl' : 'ltr', disabled: this.disabled, class: `
            NdsFloatingButton-root
            ${this.inverted ? `NdsFloatingButton-${this.variant}--inverted` : `NdsFloatingButton-${this.variant}`}
            NdsFloatingButton-${this.size} `, onClick: event => this.handleClick(event) }, h("slot", { key: '38f245d63343d0bf06d64494ca7d31a20b9be142', name: "icon" }, this.icon && h("dga-icon-v2", Object.assign({ key: '34098f63414dbcf5ef034a23ee25c52d1dc06026', name: this.icon }, this.iconProps))), !this.iconOnly && this.label && h("span", { key: 'af86c9efac969faa24b98aafcbe3a0be21a7f014', class: "NdsFloatingButton-label" }, this.label)));
    }
...
function defineCustomElement() {
    ...
    const components = ["nds-floating-button", "dga-icon-v2"];
