...
const DgaMenuV2 = /*@__PURE__*/ proxyCustomElement(class DgaMenuV2 extends H {
    ...
    render() {
        return (h(Fragment, { key: '87e4e1ba165d7af811e7d6dd0a5e3b9caada52af' }, this.open && (h("ul", { key: '00585f198219ee4cc7aa275a92a48dd1e3f1ada8', class: "menu", style: this.menuStyle, role: "menu", "aria-hidden": !this.open }, h("slot", { key: '5714384fa9332a6bd92f8f3cf352dda1043c8b42' })))));
    }
