...
const DgaStatusTag = /*@__PURE__*/ proxyCustomElement(class DgaStatusTag extends H {
    ...
    render() {
        return (h(Host, { key: '507d21b8df6c0e03b9a51d74841100fdcbc3af0b', id: this.componentId, style: this.rootStyles }, h("span", { key: '791546020efbc42788f2f0dcf1cf4948a11edfc7', class: `status-tag status-tag--${this.color} status-tag--${this.size} status-tag--${this.status}` }, h("span", { key: 'edeb11f510afac40a32d7df0d274cf6f5a5a6c8c', class: "status-tag__indicator" }), this.label, h("slot", { key: '924b360f34a82f37eb5607b3188c316f4b16c7ae' }))));
    }
    get el() { return this; }
