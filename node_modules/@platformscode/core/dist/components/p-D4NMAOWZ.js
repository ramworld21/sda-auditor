...
const DgaCarousel = /*@__PURE__*/ proxyCustomElement(class DgaCarousel extends H {
    constructor() {
        super();
        this.__registerHost();
        this.DIRECTION = {
    ...
    get el() { return this; }
    static get style() { return dgaCarouselCss; }
}, [4, "dga-carousel", {
        "variant": [1],
        "showDots": [4, "show-dots"],
        "steps": [2],
        "transitionDuration": [2, "transition-duration"],
        "Dir": [1, "dir"],
        "size": [1],
        "arrowsVariant": [1, "arrows-variant"],
        "arrows": [16],
        "childWidth": [32],
        "childrenLength": [32],
        "currentSlideIndex": [32]
    }]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-carousel", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-carousel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaCarousel);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaCarousel as D, defineCustomElement as d };
