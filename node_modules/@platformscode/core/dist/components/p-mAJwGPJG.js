...
const SubmenuComponent = /*@__PURE__*/ proxyCustomElement(class SubmenuComponent extends H {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    render() {
        ...
        "route": [16],
        "childRoute": [16, "child-route"],
        "onChildExpanded": [16, "on-child-expanded"]
    }]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["submenu-component", "dga-icon-v2", "dga-tag", "submenu-component", "tab-link"];
    components.forEach(tagName => { switch (tagName) {
        case "submenu-component":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SubmenuComponent);
            }
            break;
        case "dga-icon-v2":
            if (!customElements.get(tagName)) {
...
export { SubmenuComponent as S, defineCustomElement as d };
