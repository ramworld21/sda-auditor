...
const DgaFeaturedIcon = /*@__PURE__*/ proxyCustomElement(class DgaFeaturedIcon extends H {
    ...
    render() {
        return (h("div", { key: '71270394c243421ce4d056e145acab9e2cd73be2', class: `dga-featured-icon ${this.circle ? "dga-featured-icon--circle" : ""} dga-featured-icon--${this.size} dga-featured-icon--${this.variant}-${this.color}` }, h("dga-icon", { key: '7dadc95fe36fa0e91a7bc4bf7933abd702bd2dfb', icon: this.icon.name, variant: this.icon.variant, type: this.icon.type, size: this.iconFonts[this.size] })));
    }
