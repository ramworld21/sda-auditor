...
const DgaTextarea = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2e7f126c3588b93816ee936a23255e913442670d', id: this.componentId, style: this.rootStyles }, index.h("div", { key: 'bf8c6095df8c21aa0ccce8b273dc89e3fbd40204', class: { 'dga-form-control': true, 'dga-form-control--fullwidth': this.fullwidth } }, this.label && index.h("label", { key: 'e703df789e202bc7c3e7f0c1ee7df4eddc9a11f1', class: "dga-label" }, this.label), index.h("div", { key: '43040d3a63471c41e3d2f426dea82c9f09a50379', class: `dga-textarea dga-textarea--lg ${this.error ? 'dga-textarea--error' : ''} ${this.variant !== 'default' ? `dga-textarea--${this.variant}` : ''} ${this.isActive ? 'active' : ''} ${this.isFocused ? 'focus' : ''} ${this.disabled ? 'disabled' : ''}`, ref: el => (this.inputContainerRef = el), "data-error": this.error }, index.h("textarea", { key: 'a00b2bba5e66620ab112b7490880faf53e089051', ref: (el) => (this.textAreaEl = el), onFocus: () => (this.isFocused = true), onBlur: () => (this.isFocused = false), class: `dga-textarea__field ${this.resize ? 'dga-textarea__field--resize' : ''} ${!this.scrollbar ? 'dga-textarea__field--hidden-scrollbar' : ''}`, placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, rows: this.rows && this.rows, cols: this.cols && this.cols, onMouseDown: () => (this.isActive = true), onMouseUp: () => (this.isActive = false), onMouseOut: () => (this.isActive = false), onChange: this.onChange, onInput: this.onInput, name: this.name, value: this.value }), this.error ? (index.h("span", { class: `dga-textarea__feedback-icon dga-textarea__feedback-icon--error ${this.feedbackIconRing ? 'dga-textarea__feedback-icon--ring' : ''}` }, feedbackIconTypes['error'])) : this.feedbackIcon ? (index.h("span", { class: `dga-textarea__feedback-icon dga-textarea__feedback-icon--${this.feedbackIconType} ${this.feedbackIconRing ? 'dga-textarea__feedback-icon--ring' : ''}` }, feedbackIconTypes[this.feedbackIconType])) : null))));
    }
...
DgaTextarea.style = dgaTextareaCss;

exports.dga_textarea = DgaTextarea;
