...
const DgaRadialStepper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a1e701310694201dfc2e8209165dcfc0b510a1c8' }, index.h("dga-flex", { key: '3f4f28374a807d2b55d52bf57458ae9e779b60bb', spacing: 8, align: 'center', dir: this.RTL ? "rtl" : "ltr", class: `dga-radial-stepper--${this.size} dga-radial-stepper--${this.variant}`, "aria-size": this.size }, index.h("div", { key: 'f8cae0ec45e4a96a21c074c988fdf6f1339cc3b0', class: "dga-circular-stepper", "aria-size": this.size }, index.h("div", { key: 'f6ed3e6723fbbd6ae3cb89b4b8a9079bce680ba9', class: "dga-circular-stepper__label" }, this.showText && this.steps.length > 0 && index.h("h4", { key: '1f02f978eaff9f7f5c05900439bf4a3e379e9910', class: `dga-circular-stepper__label--text ${this.variant}` }, this.RTL ? `${this.internalActiveStep} من ${this.steps.length}` : `${this.internalActiveStep} of ${this.steps.length}`)), index.h("svg", { key: 'eac4bf8b1d6ba62eccd2d2da95112316619ad4cc', width: this.sizes[this.size], height: this.sizes[this.size], viewBox: `0 0 ${this.sizes[this.size]} ${this.sizes[this.size]}` }, index.h("circle", { key: 'e1b57a2b23b1d959328f8a7dcc62abb5ef697c84', class: `track track--${this.variant}`, fill: "none", stroke: "#e6e6e6",
            // stroke="currentColor"
            r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth }), index.h("circle", { key: '6c5e32d7a23a618daf226df2c399f622a774448c', class: `tail tail--${this.variant}`, fill: "none", stroke: "currentColor", r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth, "stroke-linecap": 'round', "stroke-dasharray": dashArray, "stroke-dashoffset": dashOffset, transform: `rotate(-90 ${this.sizes[this.size] / 2} ${this.sizes[this.size] / 2})`, style: {
                transition: 'stroke-dashoffset 0.5s ease',
            } }))), index.h("dga-flex", { key: 'cff3d7f857f93027267d02dffe7a7b1507048deb', direction: 'column', spacing: 4 }, ((_a = this.steps[this.internalActiveStep - 1]) === null || _a === void 0 ? void 0 : _a.showPreStep) && index.h("span", { key: 'ac511010e1a7d6ec63632971265ff7a7e318258c', class: "dga-radial-stepper__pre-name" }, "Previous: ", (_b = this.steps[this.internalActiveStep - 1]) === null || _b === void 0 ? void 0 :
            _b.stepName), this.showStepName && ((_c = this.steps[this.internalActiveStep - 1]) === null || _c === void 0 ? void 0 : _c.stepName) && index.h("h3", { key: '6dcdb3e616b3dc914317ebe7fa6c880422daeba3', class: "dga-radial-stepper__name" }, (_d = this.steps[this.internalActiveStep - 1]) === null || _d === void 0 ? void 0 : _d.stepName), this.showStepDescription && ((_e = this.steps[this.internalActiveStep - 1]) === null || _e === void 0 ? void 0 : _e.stepDescription) && index.h("h5", { key: 'bd2ed78883628401f31a4437dd214192fb57924a', class: "dga-radial-stepper__desc" }, (_f = this.steps[this.internalActiveStep - 1]) === null || _f === void 0 ? void 0 : _f.stepDescription), ((_g = this.steps[this.internalActiveStep - 1]) === null || _g === void 0 ? void 0 : _g.showNextStep) && index.h("span", { key: '2c1bff47812768c1c8a662079d40c19100d97435', class: "dga-radial-stepper__next-name" }, "Next: ", (_h = this.steps[this.internalActiveStep]) === null || _h === void 0 ? void 0 :
            _h.stepName)))));
    }
    static get watchers() { return {
        "steps": ["updateInternalPercentage"],
        "activeStep": ["updateInternalPercentage"]
    }; }
};
DgaRadialStepper.style = dgaRadialStepperCss;

exports.dga_radial_stepper = DgaRadialStepper;
