    ...
    renderSkeletonContent() {
        switch (this.type) {
            case 'chart and content':
                return (index.h("div", { class: " chart_and_content" }, index.h("div", { class: "wrapper" }, index.h("dga-circle-skeleton", { width: "240px", type: "2" }), index.h("div", { class: "line_wrapper" }, index.h("dga-line-skeleton", { size: "lg" }), index.h("dga-line-skeleton", { size: "lg" }), index.h("dga-line-skeleton", { size: "lg" })))));
            case 'image content and button':
                return (index.h("div", { class: " image_content_and_button" }, index.h("div", { class: "wrapper" }, index.h("dga-square-skeleton", { width: "240px", type: "1" }), index.h("div", { class: "line_wrapper" }, index.h("dga-line-skeleton", { size: "lg" }), index.h("dga-line-skeleton", { size: "lg" }), index.h("dga-line-skeleton", { size: "lg" })), index.h("div", { class: "last" }, index.h("dga-rectangle-skeleton", { size: "sm", width: "short" })))));
            case 'image profile content':
                return (index.h("div", { class: " image_profile_content" }, index.h("div", { class: "wrapper" }, index.h("dga-square-skeleton", { width: "240px", type: "1" }), index.h("div", { class: "first" }, index.h("dga-circle-skeleton", { width: "24px" }), index.h("dga-rectangle-skeleton", { size: "sm", width: "short" })), index.h("div", { class: "line_wrapper" }, index.h("dga-line-skeleton", { size: "lg" }), index.h("dga-line-skeleton", { size: "lg" }), index.h("dga-line-skeleton", { size: "lg" })), index.h("div", { class: "last" }, index.h("dga-rectangle-skeleton", { size: "sm", width: "short" })))));
            case 'image button and text':
                return (index.h("div", { class: " image_button_and_text" }, index.h("div", { class: "wrapper" }, index.h("div", { class: "left" }, index.h("dga-circle-skeleton", { width: "48px", type: "2" })), index.h("div", { class: "right" }, index.h("dga-line-skeleton", { size: "sm" }), index.h("dga-rectangle-skeleton", { size: "md", width: "short" })))));
            case 'icon and list':
                return (index.h("div", { class: " icon_and_list" }, index.h("div", { class: "wrapper" }, index.h("div", { class: "left" }, index.h("dga-square-skeleton", { width: "48px", type: "1" })), index.h("div", { class: "right" }, index.h("dga-line-skeleton", { size: "sm" }), index.h("dga-line-skeleton", { size: "sm" }), index.h("dga-line-skeleton", { size: "sm" })))));
            default:
                return null;
        }
    }
...
SkeletonComponent.style = styleCss;

exports.dga_skeleton_component = SkeletonComponent;
