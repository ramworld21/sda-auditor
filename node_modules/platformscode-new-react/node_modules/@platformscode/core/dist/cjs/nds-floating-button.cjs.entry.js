...
const NdsFloatingButton = class {
    ...
    render() {
        return (index.h("button", { key: '5296e6f22459d5fd8870dcd63f76a205121e079d', dir: this.RTL ? 'rtl' : 'ltr', disabled: this.disabled, class: `
            NdsFloatingButton-root
            ${this.inverted ? `NdsFloatingButton-${this.variant}--inverted` : `NdsFloatingButton-${this.variant}`}
            NdsFloatingButton-${this.size} `, onClick: event => this.handleClick(event) }, index.h("slot", { key: '752d58e131d01ddbda25102c52804ced4ad0edb1', name: "icon" }, this.icon && index.h("dga-icon-v2", Object.assign({ key: '8545da127ca19163a80e47edb3cf420423c3c386', name: this.icon }, this.iconProps))), !this.iconOnly && this.label && index.h("span", { key: 'a07be009d634e8d91b2fd1f2a4cbfa4e9dcf397b', class: "NdsFloatingButton-label" }, this.label)));
    }
};
NdsFloatingButton.style = ndsFloatingButtonCss;

exports.nds_floating_button = NdsFloatingButton;
