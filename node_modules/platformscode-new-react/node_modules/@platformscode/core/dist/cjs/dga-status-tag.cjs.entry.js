...
const DgaStatusTag = class {
    ...
    render() {
        return (index.h(index.Host, { key: '32c50cfdc1c7a8dc8b3f6679e565b9f253192a69', id: this.componentId, style: this.rootStyles }, index.h("span", { key: 'f1b1513a4fe9212c9b5fcb9abc29afa1bac2f1d8', class: `status-tag status-tag--${this.color} status-tag--${this.size} status-tag--${this.status}` }, index.h("span", { key: 'efbd197521054a2b4d6fcc53612441c91e5cfe27', class: "status-tag__indicator" }), this.label, index.h("slot", { key: 'ff5956004bb5d87fa50f7319621d3e0c45e9761e' }))));
    }
...
DgaStatusTag.style = dgaStatusTagCss;

exports.dga_status_tag = DgaStatusTag;
