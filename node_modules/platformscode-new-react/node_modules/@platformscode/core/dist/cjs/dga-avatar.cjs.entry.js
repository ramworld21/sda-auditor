...
const DgaAvatar = class {
    ...
    renderChildComponent() {
        ...
        if (this.type === 'initials')
            return index.h("span", { class: "dga-avatar__text" }, this.text);
        if (this.type === 'image')
            return index.h("img", { class: "dga-avatar__img", src: this.imgUrl, alt: this.alt });
        if (this.type === 'icon')
    ...
    render() {
        return (index.h(index.Host, { key: 'a8237e63662daaa26bad59d18e001ecb5bf42305', id: this.componentId, style: this.rootStyles }, index.h("div", { key: '9bfb5e59de3041427941a1a61ba174ef0995af20', class: {
                'dga-avatar': true,
...
DgaAvatar.style = dgaAvatarCss;

exports.dga_avatar = DgaAvatar;
