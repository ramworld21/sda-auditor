...
const DgaButton = class {
    ...
    renderIcon(iconName, iconProps) {
        return index.h("dga-icon", Object.assign({ name: iconName }, iconProps));
    }
    handleSxChange() {
        this.processStyling();
    }
    ...
    render() {
        ...
        const classList = [
            ...
            .filter(Boolean)
            .join(' ');
        return (index.h(index.Host, { key: '69925fb79fca46e9a90ce6391b78930fc7a1c716', id: this.componentId, style: this.rootStyles }, index.h("button", { key: 'cf358170e29ccd38aaada49a356dd3670602981c', id: buttonId, type: this.type, class: classList, disabled: this.disabled, "aria-label": this.iconOnly && !this.label ? 'Button with icon' : this.label, role: "button", onClick: (event) => this.handleClick(event) }, this.iconOnly && this.iconType && (index.h("span", { key: 'e96d3a0395460624b623abbdb444f0646c336732', class: "dga-btn-icon", "aria-hidden": "true" }, this.renderIcon(this.iconType, this.iconProps))), this.leadIcon && this.leadIconType && (index.h("span", { key: '2a85f76f645804b2ffaa7c631012354436871d7e', class: "dga-btn-icon", "aria-hidden": "true" }, this.renderIcon(this.leadIconType, this.leadIconProps))), !this.iconOnly && this.label && index.h("span", { key: 'e7df88d685136fa8c140d257f54b191fc2e7fcb4', class: "dga-btn-label" }, this.label), this.trailIcon && this.trailIconType && (index.h("span", { key: '33ae7ad9f0297f5c01a2922b31987b2a559009b0', class: "dga-btn-icon", "aria-hidden": "true" }, this.renderIcon(this.trailIconType, this.trailIconProps))))));
    }
...
DgaButton.style = dgaButtonCss;

exports.dga_button = DgaButton;
