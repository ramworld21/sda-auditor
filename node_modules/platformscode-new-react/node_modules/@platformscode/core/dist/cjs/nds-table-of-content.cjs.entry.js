...
const NdsTableOfContent = class {
    ...
    componentWillLoad() {
        ...
        this.sxHandler = new sxHandler.SxHandler(this.el, 'dga-table-of-content');
    }
    componentDidLoad() {
    ...
    renderTab(tab) {
        return (index.h("li", null, index.h("a", { ref: el => el && this.tabRefs.set(tab.Target, el), onClick: e => {
                e.preventDefault();
                this.moveTOSelectedId(tab.Target);
            }, onMouseDown: () => this.handleAddPressed(tab.Target), onMouseUp: () => this.handleRemovePressed(tab.Target), onMouseOut: () => this.handleRemovePressed(tab.Target), class: `table-of-content__tab ${this.activeSectionId === tab.Target ? 'active' : ''}` }, index.h("span", { class: "table-of-content__tab-label" }, tab.Name))));
    }
    renderSubTabs(subTab) {
        var _a;
        return (index.h("ul", { class: "table-of-content__tab-sublist" }, this.renderTab(subTab), (_a = subTab.Children) === null || _a === void 0 ? void 0 :
            _a.map(subSubTab => (index.h("ul", { class: "table-of-content__tab-sub-sublist" }, this.renderTab(subSubTab))))));
    }
    render() {
        return (index.h(index.Host, { key: '3089e56ef9c8a6fa98668702db5a5dca043fd51d', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, index.h("aside", { key: '6bdc28f8c23f7ebe67750849b42e72507285190a', class: `table-of-content ${this.rtl ? 'rtl' : ''}`, dir: this.rtl ? 'rtl' : 'ltr' }, index.h("div", { key: '21a77ec669541795d8b72173c64889715118451a', class: "table-of-content__header" }, index.h("p", { key: 'c2cc72cee09f5bff5168ad9ee9257ff85613f51b', class: "text-sm-regular" }, this.subTitle), index.h("h4", { key: 'd57c25af5130d49f6c5ad418b4c7a4b16fd03d66', class: "text-xl-semibold" }, this.tocTitle)), index.h("div", { key: '1db37300b7173de33ede5cd68ad747e56009c826', class: "table-of-content__body" }, index.h("ul", { key: '5e2494a2d4b226980a2262c35656ffee49cfa4ca', class: "table-of-content__tab-list" }, this.sections.map(tab => tab.Children ? (index.h("div", null, this.renderTab(tab), tab.Children.map(subTab => this.renderSubTabs(subTab)))) : (this.renderTab(tab))))))));
    }
...
NdsTableOfContent.style = ndsTableOfContentCss;

exports.nds_table_of_content = NdsTableOfContent;
