...
const DgaChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b1ea47c54e4139d4c00b2b6000ab03fddc513dce', id: this.componentId, style: this.rootStyles }, index.h("span", { key: '276f2cd90ea665e09b96c98af644b84cdc78ac9b', tabindex: "0", class: `chip chip--${this.variant} chip--${this.size} ${this.rounded ? 'chip--rounded' : ''} ${this.disabled ? 'disabled' : ''} ${this.pressed ? 'pressed' : ''} ${this.isSelected ? "selected" : ""}`, onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), "aria-disabled": this.disabled, onClick: () => {
                if (this.isSelected) {
            ...
            } }, this.leadIcon ? index.h("span", { class: "chip-icon" }, this.renderIcon(this.leadIcon, this.leadIconProps)) : '', this.label, this.trailIcon ? index.h("span", { class: "chip-icon" }, this.renderIcon(this.trailIcon, this.trailIconProps)) : '', index.h("slot", { key: 'a700eecd269df494102d234382aeae4a42f45a23' }))));
    }
...
DgaChip.style = dgaChipCss;

exports.dga_chip = DgaChip;
