...
const DgaCircularProgressBar = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '291033816c03db4d77a13c4ac388a57d4a54b744', class: "circular-progress-bar", "aria-size": this.size, dir: this.RTL ? 'rtl' : 'ltr' }, index.h("div", { key: 'd26868af3a0401153c55090a9f443dd773aa2f02', class: "circular-progress-bar__label" }, this.variant === 'success' && index.h("dga-icon", { key: '28461b96e858abf4a408eb72f4ff3d4ec360ca4e', icon: index$1.checkmarkCircle02SolidRoundedIcon, size: 20 }), this.variant === 'error' && index.h("dga-icon", { key: '79373d85687effb8b0dab66a574dab976398c70b', icon: index$1.multiplicationSignCircleSolidRoundedIcon, size: 20 }), this.variant !== 'success' && this.variant !== 'error' && index.h("h4", { key: 'd5df43d3d7f0f5e796407f8e5a9cbda59cad70a3', class: "circular-progress-bar__label--percentage" }, this.percentage, "%"), this.text && index.h("h5", { key: '7c3ecccfcf8f82b5082c1e0b7b5bd24b11e4bb73', class: `circular-progress-bar__label--text ${this.variant}` }, this.text)), index.h("svg", { key: '6c61a192ccd9c5ea94dcb3c9679be3e2d4c51ad6', width: this.sizes[this.size], height: this.sizes[this.size], viewBox: `0 0 ${this.sizes[this.size]} ${this.sizes[this.size]}` }, index.h("circle", { key: '44db2d34749b0e27093ba0050f039e97fe1899a1', class: "track", fill: "none", stroke: "#e6e6e6", r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth }), index.h("circle", { key: '42611fc781757fc90531f7a5ac41363a85c842ce', class: `tail tail--${this.variant}`, fill: "none", stroke: "currentColor", r: radius, cx: this.sizes[this.size] / 2, cy: this.sizes[this.size] / 2, "stroke-width": strokeWidth, "stroke-linecap": 'round', "stroke-dasharray": dashArray, "stroke-dashoffset": dashOffset, transform: `rotate(-180 ${this.sizes[this.size] / 2} ${this.sizes[this.size] / 2})`, style: {
...
exports.dga_circular_progress_bar = DgaCircularProgressBar;
