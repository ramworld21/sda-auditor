...
const DgaDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4125d71565416222bf62eb358dde0dadfc7c1bd5', id: this.componentId, style: this.rootStyles, dir: document.documentElement.getAttribute('dir') }, index.h("div", { key: '56048d0de425b292edf24461dc705db0231f9186', id: this.id, ref: el => (this.containerRef = el), class: Object.keys(dropdownClasses)
                .filter(key => dropdownClasses[key])
                .join(' ') }, index.h("button", { key: 'fb38ddc981f086eccfd17eb919266f7cbaeb3995', class: "dropdown__btn", ref: el => (this.btnRef = el), disabled: this.disabled || this.readonly, onClick: this.handleToggleDropdown.bind(this), onMouseDown: this.handleAddPressed.bind(this), onMouseUp: this.handleRemovePressed.bind(this), onMouseOut: this.handleRemovePressed.bind(this), type: "button" }, index.h("span", { key: 'b95c8a9657732213c66cca71185935af8bbb95ff', class: "dropdown__label" }), index.h("span", { key: '43c2f5d92487b480d0e6a797e5aa4e48631f801d', class: "dropdown__label-placeholder" }, this.placeholder), index.h("span", { key: 'e1f912f87109b80e9f80f7bb150f48b5815b52a4', class: "dropdown__chevron" }, index.h("dga-icon", { key: 'f53978996354dd0a11b408e1fcb6fb0645e3a70f', icon: index$2.arrowDown01StrokeRoundedIcon, size: 20 }))), index.h("ul", { key: '44ca43833029d09a424c42ceca8842bf48f35ac0', class: "dropdown__list" }, this.optionList.map((option, index$3) => (index.h("li", { key: option[this.trackBy] || index$1.guid() }, index.h("button", { class: {
                'dropdown__option': true,
                'dropdown__option--checkbox': this.multiSelect,
                'selected': option.selected
            }, "data-value": option[this.trackBy], onClick: e => this.handleOptionClick(e, option, index$3), onMouseDown: this.handleAddPressed.bind(this), onMouseUp: this.handleRemovePressed.bind(this), onMouseOut: this.handleRemovePressed.bind(this), type: "button" }, this.multiSelect && (index.h("div", { class: "dropdown__option-icon-container" }, index.h("span", { class: "dropdown__option-icon" }, index.h("dga-icon", { icon: index$2.tick02SolidRoundedIcon, size: 20 })))), index.h("span", { class: "dropdown__option-label" }, option[this.optionLabel] || ''), !this.multiSelect && option.selected && (index.h("span", { class: "dropdown__option-icon" }, index.h("dga-icon", { icon: index$2.tick02SolidRoundedIcon, size: 20 })))))))))));
    }
...
DgaDropdown.style = dgaDropdownCss;

exports.dga_dropdown = DgaDropdown;
