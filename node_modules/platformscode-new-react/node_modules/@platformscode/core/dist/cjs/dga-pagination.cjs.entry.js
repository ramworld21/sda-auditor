...
const DgaPagination = class {
    ...
    render() {
        ...
        return (index.h("ul", { key: '89574d2284bb22b95fd7c3cbf670e2160a2893bc', dir: dir$1, class: `pagination pagination--${this.size}` }, index.h("li", { key: '8cd804b8bb3ae0f5ba4afd21842a6015d49cc3f6', class: "pagination__item pagination__arrow" }, index.h("button", { key: '21e29706de888e40cdf6930ceb963b843766bf85', onClick: this.onPrevious, disabled: this.currentPage === 1 }, index.h("svg", { key: '3effbba35d2225a953be58de3344b66f27ccbafa', width: "17", height: "16", viewBox: "0 0 17 16", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("g", { key: 'be59b6288445aaae431e22c18f9bff9b0a4a4b29', id: "Leading Icon" }, index.h("path", { key: 'ac3eb19633e2db8952f3e2e03683c38709c39204', id: "Icon", d: "M10.5 12L6.5 8L10.5 4", stroke: "#161616", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }))))), this.paginationRange &&
            this.paginationRange.map(pageNumber => {
                if (pageNumber === DOTS) {
                    return (index.h("li", { key: index$1.guid(), class: "pagination__item" }, "\u2026"));
                }
                return (index.h("li", { key: index$1.guid(), class: `pagination__item ${this.currentPage === pageNumber ? 'pagination__item--active' : ''}` }, index.h("button", { onClick: () => {
                        this.handelPageChange(pageNumber);
                    } }, pageNumber)));
            }), index.h("li", { key: '46b18473db22872b05dab57b90712693e1a491a1', class: "pagination__item pagination__arrow" }, index.h("button", { key: 'd9e8459064fb22cdb834c22eca83b10791f9150a', onClick: this.onNext, disabled: this.currentPage === this.totalPageCount }, index.h("svg", { key: '6f5cda029a252cc73f9c4507ff6be2f57a26a712', width: "17", height: "16", viewBox: "0 0 17 16", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("g", { key: '19e46f0b48a6649d39cf95409e3765b1c7fd7e13', id: "Leading Icon" }, index.h("path", { key: '5c3f05a30bd4d48195b50d8ba88b02ef3dd101d1', id: "Icon", d: "M6.5 12L10.5 8L6.5 4", stroke: "#161616", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })))))));
    }
...
DgaPagination.style = dgaPaginationCss;

exports.dga_pagination = DgaPagination;
