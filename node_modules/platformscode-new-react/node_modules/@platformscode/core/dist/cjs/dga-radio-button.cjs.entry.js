...
const RadioButton = class {
    ...
    render() {
        ...
        return (index.h("label", { key: '6a9c0349e4d34e040f7645d8007c60c3b66c8a15', ref: el => (this.radioLabelRef = el), id: this.id, class: `radio ${this.color ? 'radio--' + this.color : ''}`, style: inlineStyles, onMouseDown: this.handleActive, onMouseUp: this.handleRemoveActive, onMouseOut: this.handleRemoveActive, onChange: this.handleRemoveActive, tabindex: disabled ? undefined : 0 }, index.h("div", { key: 'c4b994a5b408d5e2c2b8d72f3baab984fd13a503', class: "radio-main" }, index.h("div", { key: '4a7b104f2b557faec2961f489f65f9b277b364a7', class: "radio-main__content" }, index.h("input", { key: '482b511b78780f626b53c672c2d83704a5b20266', type: "radio", name: this.name, value: this.value,
            // id={this.id}
            onChange: this.onChange, onInput: this.onInput, disabled: this.disabled,
            // onFocus={this.handleFocus}
            // onBlur={this.handleFocusOut}
            checked: this.checked }), index.h("div", { key: 'b840492ef7978645ee95bec33327219d7998bc64', class: "radio-container" }), (this.label || this.hasHelperText) && index.h("div", { key: 'e4024ea33fc2b921497d99f05370592c8211d530', class: "dga-flex-column" }, this.label && index.h("span", { key: 'dd166381716e6dbc03d443e7ac398d2c21c5ce0f', class: "radio__label" }, this.label), this.hasHelperText && this.helperText && index.h("span", { key: '90ae3e5e34c0743c72f039e29b4b7cf112ee697d', class: "radio__helper-text" }, this.helperText))), this.alertMessage && this.alertText && (index.h("div", { key: 'cecd80a9dacadce4cb3e379fab7baf1647c688ae', class: "radio__warning" }, index.h("span", { key: '5643b60b29ea7250b54239bdf8fd2ef9f252db14', class: "radio__warning-icon" }, index.h("dga-icon", { key: 'e884727842963526ea74ec210b84a0c6c2ab9969', icon: index$2.alertCircleStrokeRoundedIcon, size: 16 })), index.h("span", { key: 'bb2659c7af946977ffbc4984a9ad6b0145a1e007', class: "radio__warning-text" }, this.alertText))))));
    }
...
RadioButton.style = dgaRadioButtonCss;

exports.dga_radio_button = RadioButton;
