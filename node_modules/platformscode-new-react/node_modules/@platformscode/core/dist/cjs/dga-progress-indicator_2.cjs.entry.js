...
const DgaProgressIndicator = class {
    ...
    render() {
        return (index.h("div", { key: 'e3f33c409c99c76bf9d5b742b7691b562a8a490c', class: "progress-indicator dga-flex", "data-alignment": this.alignment, "data-progress-key": this.componentKey }, index.h("slot", { key: '6dd6439980a5b85a67d142ea68fcb5bfe1e8008a', name: 'progress-indicator-step' })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "activeStep": ["updateInternalActiveStep"]
    }; }
};
DgaProgressIndicator.style = dgaProgressIndicatorCss;
...
const DgaProgressIndicatorStep = class {
    ...
    labelChildren(currentStep) {
        if (this.labelState === 'completed') {
            return index.h("dga-icon", { name: "tick-02", variant: "stroke", size: 16 });
        }
        return currentStep.toString();
    }
    render() {
        return (index.h("div", { key: 'aefa8b3de485cd680b113d810ad23efbec59c4d7', class: "progress-indicator__step", onMouseDown: this.handleFocus, onMouseUp: this.handleFocusOut }, index.h("div", { key: 'bd3f05e617713811c6ad839b0f62f256ed16e399', class: "progress-indicator__step-content dga-flex-column", ref: el => (this.stepContentRef = el) }, index.h("div", { key: '8e7fd1cacb3ba89ca65b51342ee528976c82f8a3', class: "step-label", "data-state": this.labelState }, index.h("span", { key: '27ba058dd4ff8fcaccfae89b35e9f9826df2b71b', class: `step-label--${this.labelStyle}` }, this.labelStyle === 'circle' && this.labelChildren(this.currentStep))), index.h("div", { key: 'ded1e2ca0776961b628b1030a6516019b23cd75e', class: "step-text dga-flex-column" }, this.showStepName && index.h("span", { key: 'c72973d7ae85a68855bc1359a19db957f73e2906', class: this.isActive ? 'text-md-medium' : 'text-md-regular' }, this.title), this.showStepDescription && index.h("p", { key: '3a54081c28289a076882b358e26ecb1058057d9c', class: "text-sm-regular" }, this.description))), this.nextStep && index.h("span", { key: '659ad1c346eda2a2491e693c3e148094d7a6f632', class: `progress-indicator__step-connector ${this.isActive ? 'progress-indicator__step-connector--active' : ''}` })));
    }
    get el() { return index.getElement(this); }
};

exports.dga_progress_indicator = DgaProgressIndicator;
exports.dga_progress_indicator_step = DgaProgressIndicatorStep;
