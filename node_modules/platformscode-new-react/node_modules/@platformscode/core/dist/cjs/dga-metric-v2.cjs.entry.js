...
const DgaMetric = class {
    ...
    render() {
        return (index.h("div", { key: '575df91070ec3bb6fbee5528aff23f248d40c5b9', class: `dga-metric`, "data-chart-size": this.Style }, index.h("div", { key: 'a4ac60e3834f567449ad33430a74406c35244bcd', class: "dga-metric__head" }, index.h("div", { key: 'b370e1b3de2d28e6d070898778a2dbb098ae868e', class: "dga-metric__head-content" }, this.showFeaturedIcon && index.h("div", { key: 'c04b9d81254544f5411ac91f43f553e9c73f776b', class: "featured-icon featured-icon--light-brand featured-icon--circle featured-icon--sm" }, this.featuredIcon), this.label && index.h("span", { key: 'c8da1099582546dc29e45401d47cddd032c32f5d', class: "dga-metric__head-content-text" }, this.label)), this.showMoreButton && (index.h("dga-button-v2", { key: '09287f5aacd513ca6475a1b4edc4065166553855', variant: "subtle", iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'more-vertical',
                variant: 'stroke',
                type: 'rounded',
            }, onClick: this.onExpandAction }))), index.h("div", { key: '140c4a033c4bc8765826d1b417c5e13150f2380b', class: "dga-metric__body" }, index.h("div", { key: '18069a890bdb8b9a487e48c254765f448d5f1c5e', class: "dga-metric__content" }, index.h("h3", { key: 'd4492075d8048b54c7a18e87a55301452d097fa9', class: "dga-metric__content-percentage" }, this.percentage), this.showInfo && (index.h("div", { key: 'b09735ba9a432b82ea94b779fdcd8ed79884dbbb', class: "dga-metric__content-change", "data-change-trend": this.changeProps.trend }, index.h("span", { key: 'd3f7e9aac24725765bb67118913ac5ed961a9fef', class: "dga-metric__content-change-icon" }, index.h("dga-icon", { key: '7224580232a91864477875c70c6fc9edc2964288', name: this.changeIcons[this.changeProps.type][this.changeProps.trend], type: "rounded", variant: "stroke", size: 24 })), index.h("span", { key: 'c4beafe9a72bac2d63d035a4296bfca2d4060251', class: "dga-metric__content-change-value" }, Math.abs(100), "%"), index.h("span", { key: 'bb71f004fed299027cb7b997004822e366de98e9', class: "dga-metric__content-change-period" }, "vs last month")))), this.showChart && (index.h("div", { key: 'ff309d5a23565858d6a0a9dfb932fb24fe387286', class: "dga-metric__chart" }, index.h("dga-metric-chart", Object.assign({ key: 'e6b5eb8e879c61119e31d755a84c32772d3203fa' }, this.chartProps, { size: this.Style === 'small-chart' ? 'sm' : 'lg' }))))), this.showActions && (index.h(index.Fragment, { key: '09c619a5301ae6d3cb2cd4c3ec6fe72cdee45257' }, index.h("div", { key: '1bf127302bcafd84c5c1ded0b2739f87bca53ab4', class: "dga-metric__divider" }), index.h("div", { key: '33333c471391db91a903cac1e018524288ee3450', class: "dga-metric__actions" }, this.showSecondaryAction && (index.h("dga-button-v2", { key: 'df34837408a2d4601468fb3f7508d05dba0fe2cb', variant: "subtle", iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'settings-02',
                variant: 'stroke',
                type: 'rounded',
            }, onClick: this.onSecondaryAction })), index.h("dga-button-v2", { key: '474382eaa11be141a05c9b5cf664d6054a9b56ca', variant: "secondary-outline", class: "dga-metric__actions--primary", label: "View Report", onClick: this.onPrimaryAction }))))));
    }
};
DgaMetric.style = dgaMetricCss;

exports.dga_metric_v2 = DgaMetric;
