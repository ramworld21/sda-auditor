...
const FloatingButton = class {
    ...
    render() {
        return (index.h("button", { key: '982e29f6241f53604cdf7808e4f107d3722260a2', dir: this.RTL ? 'rtl' : 'ltr', disabled: this.disabled, class: `floating-button-onColor-${this.onColor} floating-button-btn ${this.variant} ${this.size} `, onClick: (event) => this.handleClick(event) }, this.icon && (index.h("div", { key: '5323e8cba51ffc7ae40aae2806088019b41d761c', class: "floating-button-icon" }, this.renderIcon(this.icon, this.iconProps))), this.label && !this.iconOnly && index.h("p", { key: '96f21a4cec2d27937f574a6a57f05188eee94ea2' }, this.label)));
    }
};
FloatingButton.style = styleCss;

exports.floating_button = FloatingButton;
