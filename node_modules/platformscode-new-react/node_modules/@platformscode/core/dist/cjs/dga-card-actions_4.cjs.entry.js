...
const DgaCardV2 = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a93295ad53084e429137964b066c95284220a3f8', id: this.componentId, style: this.rootStyles }, index.h("div", Object.assign({ key: '8187ffd12f5ab3dd5bbcb8c9c34a4bfb7dd38e1c', class: `card ${this.disabled ? 'disabled' : ''} ${this.isFocused ? 'focused' : ''} card--${this.effect}`, onMouseEnter: this.onMouseEnterHandler, onMouseLeave: this.onMouseLeaveHandler }, (this.type === 'selectable' ? { onClick: this.onCheckboxChange } : {}), { style: this.cardStyles }), this.type === 'selectable' && (index.h("div", { key: '943487106159fe3b9a862e4afb7457e47cabf4c0', class: "card__checkbox-container" }, index.h("dga-checkbox", { key: 'a5e6027383e8d04ec45ecc3951596abcbed78a8b', checked: this.isSelected, color: "brand", onChange: this.onCheckboxChange }))), index.h("slot", { key: '3ac729592e66616dec54fbb78db51b3a21f234c7', name: 'card-content' }), this.type === 'default' && index.h("slot", { key: '7a006e5de0e47d951fab3eda9252ba0149953696', name: 'card-actions' }))));
    }
...
DgaCardV2.style = dgaCardCss;

exports.dga_card_actions = DgaCardActions;
exports.dga_card_content = DgaCardContent;
exports.dga_card_expandable_content = DgaCardExpandableContent;
exports.dga_card_v2 = DgaCardV2;
