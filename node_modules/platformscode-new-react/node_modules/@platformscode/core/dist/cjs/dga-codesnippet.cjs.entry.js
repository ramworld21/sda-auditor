...
const CodeSnippet = class {
    ...
    renderWithLineNumbers(code) {
        ...
        if (isMultiLine) {
            return (_a = code === null || code === void 0 ? void 0 : code.split('\n')) === null || _a === void 0 ? void 0 : _a.map((line, index$1) => (index.h("div", { key: index$1, class: "code-snippet-code-line" }, this.showSidebar && (index.h("div", { class: "code-snippet-number_container" }, index.h("span", { class: "code-snippet-line-number" }, index$1 + 1))), index.h("span", { class: "code-snippet-line-content" }, line))));
        }
        else {
            return code
                .split('\n')
                .slice(0, 1)
                .map((line, index$1) => (index.h("div", { key: index$1, class: "code-snippet-code-line" }, index.h("span", { class: "code-snippet-line-content green" }, line))));
        }
    }
    render() {
        return (index.h("div", { key: 'f78045c8331a251ef51fcca43ebf25a3ef016d0d', class: "code-snippet-container" }, this.showTabList && (index.h("div", { key: 'd1def53ad4fd933e4c8efef340d4d4acf7c3e5b7', class: "code-snippet-tabs" }, index.h("dga-tabs", { key: '0c4e63d9d7d9ef131513d31eec449bc1bef843c7', divider: true, orientation: "horizontal", size: "lg", tabsList: Object.keys(this.snippets).map(tab => ({
                label: tab,
                onClick: () => this.handleTabClick(tab),
            })) }))), index.h("pre", { key: '5f8478b994d4c0a8b38fb0672a42d632c401acdb', class: "code-snippet-code-display" }, index.h("dga-button-v2", { key: 'b13f8f1dbe0b7d8ca3899dcf29f62489e05b3ead', size: "lg", iconOnly: true, variant: 'subtle', leadIcon: true, leadIconProps: {
                name: 'copy-01',
                size: 24,
                color: '#161616',
                variant: 'stroke',
            }, class: `code-snippet-icon ${this.type}`, onClick: () => this.handleCopy(), onColor: false }), index.h("code", { key: '8f50ebfb4710153e320f37a5a3cbea26ae0ddeea', style: {
                height: this.showButton && this.type === 'multi-line' && !this.showMore ? '150px' : 'auto',
            } }, this.renderWithLineNumbers(this.snippets[this.activeTab])), this.showButton && this.type === 'multi-line' && (index.h("div", { key: '97d1dc497f1b9e6bc13ff74dc3b6dffe169d6f85', class: "code-snippet-wrapper" }, index.h("dga-button-v2", { key: '6e843a04be23922f952f64b5f910d66c02699db1', label: this.showMore ? 'Show Less' : 'Show More', size: "md", trailIcon: true, variant: 'subtle', trailIconProps: { name: !this.showMore ? 'arrow-down-01' : 'arrow-up-01', size: 20, color: '#161616', variant: 'stroke' }, onClick: () => (this.showMore = !this.showMore), onColor: false }))))));
    }
};
CodeSnippet.style = styleCss;

exports.dga_codesnippet = CodeSnippet;
