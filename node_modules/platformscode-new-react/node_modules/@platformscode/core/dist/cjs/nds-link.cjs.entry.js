...
const NdsLink = class {
    ...
    render() {
        return (index.h("a", { key: 'f48b97ed18686f03cda9964e1ac9ea5d9bca372f', href: this.href, target: this.target, onClick: event => this.handleClick(event), class: `dga-link dga-link--${this.size} dga-link--${this.variant} ${this.inline ? 'dga-link--inline' : ''} ${this.disabled ? 'dga-link--disabled' : ''}` }, index.h("span", { key: '4178aa7bf5400b9335f084b62c974cf3d903e8e9', class: "dga-link__label" }, index.h("slot", { key: '740838deeea03a9899e9f51cfe8befbb40531ded' }, this.label)), this.icon && index.h("span", { key: '53a3c389da73235be626399658756e783d7936a8', className: "dga-link__icon" }, index.h("dga-icon-v2", Object.assign({ key: '7acdf111d7878345389d59d770d8427c98bb8075', name: this.icon }, this.iconProps)))));
    }
};
NdsLink.style = ndsLinkCss;

exports.nds_link = NdsLink;
