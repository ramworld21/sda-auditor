...
const DgaGridContainer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '87b902fde60f936900e342dab8169f3fc336d86a', class: Object.keys(classes).filter(key => classes[key]).join(' ') }, index.h("slot", { key: '58d8a47a48415e02428855703379837d904973dc' })));
    }
...
const DgaGridItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a352d2ee50f1555cb7895ab0dcbd3612cdce985e', class: Object.keys(classes).filter(key => classes[key]).join(' '), style: styles }, index.h("slot", { key: 'e3ed677b0aa211f2d07c0ac1eb39624ce094133c' })));
    }
};
DgaGridItem.style = dgaGridCss;

exports.dga_grid_container = DgaGridContainer;
exports.dga_grid_item = DgaGridItem;
