...
const DgaMenuGroup = class {
    ...
    render() {
        return (index.h("div", { key: 'f83f05369c4927b2081e1b180480c59e9d73e540', class: "menu-group" }, this.groupLabel && index.h("span", { key: '557db4ae2b7333a6bec917979c657e6392f984ca', class: "menu-group__label" }, this.groupLabel), index.h("ul", { key: '0b66140bfde01c8f8df1c2d59433f7ccbe6f37b4', class: "menu-group__items" }, index.h("slot", { key: '720f7613be74e425cdb4204fbaa57e61c98ce153' }))));
    }
};
...
const DgaMenuItem = class {
    ...
    render() {
        return (index.h("li", { key: '653c9c0bd9e3f3b38f4d414bf55fdfc1f78f9751', class: `menu-item ${this.disabled ? 'disabled' : ''} ${this.pressed ? "pressed" : ""}`, onMouseDown: () => this.pressed = true, onMouseUp: () => this.pressed = false, tabindex: "0", onClick: this.handleClick }, this.hasLeadIcon && index.h("span", { key: '92e16bee31b7f248363dbfe9b9600db9283d4dd1', class: "menu-item__icon" }, index.h("slot", { key: '565479b56817e98ad2f454fab7e5d485a3d6029b', name: "lead-icon" })), index.h("span", { key: '53a53f7a22b50c3fa30e60b759e051787048c8c6', class: "menu-item__label" }, this.label), this.hasTrailElement && index.h("div", { key: '1bad8270fb653e6211e3e1fc9005d0fd25bdaf09', class: "menu-item__trail-element" }, index.h("slot", { key: '371654c563a50b14a90cdd42a4789e9e5ce26fcf', name: "trail-element" }))));
    }
};
DgaMenuItem.style = dgaMenuItemCss;

exports.dga_menu_group = DgaMenuGroup;
exports.dga_menu_item = DgaMenuItem;
