...
const DgaStructuredList = class {
    ...
    render() {
        return (index.h("div", { key: '79d691fcb4f8c39e32571f48e4364181474c83af', class: `table-wrapper ${this.contained ? 'table-contained' : ''}` }, index.h("table", { key: 'bc0004889772d9ec97a362a2d98c86f00ffd38aa', class: `azm-structured-table ${this.contained ? 'table-contained' : ''}`, style: { direction: this.direction ? 'rtl' : 'ltr' } }, index.h("thead", { key: 'b443ef28b2414b6b564e3db8fd69c21281f15209' }, index.h("tr", { key: '3075adda8efaf8c73568b6351d5289c03d787ac6', class: `${this.rowDivider ? 'row-divider' : ''}` }, this.cells.map(({ title }, index$1) => (index.h("th", { key: index$1 }, title))))), index.h("tbody", { key: '1ac5bc499fdb1b0c4718f5c41487913d24dbab78' }, this.sortedData.map((row, rowIndex) => (index.h("tr", { class: `${this.rowDivider ? 'row-divider' : ''} ${this.alternate ? 'alternate' : ''}`, key: rowIndex }, this.cells.map(({ El, customAttribute, propertyName, type, colSpan }, cellIndex) => (index.h("td", Object.assign({ key: cellIndex, colSpan: colSpan || 1 }, ((customAttribute === null || customAttribute === void 0 ? void 0 : customAttribute.key) && {
            [customAttribute.key]: customAttribute.value || '',
        }), { class: `${this.compact ? "compact" : ""} ${this.colDivider ? 'col-divider' : ''}` }), index.h("div", null, this.selectable && (index.h("span", null, index.h("input", { type: "checkbox", name: `${rowIndex}checkboxSelection`, checked: row.selected, id: `${rowIndex}checkboxSelection${propertyName}`, onChange: event => this.handleSelectedRowChanges(event.target.checked, rowIndex, propertyName, cellIndex) }))), type === 'element' && El ? index.h(El, Object.assign({}, row)) : row[propertyName])))))))))));
    }
...
DgaStructuredList.style = dgaStructuredListCss;

exports.dga_structured_list = DgaStructuredList;
