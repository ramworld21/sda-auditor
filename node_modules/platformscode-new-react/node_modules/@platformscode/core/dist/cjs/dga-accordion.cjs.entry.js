...
const DgaAccordion = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c85c226d6f1a37ee98269436924cb72f6a5d94c0', id: this.componentId, style: this.rootStyles }, index.h("div", { key: '6f90e57b6f03917581686e83c0e5c9ef89c75bfe', class: `dga-accordion-item dga-accordion-item--${this.size} 
          ${this.iconAlignment === 'leading' ? 'dga-accordion-item--icon-leading' : ''}
          ${this.flush ? 'dga-accordion-item--flush' : ''} 
          ${this.disabled ? 'disabled' : ''} ${this.isOpen ? 'active' : ''}` }, index.h("a", { key: 'bf772a859576193760275cd500e7845477877502', href: "#", onClick: e => this.handleAccordionClick(e), onKeyDown: e => (e.code === 'Space' ? this.handleAccordionClick(e) : null), class: "dga-accordion-item__header" }, this.iconAlignment === 'leading' && (index.h("div", { key: '527fc6f23e794f9b394d5f2cb5932241cce3f1aa', class: "dga-accordion-item__arrow" }, index.h("dga-icon", { key: '054cfb0b271340a48be3619e5ff13268f15add60', icon: index$1.arrowDown01StrokeRoundedIcon, size: 16 }))), index.h("div", { key: '7006cf75e37774528731102c7bd416721a23a5ab', class: "dga-accordion-item__title" }, this.title), this.iconAlignment === 'trailing' && (index.h("div", { key: 'dbf4b9c8dac179265be688fb99f45edf4d204e58', class: "dga-accordion-item__arrow" }, index.h("dga-icon", { key: '51841b960c8120fd300454087f7178c65b1ff1f7', icon: index$1.arrowDown01StrokeRoundedIcon, size: 16 })))), index.h("div", { key: '5f6937d847e0131dcd1cb09654ecf91aaf9511ce', ref: el => (this.bodyElement = el), class: "dga-accordion-item__body" }, this.content))));
    }
...
exports.dga_accordion = DgaAccordion;
