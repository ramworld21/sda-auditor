...
const chart = class {
    ...
    async componentDidLoad() {
        if (this.chartObj === null) {
            this.chartObj = new apexcharts_esm.us(this.chartRef, config(this.options, this.type, this.width, this.height, this.series));
    ...
    render() {
        return index.h("div", { key: '36b9075f0cecd46096a668cbbbf8d19716208af5', ref: el => (this.chartRef = el) });
    }
...
chart.style = dgaApexChartCss;

exports.dga_apex_chart = chart;
