...
var dateUtils = require('./dateUtils-B_vTk_3x.js');
...
const DgaDateField = class {
    constructor(hostRef) {
        ...
        this.handleInput = (event) => {
            ...
            if (dateUtils.isValidDate(this.inputValue)) {
        ...
        this.handleDatepickerChange = (event) => {
            ...
            this.inputValue = dateUtils.formatDate(this.selectedDate);
            this.errorMessage = '';
            this.error = false;
            this.isDatepickerOpen = false;
    ...
    render() {
        ...
        return (index.h("div", { key: 'ac304baaf8ec1f5286a4be53a0c27704e620d269', class: { "dga-form-control": true, "dga-form-control--fullwidth": this.fullwidth } }, this.label &&
            index.h("dga-label", { key: 'd344f92666daf85ecd35ccde15062b8b7880a7a5', label: this.label, size: this.size, required: this.required, disabled: this.disabled }), index.h("div", { key: '780e5814287987da88862d34d711c4c7cbc99ca8', class: Object.keys(inputClasses).filter(key => inputClasses[key]).join(' '), ref: el => this.inputContainerRef = el }, this.icon && (index.h("span", { key: 'a6c322f7d04489ae651f215cd1d1a2d9a8516274', class: "input__icon" }, index.h("dga-icon", { key: '6353b218fcdefa15e192a68aecfa9efcd802773b', name: this.icon.name, variant: this.icon.variant, type: this.icon.type, size: 20 }))), index.h("input", { key: '58273bef7c00b54fa1946a11623e36d8c0ae8fd9', ref: (el) => (this.inputEl = el), name: this.name, value: this.inputValue, type: "text", class: "input__field", placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onFocus: this.handleFocus, onBlur: this.handleBlur, onInput: this.handleInput, onMouseDown: () => this.isActive = true, onMouseUp: () => this.isActive = false, onMouseOut: () => this.isActive = false }), index.h("dga-button-v2", { key: 'c2816fa5c44e50a140db53a8074c90ae9923da30', variant: "transparent", iconOnly: true, leadIcon: true, leadIconProps: { name: 'calendar-03', variant: 'stroke', type: 'rounded' }, onClick: this.handleOpenDatepickerPopup }), this.error && (index.h("span", { key: '1073913a48e3f71726455f44507ec7eafbcf9964', class: "input__feedback-icon input__feedback-icon--error" }, index.h("dga-icon", { key: '63f3b2bd2bc1f7bc33e37a27051638686aa76f5d', icon: index$2.alertCircleSolidRoundedIcon })))), (this.errorMessage || this.helperText) &&
            index.h("dga-helper-text", { key: 'ef17a1f66dbbe5d99701ea4380f67ba6ccf334ab', helperText: this.errorMessage || this.helperText, error: this.error }), this.isDatepickerOpen &&
            index.h("div", { key: '464184bd4b93a54410994cb564b4bff4205b0302', class: "date-picker-dropdown", ref: el => this.datepickerRef = el }, index.h("dga-datepicker", Object.assign({ key: '8166078360cf22e4f197ae0fb674d37f5610237a' }, this.datepickerOptions, { value: this.selectedDate, onChange: this.handleDatepickerChange, style: { width: "fit-content", display: "block" } })))));
    }
    static get watchers() { return {
        "value": ["valueChanged"]
    }; }
};
DgaDateField.style = dgaDateFieldCss;

exports.dga_date_field = DgaDateField;
