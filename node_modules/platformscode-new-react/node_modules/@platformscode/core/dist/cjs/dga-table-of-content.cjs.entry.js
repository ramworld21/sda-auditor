...
const DgaTableOfContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '39e03973bc03d838f2c22636fcfc18b9acf9e716', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, index.h("aside", { key: 'cecbebb8744501f9348e247d60968190550a1b17', class: `table-of-content ${this.rtl ? 'rtl' : ''}`, dir: this.rtl ? 'rtl' : 'ltr' }, index.h("div", { key: '484dc58a9e7675ae9b1ffbe93517db38c94b83ac', class: "table-of-content__header" }, index.h("p", { key: '1094d1bbd919cdea4456be214441aaeb62feb55f', class: "text-sm-regular" }, this.subTitle), index.h("h4", { key: '0430402128539ea9a6b2c94fae6b093608ffa5a9', class: "text-xl-semibold" }, this.tocTitle)), index.h("div", { key: '9c083f97f364bfc139b9358d1c515d5f4f97972b', class: "table-of-content__body" }, index.h("ul", { key: '9f98627dbec2629d59788a97ae4e437618c6060e', class: "table-of-content__tab-list" }, this.sections.map(tab => tab.Children ? (index.h("div", null, this.renderTab(tab), tab.Children.map(subTab => this.renderSubTabs(subTab)))) : (this.renderTab(tab))))))));
    }
...
DgaTableOfContent.style = dgaTableOfContentCss;

exports.dga_table_of_content = DgaTableOfContent;
