...
const DgaDrawer = class {
    ...
    componentWillLoad() {
        this.sxHandler = new sxHandler.SxHandler(this.el, 'dga-slider');
    }
    componentDidLoad() {
    ...
    render() {
        return (index.h(index.Host, { key: '852c1b553acf13987eed86c49d6f237e119fc378', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, index.h("div", { key: 'bfaa54d3f169a759aef88eb857f491bcc06f1857', class: `sidepanel sidepanel--${this.anchor} ${this.background ? `sidepanel--bg-${this.background}` : ''}
            ${this.overlay ? 'sidepanel--overlay' : ''}
            ${this.border ? 'sidepanel--border' : ''}
            ${this.open ? 'active' : ''}
            ` }, this.headerLogo && index.h("div", { key: 'c480128121823c203d9acfa71e32f2ea244849bb', class: "sidepanel__header" }, index.h("img", { key: '423d3ed5fb4efc982b2a4a43e34eb9356980de7a', src: this.headerLogo, alt: 'logo' })), index.h("side-panel-menu", { key: '59a4b075643abf8ec329ec9dd69e046b9263a870', routes: this.routes }), index.h("slot", { key: '6748cf132fc0e7872e030f10a7e0dcae25125ce4' }))));
    }
...
DgaDrawer.style = dgaDrawerCss;

const SidePanelMenu = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.routes = [];
    }
    render() {
        return (index.h("ul", { key: '1a90543c32ed292f8680be93b898e4128b7515a0', class: "sidepanel__menu-list" }, this.routes.map((route, index$2) => (index.h("li", { key: index$1.guid() }, index.h("tab-component", { route: route }), index$2 < this.routes.length - 1 && (index.h("div", { class: "sidepanel__menu-tab-divider" })))))));
    }
};
...
const TabComponent = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '80b133e8baeb5c1d0531153f1f2f521bc8cbed79' }, index.h("tab-link", { key: 'bcd51261e7d2dd2687964519192b28547f1e7d04', text: this.route.name, type: this.route.children && this.route.children.length > 0 ? 'parent' : 'child', icon: this.route.icon, link: this.route.path, onExpand: this.handleExpanded.bind(this), disabled: this.route.disabled }), this.route.children && this.route.children.length > 0 && (index.h("ul", { key: '43b9cfdf1e48635d9e867e12d999564b22f10627', class: "sidepanel__submenu-list", ref: el => (this.submenuElement = el) }, this.route.children.map((childRoute, index$1) => (index.h("submenu-component", { key: index$1, route: this.route, childRoute: childRoute, onChildExpanded: expanded => {
                if (expanded) {
                    this.submenuElement.style.maxHeight = 'fit-content';
                }
            } })))))));
...
exports.dga_drawer = DgaDrawer;
exports.side_panel_menu = SidePanelMenu;
exports.tab_component = TabComponent;
