...
const DgaFileUpload = class {
    ...
    renderFile(file, index$1) {
        if (file.uploadStatus === 'error') {
            return (index.h("div", { class: "file-upload__file-item--error" }, index.h("div", { class: "file-upload__file-item" }, index.h("span", { class: "file-upload__file-status file-upload__file-status--error" }, index.h("dga-icon", { name: "alert-circle", variant: "solid", size: 20 })), index.h("span", { class: "file-upload__file-name" }, file.name), index.h("button", { class: "btn btn--close btn--icon btn--sm", onClick: () => this.handleDeleteFile(index$1, file) }, index.h("span", { class: "btn-icon" }, index.h("dga-icon", { name: "multiplication-sign", variant: "stroke", size: 20 })))), index.h("div", { class: "file-upload__file-item-msg" }, file.errorMessage ? file.errorMessage : 'Here goes the helper text.')));
        }
        return (index.h("div", { class: "file-upload__file-item" }, index.h("span", { class: `file-upload__file-status file-upload__file-status--${file.uploadStatus}` }, file.uploadStatus === 'uploading' && file.progress && index.h("dga-loading", { size: "tiny", variant: "neutral" }), file.uploadStatus === 'complete' && index.h("dga-icon", { name: "checkmark-circle-02", variant: "solid", size: 20 })), index.h("span", { class: "file-upload__file-name" }, file.name), index.h("button", { class: "btn btn--close btn--icon btn--sm", onClick: () => this.handleDeleteFile(index$1, file) }, index.h("span", { class: "btn-icon" }, index.h("dga-icon", { name: "multiplication-sign", variant: "stroke", size: 20 })))));
    }
    render() {
        return (index.h("div", { key: '403b9bd7df4f837e789093c790163933718e3cfe', class: `file-upload ${this.dragState ? 'file-upload--drag-over' : ''} ${this.disabled ? 'file-upload--disabled' : ''}` }, index.h("input", { key: '7ba72bef2def2cec12f259b838f5916127b53e09', type: "file", id: this.id, name: this.name, class: "file-upload__input", accept: this.accept, multiple: this.multiple, "aria-hidden": "true", onChange: this.handleFileSelection, ref: el => (this.fileInputRef = el) }), index.h("label", { key: '43c441bd125795cfba70950bd75df41d08ece4f4', htmlFor: this.id, class: "file-upload__drop-area" }, index.h("span", { key: '9a843b0d167fd073b81428e817030c63633a35d1', class: "file-upload__icon" }, index.h("dga-icon", { key: 'ce39243d21b0ec0359e2eccaf6a489697f88ba0c', name: "file-upload", variant: "stroke", size: 20 })), index.h("div", { key: 'b7d6fd8b9613ad4d7e2fbb05ac8545f3e8c847d8', class: "file-upload__content" }, index.h("p", { key: '319c3ab7f3c806bc7b8271f10515c2a26c92536b', class: "file-upload__instructions" }, this.title), index.h("p", { key: '3fe784b51e9278662501654f43c9dfb3d31b6b4b', class: "file-upload__formats" }, this.fileTypesText)), index.h("button", { key: '2c02c041fc9f9c2ee97f0c6aa582a307d23de7b8', class: "btn btn--md btn--secondary", "aria-label": "Browse Files", disabled: this.dragState || this.disabled, type: "button", onClick: () => { var _a; return (_a = this.fileInputRef) === null || _a === void 0 ? void 0 : _a.click(); } }, index.h("span", { key: '6d39c744b101b9d2e66ab0180fe7d43bca10b96f' }, this.actionName))), index.h("div", { key: '1f91fcc34066b27848ee9d94df4f74ff189e0083', class: "file-upload__files-list" }, this.files.map((file, index) => this.renderFile(file, index)))));
    }
};
DgaFileUpload.style = dgaFileUploadCss;

exports.dga_file_upload = DgaFileUpload;
