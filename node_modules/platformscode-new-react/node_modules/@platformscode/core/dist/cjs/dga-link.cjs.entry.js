...
const DgaLink = class {
    ...
    render() {
        if (this.external)
            return (index.h("a", { href: this.url, target: this.target, onClick: event => this.handleClick(event), onMouseDown: () => this.focus = true, onMouseUp: () => this.focus = false, class: `link link--${this.size} ${this.focus ? "focus" : ""} link--${this.variant} ${this.inline ? 'link--inline' : ''} ${this.disabled ? 'link--disabled' : ''} ${this.extraClass}` }, index.h("span", { class: "link__label" }, this.label), this.icon && this.iconType && index.h("span", { className: "link__icon" }, this.iconType), index.h("slot", null)));
        return (index.h("a", { href: this.url, onMouseDown: () => this.focus = true, onMouseUp: () => this.focus = false, onClick: this.handleClick, class: `link link--${this.size} ${this.focus ? "focus" : ""} link--${this.variant} ${this.inline ? 'link--inline' : ''} ${this.disabled ? 'link--disabled' : ''} ${this.extraClass}` }, index.h("span", { class: "link__label" }, this.label), this.icon && this.iconType && index.h("span", { class: "link__icon" }, this.iconType), index.h("slot", null)));
    }
};
DgaLink.style = dgaLinkCss;

exports.dga_link = DgaLink;
