...
const DgaTag = class {
    ...
    render() {
        if (this.iconOnly)
            return (index.h(index.Host, { id: this.componentId, style: this.rootStyles }, index.h("span", { class: `tag tag--${this.variant} ${this.outlined ? `tag--${this.variant}-outlined` : ''} tag--${this.size} ${this.rounded ? 'tag--rounded' : ''}  tag--icon` }, this.leadIcon && index.h("span", { class: "tag-icon" }, index.h("dga-icon", Object.assign({}, this.leadIcon))), !this.leadIcon && index.h("slot", null))));
        return (index.h(index.Host, { id: this.componentId, style: this.rootStyles }, index.h("span", { class: `tag tag--${this.variant} ${this.outlined ? `tag--${this.variant}-outlined` : ''} tag--${this.size} ${this.rounded ? 'tag--rounded' : ''}` }, this.leadIcon ? index.h("span", { class: "tag-icon" }, index.h("dga-icon", Object.assign({}, this.leadIcon))) : '', this.label, this.trailIcon ? index.h("span", { class: "tag-icon" }, index.h("dga-icon", Object.assign({}, this.trailIcon))) : '', index.h("slot", null))));
    }
...
DgaTag.style = dgaTagCss;

const SubmenuComponent = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    }
    ...
    render() {
        if (!this.childRoute.children || this.childRoute.children.length === 0) {
            return (index.h("li", { key: this.childRoute.path }, index.h("tab-link", { text: this.childRoute.name, link: `${this.route.path}${this.childRoute.path}`, level: this.childRoute.level, type: "child", icon: this.childRoute.icon, badge: this.childRoute.badge, disabled: this.childRoute.disabled })));
        }
        return (index.h("li", { key: this.childRoute.path }, index.h("tab-link", { text: this.childRoute.name, link: `${this.route.path}${this.childRoute.path}`, type: "parent", icon: this.childRoute.icon, disabled: this.childRoute.disabled, onExpand: this.handleExpanded.bind(this) }), index.h("ul", { class: "sidepanel__submenu-list", ref: el => (this.submenuElement = el) }, this.childRoute.children.map((subSubRoute, index$1) => (index.h("submenu-component", { key: index$1, route: this.route, childRoute: subSubRoute }))))));
    }
};
...
const TabLink = class {
    ...
    render() {
        ...
        if (this.externalLink) {
            return (index.h("a", Object.assign({ href: this.link }, commonProps, { tabindex: "0" }), this.icon && index.h("span", { class: "sidepanel__menu-tab-icon" }, index.h("dga-icon", Object.assign({}, this.icon))), index.h("span", { class: "sidepanel__menu-tab-label" }, this.text), this.type === 'parent' && (index.h("span", { class: "sidepanel__menu-tab-arrow" }, index.h("dga-icon", { icon: index$1.arrowDown01StrokeRoundedIcon, size: 16 }))), this.badge !== undefined && index.h("dga-tag", { color: this.onColor ? 'on-color' : 'gray', label: this.badge >= 100 ? '+99' : this.badge.toString(), size: "sm" })));
        }
        // Parent tab case
        if (this.type === 'parent') {
            console.log(this.icon, "this.iconthis.icon");
            return (index.h("a", Object.assign({ href: "#" }, commonProps, { onClick: e => this.toggleTab(e), tabindex: "0" }), this.icon && index.h("span", { class: "sidepanel__menu-tab-icon" }, index.h("dga-icon", Object.assign({}, this.icon))), index.h("span", { class: "sidepanel__menu-tab-label" }, this.text), index.h("span", { class: "sidepanel__menu-tab-arrow" }, index.h("dga-icon", { icon: index$1.arrowDown01StrokeRoundedIcon, size: 16 }), " "), this.badge !== undefined && index.h("dga-tag", { color: this.onColor ? 'on-color' : 'gray', label: this.badge >= 100 ? '+99' : this.badge.toString(), size: "sm" })));
        }
        // Child tab case (regular link)
        return (index.h("stencil-route-link", Object.assign({ url: this.link }, commonProps, { tabindex: "0" }), this.icon && index.h("span", { class: "sidepanel__menu-tab-icon" }, index.h("dga-icon", Object.assign({}, this.icon))), index.h("span", { class: "sidepanel__menu-tab-label" }, this.text), this.badge !== undefined && index.h("dga-tag", { color: this.onColor ? 'on-color' : 'gray', label: this.badge >= 100 ? '+99' : this.badge.toString(), size: "sm" })));
    }
};

exports.dga_tag = DgaTag;
exports.submenu_component = SubmenuComponent;
exports.tab_link = TabLink;
