...
if (window) {
    const win = window;
    win.ApexCharts = apexcharts_esm.us;
}
const DgaChart = class {
    constructor(hostRef) {
    ...
    async componentDidLoad() {
        if (this.chartObj === null) {
            this.chartObj = new apexcharts_esm.us(this.chartRef, config(this.options, this.type, this.width, this.height, this.series, this.labels, this.xaxis, this.yaxis, this.colors));
    ...
    render() {
        return index.h("div", { key: '16ca5eedd23654b879ab62be8f7a3808ffc69c39', ref: el => (this.chartRef = el) });
    }
...
DgaChart.style = dgaChartCss;

exports.dga_chart = DgaChart;
