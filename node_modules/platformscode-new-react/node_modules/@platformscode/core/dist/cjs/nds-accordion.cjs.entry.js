...
const NdsAccordion = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c306a87788d068563ddef40ff8e535b364ec4240', id: this.componentId, style: this.rootStyles }, index.h("div", { key: '3a60a41cd8239ac0b2d0c2c5eed77f943c444476', class: `dga-accordion-item dga-accordion-item--${this.size} 
          ${this.iconAlignment === 'leading' ? 'dga-accordion-item--icon-leading' : ''}
          ${this.flush ? 'dga-accordion-item--flush' : ''} 
          ${this.disabled ? 'disabled' : ''} ${this.isOpen ? 'active' : ''}` }, index.h("a", { key: '95863549e6eb11b6672ee808ae6134f602745d5a', href: "#", onClick: e => this.handleAccordionClick(e), onKeyDown: e => (e.code === 'Space' ? this.handleAccordionClick(e) : null), class: "dga-accordion-item__header" }, this.iconAlignment === 'leading' && (index.h("div", { key: 'fe3dd2ff3b2b56f100eac5e95537830e49f3ce05', class: "dga-accordion-item__arrow" }, index.h("dga-icon-v2", { key: '729d25df129367ebea242f63f6dfce699e9b544b', name: "arrow-down-01", variant: "stroke", size: 16 }))), index.h("div", { key: 'c2a5da1d2b70bb78e082fc6e7e4e9a718d3db7a9', class: "dga-accordion-item__title" }, index.h("slot", { key: '8ddd02d000d41e70e00167653a4dc350ee6d936a', name: 'title' }, this.title)), this.iconAlignment === 'trailing' && (index.h("div", { key: 'e3d428da9a1f7f9ee4232b2f56134f93788c0a84', class: "dga-accordion-item__arrow" }, index.h("dga-icon-v2", { key: '636bc322771116e28cbe1a62bbbe48f267536df0', name: "arrow-down-01", variant: "stroke", size: 16 })))), index.h("div", { key: 'f269860f5a6dc09fd18f07fb624525f08209eea4', ref: el => (this.bodyElement = el), class: "dga-accordion-item__body" }, index.h("slot", { key: '3c8a128b32150a860f5b8c8013509901cc26fc50', name: 'content' }, this.content)))));
    }
...
NdsAccordion.style = ndsAccordionCss;

exports.nds_accordion = NdsAccordion;
