...
const DgaTabs = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'cf608207eb889e64245950d2cc1a19bd8c7b7ab8', id: this.componentId, style: this.rootStyles }, index.h("ul", { key: '3a04ac3e5a467cf891b25698dcc5b42979331cf9', class: `dga-tabs-list dga-tabs-list--${this.orientation} ${this.divider ? 'dga-tabs-list--divider' : ''} ${this.flush ? 'flush' : ''} ${this.extraClass}` }, (_a = this.tabsList) === null || _a === void 0 ? void 0 :
            _a.slice(0, 5).map((tab, index$1) => (index.h("li", { key: index$1 }, this.external ? (index.h("a", { href: tab.link, class: `dga-tabs-list__item dga-tabs-list__item--${this.size} ${this.activeTab === index$1 ? 'dga-tabs-list__item--active' : ''} ${this.disabled ? 'disabled' : ''}`, onClick: e => {
                    e.preventDefault();
                    !this.disabled && this.setActiveTab(index$1);
                } }, (tab === null || tab === void 0 ? void 0 : tab.tabIcon) && index.h("div", { class: "dga-tabs-list__icon" }, this.renderIcon(tab === null || tab === void 0 ? void 0 : tab.tabIcon, tab === null || tab === void 0 ? void 0 : tab.iconProps)), index.h("div", { class: "dga-tabs-list__label" }, tab === null || tab === void 0 ? void 0 : tab.label))) : (index.h("a", { href: "#", class: `dga-tabs-list__item dga-tabs-list__item--${this.size} ${this.activeTab === index$1 ? 'dga-tabs-list__item--active' : ''} ${this.disabled ? 'disabled' : ''}`, onClick: e => {
                    e.preventDefault();
                    !this.disabled && this.setActiveTab(index$1);
                    (tab === null || tab === void 0 ? void 0 : tab.onClick) && (tab === null || tab === void 0 ? void 0 : tab.onClick(e));
                } }, (tab === null || tab === void 0 ? void 0 : tab.tabIcon) && index.h("div", { class: "dga-tabs-list__icon" }, this.renderIcon(tab === null || tab === void 0 ? void 0 : tab.tabIcon, tab === null || tab === void 0 ? void 0 : tab.iconProps)), index.h("div", { class: "dga-tabs-list__label" }, tab === null || tab === void 0 ? void 0 : tab.label)))))), this.orientation === 'horizontal' && this.tabsList.length > 5 && (index.h("li", { key: 'c22c5f055ae2324e10ed7d28c5473dc654c6de13', class: "breadcrumb-item ellipsis" }, index.h("dga-button", { key: '7663fda3c9ed1bb9871f7d6f434612af0a0dc36f', iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'MoreHorizontalCircle01Icon',
                size: 17,
                variant: 'solid',
            }, label: "Button", onClick: () => {
                this.toggleMenu();
            }, size: "md", variant: "subtle", disabled: this.disabled, "aria-haspopup": "true", "aria-expanded": this.isMenuOpen ? 'true' : 'false' }), this.isMenuOpen && (index.h("div", { key: 'f7ddf8175c459667931837257d5e33c69d9bf7f8', class: "breadcrumb-dropdown" }, index.h("dga-tabs", { key: '5d2a089302384ef642128d223e96f8d2cf9350f7', size: "md", orientation: "vertical",
            // tabIcons: true,
...
DgaTabs.style = dgaTabsCss;

exports.dga_tabs = DgaTabs;
