import { r as registerInstance, h, H as Host, a as getElement, F as Fragment } from './index-B4CGwdkg.js';
...
const DgaDrawer = class {
    ...
    render() {
        return (h(Host, { key: '852c1b553acf13987eed86c49d6f237e119fc378', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, h("div", { key: 'bfaa54d3f169a759aef88eb857f491bcc06f1857', class: `sidepanel sidepanel--${this.anchor} ${this.background ? `sidepanel--bg-${this.background}` : ''}
            ${this.overlay ? 'sidepanel--overlay' : ''}
            ${this.border ? 'sidepanel--border' : ''}
            ${this.open ? 'active' : ''}
            ` }, this.headerLogo && h("div", { key: 'c480128121823c203d9acfa71e32f2ea244849bb', class: "sidepanel__header" }, h("img", { key: '423d3ed5fb4efc982b2a4a43e34eb9356980de7a', src: this.headerLogo, alt: 'logo' })), h("side-panel-menu", { key: '59a4b075643abf8ec329ec9dd69e046b9263a870', routes: this.routes }), h("slot", { key: '6748cf132fc0e7872e030f10a7e0dcae25125ce4' }))));
    }
...
const SidePanelMenu = class {
    ...
    render() {
        return (h("ul", { key: '1a90543c32ed292f8680be93b898e4128b7515a0', class: "sidepanel__menu-list" }, this.routes.map((route, index) => (h("li", { key: guid() }, h("tab-component", { route: route }), index < this.routes.length - 1 && (h("div", { class: "sidepanel__menu-tab-divider" })))))));
    }
};
...
const TabComponent = class {
    ...
    render() {
        return (h(Fragment, { key: '80b133e8baeb5c1d0531153f1f2f521bc8cbed79' }, h("tab-link", { key: 'bcd51261e7d2dd2687964519192b28547f1e7d04', text: this.route.name, type: this.route.children && this.route.children.length > 0 ? 'parent' : 'child', icon: this.route.icon, link: this.route.path, onExpand: this.handleExpanded.bind(this), disabled: this.route.disabled }), this.route.children && this.route.children.length > 0 && (h("ul", { key: '43b9cfdf1e48635d9e867e12d999564b22f10627', class: "sidepanel__submenu-list", ref: el => (this.submenuElement = el) }, this.route.children.map((childRoute, index) => (h("submenu-component", { key: index, route: this.route, childRoute: childRoute, onChildExpanded: expanded => {
                if (expanded) {
                    this.submenuElement.style.maxHeight = 'fit-content';
                }
            } })))))));
...
export { DgaDrawer as dga_drawer, SidePanelMenu as side_panel_menu, TabComponent as tab_component };
