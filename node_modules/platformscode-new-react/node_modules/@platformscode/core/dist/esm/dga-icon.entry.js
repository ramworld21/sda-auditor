import { d as getAssetPath, r as registerInstance, h, H as Host, a as getElement } from './index-B4CGwdkg.js';
...
function getSvgByUrl(url) {
    ...
    if (svg) {
        gdsIconContent.set(url, svg.outerHTML);
...
Icon.style = dgaIconCss;

export { Icon as dga_icon };
