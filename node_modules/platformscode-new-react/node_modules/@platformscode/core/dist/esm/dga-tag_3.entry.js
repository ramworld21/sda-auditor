...
const DgaTag = class {
    ...
    render() {
        if (this.iconOnly)
            return (h(Host, { id: this.componentId, style: this.rootStyles }, h("span", { class: `tag tag--${this.variant} ${this.outlined ? `tag--${this.variant}-outlined` : ''} tag--${this.size} ${this.rounded ? 'tag--rounded' : ''}  tag--icon` }, this.leadIcon && h("span", { class: "tag-icon" }, h("dga-icon", Object.assign({}, this.leadIcon))), !this.leadIcon && h("slot", null))));
        return (h(Host, { id: this.componentId, style: this.rootStyles }, h("span", { class: `tag tag--${this.variant} ${this.outlined ? `tag--${this.variant}-outlined` : ''} tag--${this.size} ${this.rounded ? 'tag--rounded' : ''}` }, this.leadIcon ? h("span", { class: "tag-icon" }, h("dga-icon", Object.assign({}, this.leadIcon))) : '', this.label, this.trailIcon ? h("span", { class: "tag-icon" }, h("dga-icon", Object.assign({}, this.trailIcon))) : '', h("slot", null))));
    }
...
export { DgaTag as dga_tag, SubmenuComponent as submenu_component, TabLink as tab_link };
