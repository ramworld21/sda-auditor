...
const DgaNavHeader = /*@__PURE__*/ proxyCustomElement(class DgaNavHeader extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-nav-header"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeader);
            }
            break;
    } });
}

export { DgaNavHeader as D, defineCustomElement as d };
