...
const CircleSkeleton = /*@__PURE__*/ proxyCustomElement(class CircleSkeleton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-circle-skeleton"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-circle-skeleton":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, CircleSkeleton);
            }
            break;
    } });
}

export { CircleSkeleton as C, defineCustomElement as d };
