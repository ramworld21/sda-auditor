...
const DgaCardActions = /*@__PURE__*/ proxyCustomElement(class DgaCardActions extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaCardActionsCss; }
}, [1, "dga-card-actions", {
        "type": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-card-actions"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-card-actions":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaCardActions);
            }
            break;
    } });
}

export { DgaCardActions as D, defineCustomElement as d };
