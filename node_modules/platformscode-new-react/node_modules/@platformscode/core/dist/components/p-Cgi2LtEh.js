...
const DgaModalTitle = /*@__PURE__*/ proxyCustomElement(class DgaModalTitle extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaModalTitleCss; }
}, [1, "dga-modal-title"]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-modal-title"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-modal-title":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaModalTitle);
            }
            break;
    } });
}

export { DgaModalTitle as D, defineCustomElement as d };
