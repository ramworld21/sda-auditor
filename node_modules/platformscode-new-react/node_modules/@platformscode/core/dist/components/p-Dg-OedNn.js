...
const DgaMenuItem = /*@__PURE__*/ proxyCustomElement(class DgaMenuItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaMenuItemCss; }
}, [1, "dga-menu-item", {
        "label": [1],
        "disabled": [4],
        "hasTrailElement": [4, "has-trail-element"],
        "hasLeadIcon": [4, "has-lead-icon"],
        "pressed": [32]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-menu-item"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-menu-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaMenuItem);
            }
            break;
    } });
}

export { DgaMenuItem as D, defineCustomElement as d };
