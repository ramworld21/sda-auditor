...
const chart = /*@__PURE__*/ proxyCustomElement(class chart extends H {
    constructor() {
        super();
        this.__registerHost();
        /**
    ...
    async componentDidLoad() {
        if (this.chartObj === null) {
            this.chartObj = new us(this.chartRef, config(this.options, this.type, this.width, this.height, this.series));
    ...
    render() {
        return h("div", { key: '36b9075f0cecd46096a668cbbbf8d19716208af5', ref: el => (this.chartRef = el) });
    }
    static get watchers() { return {
        "options": ["optionsChanged"],
        "series": ["seriesChanged"]
    }; }
    static get style() { return dgaApexChartCss; }
}, [0, "dga-apex-chart", {
        "type": [1],
        "width": [8],
        "height": [8],
...
function defineCustomElement() {
    ...
    const components = ["dga-apex-chart"];
...
export { chart as c, defineCustomElement as d };
