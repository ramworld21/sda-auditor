...
const DgaLoading = /*@__PURE__*/ proxyCustomElement(class DgaLoading extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h(Host, { key: 'aec3305a5289c4f5a2661e5ac024f9d3dba1ce18', id: this.componentId, style: this.rootStyles }, h("div", { key: 'f26f96d4e528b58281080ba7b56c78acd4ff8420', class: classes }, h("div", { key: 'a1aa4321be52b29c87ea64a4a5eb0d7156a6cb65', class: "dga-loading__circle" }))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["handleSxChange"]
    }; }
    static get style() { return dgaLoadingCss; }
}, [1, "dga-loading", {
        "size": [1],
        "variant": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-loading"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-loading":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaLoading);
            }
            break;
    } });
}

export { DgaLoading as D, defineCustomElement as d };
