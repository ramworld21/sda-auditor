...
const DgaFlex = /*@__PURE__*/ proxyCustomElement(class DgaFlex extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaFlexCss; }
}, [1, "dga-flex", {
        "direction": [1],
        "spacing": [2],
        "align": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-flex"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-flex":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaFlex);
            }
            break;
    } });
}

export { DgaFlex as D, defineCustomElement as d };
