...
import { d as defineCustomElement$1 } from './p-Cg2ruBZP.js';
...
const DgaHeaderSubMenuItem = /*@__PURE__*/ proxyCustomElement(class DgaHeaderSubMenuItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaHeaderSubMenuItemCss; }
}, [1, "dga-header-sub-menu-item", {
        "background": [1],
        "link": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-header-sub-menu-item", "dga-flex"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-header-sub-menu-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaHeaderSubMenuItem);
            }
            break;
        case "dga-flex":
            if (!customElements.get(tagName)) {
...
export { DgaHeaderSubMenuItem as D, defineCustomElement as d };
