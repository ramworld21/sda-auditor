...
import { d as defineCustomElement$1 } from './p-CD4HEP4m.js';
...
const DgaSlideoutMenu = /*@__PURE__*/ proxyCustomElement(class DgaSlideoutMenu extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return dgaSlideoutMenuCss; }
}, [4, "dga-slideout-menu", {
...
function defineCustomElement() {
    ...
    const components = ["dga-slideout-menu", "dga-divider"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-slideout-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaSlideoutMenu);
            }
            break;
        case "dga-divider":
            if (!customElements.get(tagName)) {
...
export { DgaSlideoutMenu as D, defineCustomElement as d };
