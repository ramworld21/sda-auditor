...
const DgaAvatarGroup = /*@__PURE__*/ proxyCustomElement(class DgaAvatarGroup extends H {
    ...
    render() {
        return (h(Host, { key: '867a72eef9bcc92e4d1c0a0ab301c10f042203fe', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, h("div", { key: '33fd39b3b39021f6d707f4144dec931fc73ebfac', class: {
                'dga-avatar-group': true,
                'dga-avatar-group--stacked': this.stacked,
            } }, h("slot", { key: '10b583ee3ce73ebb80c2a367cf349c4b5268c635' }))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["sxChanged"]
    }; }
    static get style() { return dgaAvatarGroupCss; }
}, [1, "dga-avatar-group", {
        "stacked": [4],
        "sx": [1]
    }, undefined, {
...
function defineCustomElement() {
    ...
    const components = ["dga-avatar-group"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-avatar-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaAvatarGroup);
            }
            break;
    } });
}

export { DgaAvatarGroup as D, defineCustomElement as d };
