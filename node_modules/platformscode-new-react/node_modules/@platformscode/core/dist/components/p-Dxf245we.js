...
const DgaHeaderActionBtn = /*@__PURE__*/ proxyCustomElement(class DgaHeaderActionBtn extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-header-action-btn", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-header-action-btn":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaHeaderActionBtn);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaHeaderActionBtn as D, defineCustomElement as d };
