...
const DgaNavHeaderSubMenuLink = /*@__PURE__*/ proxyCustomElement(class DgaNavHeaderSubMenuLink extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "dga-nav-header-sub-menu-link", {
        "background": [1],
        "link": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-nav-header-sub-menu-link", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header-sub-menu-link":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeaderSubMenuLink);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaNavHeaderSubMenuLink as D, defineCustomElement as d };
