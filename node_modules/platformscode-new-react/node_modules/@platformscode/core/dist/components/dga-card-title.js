...
const DgaCardTitle$1 = /*@__PURE__*/ proxyCustomElement(class DgaCardTitle extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h("h4", { key: '1b09c0c4850e623f60260b6f3d8ffe730c2f31e5', class: "text-lg-bold" }, h("slot", { key: 'a611028c66a9512443db355eab99f7120384cd12' })));
    }
    get el() { return this; }
...
function defineCustomElement$1() {
    ...
    const components = ["dga-card-title"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-card-title":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaCardTitle$1);
            }
            break;
    } });
}

const DgaCardTitle = DgaCardTitle$1;
const defineCustomElement = defineCustomElement$1;

export { DgaCardTitle, defineCustomElement };
