...
const DgaNavHeaderMenu = /*@__PURE__*/ proxyCustomElement(class DgaNavHeaderMenu extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "dga-nav-header-menu"]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-nav-header-menu"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeaderMenu);
            }
            break;
    } });
}

export { DgaNavHeaderMenu as D, defineCustomElement as d };
