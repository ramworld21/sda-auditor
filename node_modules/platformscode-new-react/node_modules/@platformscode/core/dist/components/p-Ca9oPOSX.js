...
const DgaGridItem = /*@__PURE__*/ proxyCustomElement(class DgaGridItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-grid-item"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-grid-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaGridItem);
            }
            break;
    } });
}

export { DgaGridItem as D, defineCustomElement as d };
