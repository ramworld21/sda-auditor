...
const DgaTag = /*@__PURE__*/ proxyCustomElement(class DgaTag extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaTagCss; }
}, [1, "dga-tag", {
        "label": [1],
        "variant": [1],
        "size": [1],
        "iconOnly": [4, "icon-only"],
        "leadIcon": [16, "lead-icon"],
        "trailIcon": [16, "trail-icon"],
        "rounded": [4],
        "outlined": [4],
        "sx": [1]
    }, undefined, {
...
function defineCustomElement() {
    ...
    const components = ["dga-tag", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-tag":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaTag);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaTag as D, defineCustomElement as d };
