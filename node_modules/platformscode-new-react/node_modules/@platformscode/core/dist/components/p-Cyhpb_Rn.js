...
const CodeSnippet = /*@__PURE__*/ proxyCustomElement(class CodeSnippet extends H {
    constructor() {
        super();
        this.__registerHost();
        var _a;
    ...
    static get style() { return styleCss; }
        ...
        "type": [1],
        "showSidebar": [4, "show-sidebar"],
        "showTabList": [4, "show-tab-list"],
        "showMore": [32],
        "activeTab": [32]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-codesnippet", "dga-button", "dga-button-v2", "dga-icon", "dga-tabs"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-codesnippet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, CodeSnippet);
            }
            break;
        case "dga-button":
            if (!customElements.get(tagName)) {
...
export { CodeSnippet as C, defineCustomElement as d };
