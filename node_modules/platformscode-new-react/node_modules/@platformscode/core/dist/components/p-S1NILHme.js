...
const DgaHeaderSubMenu = /*@__PURE__*/ proxyCustomElement(class DgaHeaderSubMenu extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaHeaderSubMenuCss; }
}, [1, "dga-header-sub-menu", {
        "active": [4],
...
function defineCustomElement() {
    ...
    const components = ["dga-header-sub-menu"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-header-sub-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaHeaderSubMenu);
            }
            break;
    } });
}

export { DgaHeaderSubMenu as D, defineCustomElement as d };
