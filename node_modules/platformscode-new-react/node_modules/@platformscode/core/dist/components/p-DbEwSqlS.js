...
const DgaStatusTag = /*@__PURE__*/ proxyCustomElement(class DgaStatusTag extends H {
    ...
    render() {
        return (h(Host, { key: '32c50cfdc1c7a8dc8b3f6679e565b9f253192a69', id: this.componentId, style: this.rootStyles }, h("span", { key: 'f1b1513a4fe9212c9b5fcb9abc29afa1bac2f1d8', class: `status-tag status-tag--${this.color} status-tag--${this.size} status-tag--${this.status}` }, h("span", { key: 'efbd197521054a2b4d6fcc53612441c91e5cfe27', class: "status-tag__indicator" }), this.label, h("slot", { key: 'ff5956004bb5d87fa50f7319621d3e0c45e9761e' }))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["handleSxChange"]
    }; }
    static get style() { return dgaStatusTagCss; }
}, [1, "dga-status-tag", {
        "RTL": [4, "r-t-l"],
        "label": [1],
        "color": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-status-tag"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-status-tag":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaStatusTag);
            }
            break;
    } });
}

export { DgaStatusTag as D, defineCustomElement as d };
