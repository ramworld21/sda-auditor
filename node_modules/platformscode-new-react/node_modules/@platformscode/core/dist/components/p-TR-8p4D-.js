...
const DgaNavHeaderSubMenu = /*@__PURE__*/ proxyCustomElement(class DgaNavHeaderSubMenu extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-nav-header-sub-menu"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header-sub-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeaderSubMenu);
            }
            break;
    } });
}

export { DgaNavHeaderSubMenu as D, defineCustomElement as d };
