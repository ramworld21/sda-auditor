...
const LineSkeleton = /*@__PURE__*/ proxyCustomElement(class LineSkeleton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-line-skeleton"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-line-skeleton":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, LineSkeleton);
            }
            break;
    } });
}

export { LineSkeleton as L, defineCustomElement as d };
