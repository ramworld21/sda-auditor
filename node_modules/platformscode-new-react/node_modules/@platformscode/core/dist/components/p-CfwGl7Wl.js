...
const SquareSkeleton = /*@__PURE__*/ proxyCustomElement(class SquareSkeleton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-square-skeleton"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-square-skeleton":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SquareSkeleton);
            }
            break;
    } });
}

export { SquareSkeleton as S, defineCustomElement as d };
