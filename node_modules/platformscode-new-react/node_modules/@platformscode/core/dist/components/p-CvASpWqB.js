...
const feedbackIconTypes = {
    success: h("dga-icon", { icon: checkmarkCircle02SolidRoundedIcon, variant: "solid" }),
    error: h("dga-icon", { icon: alertCircleSolidRoundedIcon, variant: "solid" }),
    warning: h("dga-icon", { icon: alert02SolidRoundedIcon, variant: "solid" }),
};
const DgaTextarea = /*@__PURE__*/ proxyCustomElement(class DgaTextarea extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaTextareaCss; }
}, [1, "dga-textarea", {
        "label": [1],
        "placeholder": [1],
        "variant": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-textarea", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaTextarea);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaTextarea as D, defineCustomElement as d };
