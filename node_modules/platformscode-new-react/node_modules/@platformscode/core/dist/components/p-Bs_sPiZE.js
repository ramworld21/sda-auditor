...
const DgaButton = /*@__PURE__*/ proxyCustomElement(class DgaButton extends H {
    ...
    render() {
        const classList = [
            ...
            .filter(Boolean)
            .join(' ');
        return (h("button", { key: 'e263ebdc5d35e019de5623ec42a6b0d1de43d219', type: this.type, class: classList, disabled: this.disabled, "aria-label": this.iconOnly && !this.label ? 'Button with icon' : this.label, role: "button", onClick: (event) => this.handleClick(event) }, this.leadIcon && this.leadIconProps.name && (h("span", { key: '74e330e7af828901901e8e982df6fe5c3da002bb', class: "dga-btn-icon", "aria-hidden": "true" }, h("dga-icon", Object.assign({ key: 'd157f037aecb21ef72c05b2890fa8550260caaf6' }, this.leadIconProps)))), !this.iconOnly && this.label && h("span", { key: '57caddc59882fefff54b76f46a081450eed51183' }, this.label), h("slot", { key: '4fba8e4f04f951e97e84f7d209ea317d1a0640fd', name: "trailing-icon" }), this.trailIcon && this.trailIconProps.name && !this.iconOnly && (h("span", { key: '99386ede7db2386a2436b51e46a729d6a81a77d1', class: "dga-btn-icon", "aria-hidden": "true" }, h("dga-icon", Object.assign({ key: '9414d4fe51d389879f0ae2df2d08c2c5650bad40' }, this.trailIconProps))))));
    }
    get el() { return this; }
...
function defineCustomElement() {
    ...
    const components = ["dga-button-v2", "dga-icon"];
