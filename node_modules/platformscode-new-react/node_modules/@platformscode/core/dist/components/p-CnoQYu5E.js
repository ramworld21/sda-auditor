...
const DgaFeaturedIcon = /*@__PURE__*/ proxyCustomElement(class DgaFeaturedIcon extends H {
    constructor() {
        ...
        this.color = 'brand';
        this.variant = 'light';
        // @Prop() variant: 'circle' | 'square' = 'circle';
        this.circle = true;
        this.iconFonts = {
            "xl": 28,
            "lg": 24,
    ...
    render() {
        return (h("div", { key: '71270394c243421ce4d056e145acab9e2cd73be2', class: `dga-featured-icon ${this.circle ? "dga-featured-icon--circle" : ""} dga-featured-icon--${this.size} dga-featured-icon--${this.variant}-${this.color}` }, h("dga-icon", { key: '7dadc95fe36fa0e91a7bc4bf7933abd702bd2dfb', name: this.icon.name, variant: this.icon.variant, type: this.icon.type, size: this.iconFonts[this.size] })));
    }
    static get style() { return dgaFeaturedIconCss; }
}, [1, "dga-featured-icon", {
        "size": [1],
        "color": [1],
        "variant": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-featured-icon", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-featured-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaFeaturedIcon);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaFeaturedIcon as D, defineCustomElement as d };
