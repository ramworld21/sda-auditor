...
const DgaNumberInput = /*@__PURE__*/ proxyCustomElement(class DgaNumberInput extends H {
    ...
    render() {
        return (h(Host, { key: 'b6cfc11bdc5d807d52a47f5d43e20b239ef7b072', id: this.componentId, style: this.rootStyles }, h("div", { key: '895e80001a6e9c4b381338adb29af0793bf693fd', class: "dga-form-control" }, this.label && h("dga-label", { key: '2b80aba8bdd09af5d1ca872b79ea059d96445886', label: this.label, size: this.size, required: this.required, disabled: this.disabled }), h("div", { key: 'efe9404c98548f4b54309ea1973a62d61f55369e', class: `dga-number-input dga-number-input--${this.size} ${this.error ? 'dga-number-input--error' : ''} ${this.fullwidth ? 'dga-number-input--full-width' : ''} ${this.variant !== 'default' ? `dga-number-input--${this.variant}` : ''} ${this.isActive ? 'active' : ''} ${this.isFocused ? 'focus' : ''} ${this.disabled ? 'dga-number-input--disabled' : ''} ${this.readonly ? 'readOnly' : ''}`, ref: el => (this.inputContainerRef = el) }, h("button", { key: '6199d149be5c74231ff6a9eec44db045175f5f2b', class: `dga-number-input__prefix`, onClick: this.handleIncrement, disabled: this.disabled || this.readonly }, h("span", { key: 'e55563e4bc62d3317397164d6a9d94d4b4f4bb57', class: "dga-number-input__prefix-icon" }, h("dga-icon", { key: 'f34ed026b2c8b15056eebb03ade51588f8bb5cb3', name: "plus-sign", variant: "stroke", type: "rounded" }))), h("input", { key: '084ad77e87c028fdec819b3fb74fd5d25ba8fd0b',
            // id={id}
            value: this.value, name: this.name, type: 'number', onFocus: () => (this.isFocused = true), onBlur: e => {
                this.isFocused = false;
                this.onBlur(e);
            }, class: "dga-number-input__field", placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readonly, required: this.required, onMouseDown: () => (this.isActive = true), onMouseUp: () => (this.isActive = false), onMouseOut: () => (this.isActive = false), onChange: this.onChange, onInput: this.onInput }), h("button", { key: '7f6ebb7445d298d4eced9d3a6185e4e6653c79ac', class: `dga-number-input__suffix`, onClick: this.handleDecrement, disabled: this.disabled || this.readonly }, h("span", { key: '0fea4e0cf41285383e10f1349e5a51df7af74cc0', class: "dga-number-input__suffix-icon" }, h("dga-icon", { key: '315234d4118b47420bda15722c7cd73bfe9d154e', name: "minus-sign", variant: "stroke", type: "rounded" })))), this.helperText && h("dga-helper-text", { key: '1afcf5d50b1b0d24b0fdc959a3e327f49f8e1fa3', helperText: this.helperText, helperTextIcon: this.helperTextIcon, error: this.error }))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["handleSxChange"]
    }; }
    static get style() { return dgaNumberInputCss; }
}, [0, "dga-number-input", {
        "label": [1],
        "placeholder": [1],
        "size": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-number-input", "dga-helper-text", "dga-icon", "dga-label"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-number-input":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNumberInput);
            }
            break;
...
export { DgaNumberInput as D, defineCustomElement as d };
