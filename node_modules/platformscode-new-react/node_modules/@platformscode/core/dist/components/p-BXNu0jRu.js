...
const CarouselItem = /*@__PURE__*/ proxyCustomElement(class CarouselItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaCarouselItemCss; }
}, [1, "dga-carousel-item"]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-carousel-item"];
