...
const DgaHeaderAction = /*@__PURE__*/ proxyCustomElement(class DgaHeaderAction extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return dgaHeaderActionCss; }
}, [1, "dga-header-action", {
        "label": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-header-action"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-header-action":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaHeaderAction);
            }
            break;
    } });
}

export { DgaHeaderAction as D, defineCustomElement as d };
