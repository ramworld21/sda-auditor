...
const DgaListItem = /*@__PURE__*/ proxyCustomElement(class DgaListItem extends H {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    get el() { return this; }
    static get style() { return dgaListItemCss; }
}, [0, "dga-list-item", {
        "type": [1],
        "level": [1],
        "itemText": [1, "item-text"],
        "itemNumber": [1, "item-number"],
        "itemLetter": [1, "item-letter"],
        "icon": [1],
        "inheritedType": [32]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-list-item", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-list-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaListItem);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaListItem as D, defineCustomElement as d };
