...
const DgaCardImage$1 = /*@__PURE__*/ proxyCustomElement(class DgaCardImage extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    //   }
    render() {
        return (h("div", { key: 'a9d3e98d3e8fb48529a54ae9052061a9dd782497', class: "dga-card__image-container" }, h("img", { key: 'dbc4df877868715483bdf89744451a778ec2b49a', src: this.src, alt: this.alt })));
    }
    get el() { return this; }
...
function defineCustomElement$1() {
    ...
    const components = ["dga-card-image"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-card-image":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaCardImage$1);
            }
            break;
    } });
}

const DgaCardImage = DgaCardImage$1;
const defineCustomElement = defineCustomElement$1;

export { DgaCardImage, defineCustomElement };
