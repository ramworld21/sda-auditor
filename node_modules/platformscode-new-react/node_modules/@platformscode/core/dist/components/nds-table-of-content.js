...
const THRESHOLD = 10;
const NdsTableOfContent$1 = /*@__PURE__*/ proxyCustomElement(class NdsTableOfContent extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h(Host, { key: '3089e56ef9c8a6fa98668702db5a5dca043fd51d', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, h("aside", { key: '6bdc28f8c23f7ebe67750849b42e72507285190a', class: `table-of-content ${this.rtl ? 'rtl' : ''}`, dir: this.rtl ? 'rtl' : 'ltr' }, h("div", { key: '21a77ec669541795d8b72173c64889715118451a', class: "table-of-content__header" }, h("p", { key: 'c2cc72cee09f5bff5168ad9ee9257ff85613f51b', class: "text-sm-regular" }, this.subTitle), h("h4", { key: 'd57c25af5130d49f6c5ad418b4c7a4b16fd03d66', class: "text-xl-semibold" }, this.tocTitle)), h("div", { key: '1db37300b7173de33ede5cd68ad747e56009c826', class: "table-of-content__body" }, h("ul", { key: '5e2494a2d4b226980a2262c35656ffee49cfa4ca', class: "table-of-content__tab-list" }, this.sections.map(tab => tab.Children ? (h("div", null, this.renderTab(tab), tab.Children.map(subTab => this.renderSubTabs(subTab)))) : (this.renderTab(tab))))))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["sxChanged"]
    }; }
    static get style() { return ndsTableOfContentCss; }
}, [1, "nds-table-of-content", {
        "sections": [16],
        "subTitle": [1, "sub-title"],
        "tocTitle": [1, "title"],
        "defaultActiveId": [1, "default-active-id"],
        "rtl": [4],
        "sx": [1],
        "activeSectionId": [32]
    }, undefined, {
...
function defineCustomElement$1() {
    ...
    const components = ["nds-table-of-content"];
    components.forEach(tagName => { switch (tagName) {
        case "nds-table-of-content":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NdsTableOfContent$1);
            }
            break;
    } });
}

const NdsTableOfContent = NdsTableOfContent$1;
const defineCustomElement = defineCustomElement$1;

export { NdsTableOfContent, defineCustomElement };
