...
const DgaNavHeaderActions = /*@__PURE__*/ proxyCustomElement(class DgaNavHeaderActions extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-nav-header-actions", "dga-button-v2", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header-actions":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeaderActions);
            }
            break;
        case "dga-button-v2":
            if (!customElements.get(tagName)) {
...
export { DgaNavHeaderActions as D, defineCustomElement as d };
