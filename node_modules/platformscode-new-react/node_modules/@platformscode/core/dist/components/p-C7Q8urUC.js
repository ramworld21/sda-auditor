...
const DgaGridContainer = /*@__PURE__*/ proxyCustomElement(class DgaGridContainer extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return dgaGridCss; }
}, [4, "dga-grid-container", {
        "fluid": [4],
        "gap": [8],
        "columnGap": [8, "column-gap"],
        "rowGap": [8, "row-gap"],
        "spacing": [2],
        "disableGutters": [4, "disable-gutters"]
    }, undefined, {
        "gap": ["updateSpacing"],
        "columnGap": ["updateSpacing"],
        "rowGap": ["updateSpacing"],
...
function defineCustomElement() {
    ...
    const components = ["dga-grid-container"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-grid-container":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaGridContainer);
            }
            break;
    } });
}

export { DgaGridContainer as D, defineCustomElement as d };
