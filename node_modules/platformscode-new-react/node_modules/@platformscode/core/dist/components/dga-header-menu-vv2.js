...
const DgaHeaderMenu = /*@__PURE__*/ proxyCustomElement(class DgaHeaderMenu extends H {
    ...
    render() {
        return (h("ul", { key: '29ab177857d9b1fb5ecde5923cd9d05aeb98ff02', class: "header-nav__menu" }, h("slot", { key: '30658668cffc5e0d6dee79d99f0f7cd29f9ac03a' })));
    }
    static get style() { return dgaHeaderMenuCss; }
}, [1, "dga-header-menu-vv2"]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-header-menu-vv2"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-header-menu-vv2":
...
const DgaHeaderMenuVv2 = DgaHeaderMenu;
const defineCustomElement = defineCustomElement$1;

export { DgaHeaderMenuVv2, defineCustomElement };
