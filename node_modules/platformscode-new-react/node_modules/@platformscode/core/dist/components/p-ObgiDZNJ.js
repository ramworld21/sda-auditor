...
const DgaLink = /*@__PURE__*/ proxyCustomElement(class DgaLink extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return dgaLinkCss; }
}, [4, "dga-link", {
        "variant": [1],
        "size": [1],
        "label": [1],
        ...
        "external": [4],
        "target": [1],
        "preventScrollReset": [4, "prevent-scroll-reset"],
        "state": [16],
...
function defineCustomElement() {
    ...
    const components = ["dga-link"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-link":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaLink);
            }
            break;
    } });
}

export { DgaLink as D, defineCustomElement as d };
