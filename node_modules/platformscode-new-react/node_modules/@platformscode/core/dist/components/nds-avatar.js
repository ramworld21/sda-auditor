...
const NdsAvatar$1 = /*@__PURE__*/ proxyCustomElement(class NdsAvatar extends H {
    ...
    render() {
        return (h(Host, { key: '877fd9dc344786e47f8cd98522bf810f272c1011', id: this.componentId, style: this.rootStyles }, h("div", { key: '881c1b54b35b7085e959faf4ab9f79c5fff5ead3', class: {
                'dga-avatar': true,
    ...
    static get style() { return ndsAvatarCss; }
}, [1, "nds-avatar", {
        "type": [1],
        "size": [2],
        "square": [1540],
...
function defineCustomElement$1() {
    ...
    const components = ["nds-avatar", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nds-avatar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NdsAvatar$1);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
const NdsAvatar = NdsAvatar$1;
const defineCustomElement = defineCustomElement$1;

export { NdsAvatar, defineCustomElement };
