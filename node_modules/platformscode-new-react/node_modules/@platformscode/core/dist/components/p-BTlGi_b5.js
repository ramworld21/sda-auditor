...
const DgaCardExpandableContent = /*@__PURE__*/ proxyCustomElement(class DgaCardExpandableContent extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaCardExpandableContentCss; }
}, [1, "dga-card-expandable-content"]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-card-expandable-content"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-card-expandable-content":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaCardExpandableContent);
            }
            break;
    } });
}

export { DgaCardExpandableContent as D, defineCustomElement as d };
