...
const DgaHeader = /*@__PURE__*/ proxyCustomElement(class DgaHeader extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaHeaderCss; }
}, [1, "dga-header-vv2", {
...
function defineCustomElement() {
    ...
    const components = ["dga-header-vv2"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-header-vv2":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaHeader);
            }
            break;
    } });
}

export { DgaHeader as D, defineCustomElement as d };
