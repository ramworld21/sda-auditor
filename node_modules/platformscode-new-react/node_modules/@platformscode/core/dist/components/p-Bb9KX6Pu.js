...
import { d as defineCustomElement$2 } from './p-C-62j229.js';
...
const DgaCardV2 = /*@__PURE__*/ proxyCustomElement(class DgaCardV2 extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-card-v2", "dga-checkbox", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-card-v2":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaCardV2);
            }
            break;
        case "dga-checkbox":
            if (!customElements.get(tagName)) {
...
export { DgaCardV2 as D, defineCustomElement as d };
