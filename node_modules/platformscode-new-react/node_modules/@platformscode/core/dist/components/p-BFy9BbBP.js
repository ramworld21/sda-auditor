...
const DgaStructuredList = /*@__PURE__*/ proxyCustomElement(class DgaStructuredList extends H {
    constructor() {
        super();
        this.__registerHost();
        this.data = [];
    ...
    render() {
        return (h("div", { key: '79d691fcb4f8c39e32571f48e4364181474c83af', class: `table-wrapper ${this.contained ? 'table-contained' : ''}` }, h("table", { key: 'bc0004889772d9ec97a362a2d98c86f00ffd38aa', class: `azm-structured-table ${this.contained ? 'table-contained' : ''}`, style: { direction: this.direction ? 'rtl' : 'ltr' } }, h("thead", { key: 'b443ef28b2414b6b564e3db8fd69c21281f15209' }, h("tr", { key: '3075adda8efaf8c73568b6351d5289c03d787ac6', class: `${this.rowDivider ? 'row-divider' : ''}` }, this.cells.map(({ title }, index) => (h("th", { key: index }, title))))), h("tbody", { key: '1ac5bc499fdb1b0c4718f5c41487913d24dbab78' }, this.sortedData.map((row, rowIndex) => (h("tr", { class: `${this.rowDivider ? 'row-divider' : ''} ${this.alternate ? 'alternate' : ''}`, key: rowIndex }, this.cells.map(({ El, customAttribute, propertyName, type, colSpan }, cellIndex) => (h("td", Object.assign({ key: cellIndex, colSpan: colSpan || 1 }, ((customAttribute === null || customAttribute === void 0 ? void 0 : customAttribute.key) && {
    ...
    static get style() { return dgaStructuredListCss; }
}, [0, "dga-structured-list", {
        "data": [16],
        "rowDivider": [4, "row-divider"],
        "colDivider": [4, "col-divider"],
        "compact": [4],
        "selectable": [4],
        "alternate": [4],
        "cells": [16],
        "contained": [4],
        "getSelectedRows": [16, "get-selected-rows"],
        "sx": [8],
        "sortedData": [32],
        "direction": [32]
    }, undefined, {
...
function defineCustomElement() {
    ...
    const components = ["dga-structured-list"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-structured-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaStructuredList);
            }
            break;
    } });
}

export { DgaStructuredList as D, defineCustomElement as d };
