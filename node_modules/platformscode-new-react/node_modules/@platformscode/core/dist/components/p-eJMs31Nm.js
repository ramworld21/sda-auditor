...
const DgaRating = /*@__PURE__*/ proxyCustomElement(class DgaRating extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaRatingCss; }
}, [1, "dga-rating", {
        "size": [1],
        "value": [1538],
...
function defineCustomElement() {
    ...
    const components = ["dga-rating"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-rating":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaRating);
            }
            break;
    } });
}

export { DgaRating as D, defineCustomElement as d };
