...
const DgaNavHeaderMain = /*@__PURE__*/ proxyCustomElement(class DgaNavHeaderMain extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-nav-header-main"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header-main":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeaderMain);
            }
            break;
    } });
}

export { DgaNavHeaderMain as D, defineCustomElement as d };
