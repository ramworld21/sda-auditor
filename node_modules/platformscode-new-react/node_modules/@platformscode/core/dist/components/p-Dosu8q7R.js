...
const DgaListV2 = /*@__PURE__*/ proxyCustomElement(class DgaListV2 extends H {
    constructor() {
        super();
        this.__registerHost();
        this.type = 'unordered';
    ...
    static get style() { return dgaListV2Css; }
}, [4, "dga-list-v2", {
        "type": [1],
        "color": [1],
        "title": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-list-v2"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-list-v2":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaListV2);
            }
            break;
    } });
}

export { DgaListV2 as D, defineCustomElement as d };
