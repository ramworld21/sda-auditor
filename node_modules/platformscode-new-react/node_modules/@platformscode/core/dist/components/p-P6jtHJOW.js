...
import { u as us } from './p-CC_LKJPD.js';
...
const DgaChart = /*@__PURE__*/ proxyCustomElement(class DgaChart extends H {
    constructor() {
        super();
        this.__registerHost();
        /**
    ...
    async componentDidLoad() {
        if (this.chartObj === null) {
            this.chartObj = new us(this.chartRef, config(this.options, this.type, this.width, this.height, this.series, this.labels, this.xaxis, this.yaxis, this.colors));
    ...
    static get style() { return dgaChartCss; }
}, [0, "dga-chart", {
        "type": [1],
        "width": [8],
        "height": [8],
...
function defineCustomElement() {
    ...
    const components = ["dga-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaChart);
            }
            break;
    } });
}

export { DgaChart as D, defineCustomElement as d };
