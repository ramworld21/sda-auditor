...
import { g as arrowLeft01StrokeRoundedIcon, h as arrowRight01StrokeRoundedIcon } from './p-YcCmBZW3.js';
...
const DgaBreadcrumbs = /*@__PURE__*/ proxyCustomElement(class DgaBreadcrumbs extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    getArrowIcon() {
        return isRTL(this.el) ? arrowLeft01StrokeRoundedIcon : arrowRight01StrokeRoundedIcon;
    }
    render() {
        const { el } = this;
        const dir = isRTL(el) ? 'rtl' : 'ltr';
        return (h(Host, { key: 'fb59028d99df07ab8d9e39de982f43d9f4404b5e', id: this.componentId, style: this.rootStyles, dir: dir }, h("nav", { key: '1a3e10885e2a76ce6052400118f2a8c84049e476', "aria-label": "breadcrumb" }, h("ul", { key: '42b42572022ec7e3ed8ecad3474191307df51d9f', class: `dga-breadcrumb dga-breadcrumb--${dir}` }, this.breadcrumbItems.map((item, index) => {
            if (this.isEllipsisItem(item)) {
                return (h("li", { key: index, class: "dga-breadcrumb-item ellipsis" }, h("span", { class: "dga-breadcrumb-icon" }, h("dga-icon", { icon: this.getArrowIcon() })), h("a", { onClick: () => {
                        this.toggleMenu();
                        return false;
            ...
            return (h("li", { key: index, class: {
                    ...
                    'active': isLastItem,
                }, "aria-current": isLastItem ? 'page' : undefined }, item.path && !isLastItem ? (h(Fragment, null, !first && (h("span", { class: "dga-breadcrumb-icon" }, h("dga-icon", { icon: this.getArrowIcon() }))), h("a", { onClick: e => this.handleClick(e, item.path, item), class: {
                    'link link--md link--neutral': true,
                    'disabled-link': item.disabled,
                }, href: item.disabled ? undefined : item.path, "aria-disabled": item.disabled ? 'true' : 'false' }, h("span", { class: "link__label" }, item.label)))) : (h(Fragment, null, h("span", { class: "dga-breadcrumb-icon" }, h("dga-icon", { icon: this.getArrowIcon() })), h("a", { onClick: e => this.handleClick(e, item.path, item), class: {
                    'link link--md link--neutral': true,
                    'disabled-link': item.disabled,
                    'link_empty': true,
    ...
    static get style() { return dgaBreadcrumbsCss; }
}, [1, "dga-breadcrumbs", {
        "items": [16],
        "max": [2],
        "sx": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-breadcrumbs", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-breadcrumbs":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaBreadcrumbs);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaBreadcrumbs as D, defineCustomElement as d };
