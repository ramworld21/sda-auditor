...
import { b as arrowDown01StrokeRoundedIcon, t as tick02SolidRoundedIcon } from './p-YcCmBZW3.js';
...
const DgaDropdown = /*@__PURE__*/ proxyCustomElement(class DgaDropdown extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h(Host, { key: '4125d71565416222bf62eb358dde0dadfc7c1bd5', id: this.componentId, style: this.rootStyles, dir: document.documentElement.getAttribute('dir') }, h("div", { key: '56048d0de425b292edf24461dc705db0231f9186', id: this.id, ref: el => (this.containerRef = el), class: Object.keys(dropdownClasses)
                .filter(key => dropdownClasses[key])
                .join(' ') }, h("button", { key: 'fb38ddc981f086eccfd17eb919266f7cbaeb3995', class: "dropdown__btn", ref: el => (this.btnRef = el), disabled: this.disabled || this.readonly, onClick: this.handleToggleDropdown.bind(this), onMouseDown: this.handleAddPressed.bind(this), onMouseUp: this.handleRemovePressed.bind(this), onMouseOut: this.handleRemovePressed.bind(this), type: "button" }, h("span", { key: 'b95c8a9657732213c66cca71185935af8bbb95ff', class: "dropdown__label" }), h("span", { key: '43c2f5d92487b480d0e6a797e5aa4e48631f801d', class: "dropdown__label-placeholder" }, this.placeholder), h("span", { key: 'e1f912f87109b80e9f80f7bb150f48b5815b52a4', class: "dropdown__chevron" }, h("dga-icon", { key: 'f53978996354dd0a11b408e1fcb6fb0645e3a70f', icon: arrowDown01StrokeRoundedIcon, size: 20 }))), h("ul", { key: '44ca43833029d09a424c42ceca8842bf48f35ac0', class: "dropdown__list" }, this.optionList.map((option, index) => (h("li", { key: option[this.trackBy] || guid() }, h("button", { class: {
                'dropdown__option': true,
                'dropdown__option--checkbox': this.multiSelect,
                'selected': option.selected
            }, "data-value": option[this.trackBy], onClick: e => this.handleOptionClick(e, option, index), onMouseDown: this.handleAddPressed.bind(this), onMouseUp: this.handleRemovePressed.bind(this), onMouseOut: this.handleRemovePressed.bind(this), type: "button" }, this.multiSelect && (h("div", { class: "dropdown__option-icon-container" }, h("span", { class: "dropdown__option-icon" }, h("dga-icon", { icon: tick02SolidRoundedIcon, size: 20 })))), h("span", { class: "dropdown__option-label" }, option[this.optionLabel] || ''), !this.multiSelect && option.selected && (h("span", { class: "dropdown__option-icon" }, h("dga-icon", { icon: tick02SolidRoundedIcon, size: 20 })))))))))));
    }
    get el() { return this; }
    ...
    static get style() { return dgaDropdownCss; }
}, [1, "dga-dropdown", {
        "id": [1],
        "placeholder": [1],
        "size": [1],
        ...
        "trackBy": [1, "track-by"],
        "getSelectedOptions": [16, "get-selected-options"],
...
function defineCustomElement() {
    ...
    const components = ["dga-dropdown", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-dropdown":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaDropdown);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaDropdown as D, defineCustomElement as d };
