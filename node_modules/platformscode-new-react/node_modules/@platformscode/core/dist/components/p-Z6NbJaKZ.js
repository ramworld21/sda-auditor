...
const DgaSlideoutMenuActions = /*@__PURE__*/ proxyCustomElement(class DgaSlideoutMenuActions extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "dga-slideout-menu-actions"]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-slideout-menu-actions"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-slideout-menu-actions":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaSlideoutMenuActions);
            }
            break;
    } });
}

export { DgaSlideoutMenuActions as D, defineCustomElement as d };
