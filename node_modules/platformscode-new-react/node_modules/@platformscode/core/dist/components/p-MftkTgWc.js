...
const DgaSlider = /*@__PURE__*/ proxyCustomElement(class DgaSlider extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaSliderCss; }
}, [1, "dga-slider", {
        "min": [2],
        "max": [2],
        "step": [2],
        ...
        "size": [1],
        "initialMin": [2, "initial-min"],
        "initialMax": [2, "initial-max"],
...
function defineCustomElement() {
    ...
    const components = ["dga-slider"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-slider":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaSlider);
            }
            break;
    } });
}

export { DgaSlider as D, defineCustomElement as d };
