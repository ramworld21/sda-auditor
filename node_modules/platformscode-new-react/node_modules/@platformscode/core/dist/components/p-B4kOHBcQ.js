...
const DgaNavHeaderSubMenuColumn = /*@__PURE__*/ proxyCustomElement(class DgaNavHeaderSubMenuColumn extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "dga-nav-header-sub-menu-column", {
        "label": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-nav-header-sub-menu-column"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header-sub-menu-column":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeaderSubMenuColumn);
            }
            break;
    } });
}

export { DgaNavHeaderSubMenuColumn as D, defineCustomElement as d };
