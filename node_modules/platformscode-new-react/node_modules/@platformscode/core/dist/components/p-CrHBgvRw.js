...
const DgaCollapse = /*@__PURE__*/ proxyCustomElement(class DgaCollapse extends H {
    ...
    render() {
        ...
        return (h("div", { key: 'b38eeb7b187504e9a8c91f09a5bf5cfb0033e45d', ref: (el) => this.containerRef = el, "aria-hidden": !this.open, style: styles }, h("slot", { key: '2bf0440b12d1cb7fd709691854ffee14d1df07e4' })));
    }
