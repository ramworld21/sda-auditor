...
const DgaLogoPlaceholder = /*@__PURE__*/ proxyCustomElement(class DgaLogoPlaceholder extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaLogoPlaceholderCss; }
}, [1, "dga-logo-placeholder", {
        "src": [1],
        "text": [1],
        "layout": [1],
        "size": [1]
...
function defineCustomElement() {
    ...
    const components = ["dga-logo-placeholder"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-logo-placeholder":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaLogoPlaceholder);
            }
            break;
    } });
}

export { DgaLogoPlaceholder as D, defineCustomElement as d };
