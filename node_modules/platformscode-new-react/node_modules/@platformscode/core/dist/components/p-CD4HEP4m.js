...
const DgaDivider = /*@__PURE__*/ proxyCustomElement(class DgaDivider extends H {
    ...
    render() {
        return h("span", { key: '01605ad7c7099135a29273fadd7054d34a26333f', class: `dga-divider dga-divider--${this.color} dga-divider--${this.orientation}` });
    }
    static get style() { return dgaDividerCss; }
}, [1, "dga-divider", {
        "color": [1],
        "orientation": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-divider"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-divider":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaDivider);
            }
            break;
    } });
}

export { DgaDivider as D, defineCustomElement as d };
