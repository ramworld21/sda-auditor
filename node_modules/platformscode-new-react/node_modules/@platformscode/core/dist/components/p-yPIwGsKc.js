...
const DgaMenuV2 = /*@__PURE__*/ proxyCustomElement(class DgaMenuV2 extends H {
    ...
    render() {
        return (h(Fragment, { key: '6693f1b83a2c0dc22eb78b9cc06d6816f1296d21' }, this.open && (h("ul", { key: 'aeedfaf5a642f1847e7bdfd8db1cf07ff813cabf', class: "menu", style: this.menuStyle, role: "menu", "aria-hidden": !this.open }, h("slot", { key: '427676e44ac227d3761ab208e24a618f622f27f7' })))));
    }
    static get watchers() { return {
        "open": ["handleOpenChange"]
    }; }
    static get style() { return dgaMenuCss; }
}, [1, "dga-menu-v2", {
        "anchorEl": [16, "anchor-el"],
        "open": [4],
        "onClose": [16, "on-close"],
        "anchorOrigin": [16, "anchor-origin"],
        "transformOrigin": [16, "transform-origin"],
        "menuStyle": [32]
    }, undefined, {
        "open": ["handleOpenChange"]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-menu-v2"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-menu-v2":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaMenuV2);
            }
            break;
    } });
}

export { DgaMenuV2 as D, defineCustomElement as d };
