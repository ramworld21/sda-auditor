...
const DgaPagination = /*@__PURE__*/ proxyCustomElement(class DgaPagination extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaPaginationCss; }
}, [1, "dga-pagination", {
        "size": [1],
        "totalPageCount": [2, "total-page-count"],
...
function defineCustomElement() {
    ...
    const components = ["dga-pagination"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-pagination":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaPagination);
            }
            break;
    } });
}

export { DgaPagination as D, defineCustomElement as d };
