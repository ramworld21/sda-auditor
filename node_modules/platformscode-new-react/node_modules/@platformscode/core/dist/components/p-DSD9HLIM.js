...
const FloatingButton = /*@__PURE__*/ proxyCustomElement(class FloatingButton extends H {
    ...
    render() {
        return (h("button", { key: '982e29f6241f53604cdf7808e4f107d3722260a2', dir: this.RTL ? 'rtl' : 'ltr', disabled: this.disabled, class: `floating-button-onColor-${this.onColor} floating-button-btn ${this.variant} ${this.size} `, onClick: (event) => this.handleClick(event) }, this.icon && (h("div", { key: '5323e8cba51ffc7ae40aae2806088019b41d761c', class: "floating-button-icon" }, this.renderIcon(this.icon, this.iconProps))), this.label && !this.iconOnly && h("p", { key: '96f21a4cec2d27937f574a6a57f05188eee94ea2' }, this.label)));
    }
...
function defineCustomElement() {
    ...
    const components = ["floating-button", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "floating-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, FloatingButton);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { FloatingButton as F, defineCustomElement as d };
