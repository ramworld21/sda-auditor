...
const DgaSlideoutMenuItems = /*@__PURE__*/ proxyCustomElement(class DgaSlideoutMenuItems extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-slideout-menu-items"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-slideout-menu-items":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaSlideoutMenuItems);
            }
            break;
    } });
}

export { DgaSlideoutMenuItems as D, defineCustomElement as d };
