...
const DgaAvatar = /*@__PURE__*/ proxyCustomElement(class DgaAvatar extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaAvatarCss; }
}, [1, "dga-avatar", {
        "type": [1],
        "size": [2],
        "square": [1540],
...
function defineCustomElement() {
    ...
    const components = ["dga-avatar", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-avatar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaAvatar);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
