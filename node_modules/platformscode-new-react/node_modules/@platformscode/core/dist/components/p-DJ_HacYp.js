...
import { d as defineCustomElement$3 } from './p-CnoQYu5E.js';
...
const DgaSlideoutMenuHeader = /*@__PURE__*/ proxyCustomElement(class DgaSlideoutMenuHeader extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return dgaSlideoutMenuHeaderCss; }
}, [1, "dga-slideout-menu-header", {
        "title": [1],
        "description": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-slideout-menu-header", "dga-button-v2", "dga-featured-icon", "dga-flex", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-slideout-menu-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaSlideoutMenuHeader);
            }
            break;
        case "dga-button-v2":
            if (!customElements.get(tagName)) {
...
export { DgaSlideoutMenuHeader as D, defineCustomElement as d };
