...
const DgaHeaderSubMenuColumn = /*@__PURE__*/ proxyCustomElement(class DgaHeaderSubMenuColumn extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaHeaderSubMenuColumnCss; }
}, [1, "dga-header-sub-menu-column", {
        "label": [1]
    }]);
function defineCustomElement() {
    ...
    const components = ["dga-header-sub-menu-column"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-header-sub-menu-column":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaHeaderSubMenuColumn);
            }
            break;
    } });
}

export { DgaHeaderSubMenuColumn as D, defineCustomElement as d };
