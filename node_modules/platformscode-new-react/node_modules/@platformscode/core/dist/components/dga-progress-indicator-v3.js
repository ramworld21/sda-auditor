...
const DgaProgressIndicator = /*@__PURE__*/ proxyCustomElement(class DgaProgressIndicator extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    updateSlottedElements() {
        ...
        const slot = this.el.querySelector('slot[name="progress-indicator-step"]');
        if (slot) {
            const slottedElements = slot.assignedElements();
            // Update each slotted element
            slottedElements.forEach(element => {
                if (element.tagName === 'DGA-PROGRESS-INDICATOR-STEP') {
                    element.setAttribute('active-step', this.activeStep.toString());
                }
            });
        }
    }
    ...
    componentWillLoad() {
        this.el.childNodes.forEach(item => {
            const el = item;
            if (el.tagName === 'DGA-PROGRESS-INDICATOR-STEP-V3' && el.attributes.getNamedItem('slot') === null) {
    ...
    render() {
        ...
        return (h("div", { key: '19a2c27561dc325a52fe922ae57a5af5a1de88e7', class: "progress-indicator dga-flex", "data-alignment": this.alignment }, h("slot", { key: '0d8e4928f96c74b8a3a6edf3a0da099046debcd4', name: 'progress-indicator-step' })));
    }
    get el() { return this; }
    static get watchers() { return {
        "activeStep": ["updateInternalActiveStep"]
    }; }
    static get style() { return dgaProgressIndicatorCss; }
}, [4, "dga-progress-indicator-v3", {
...
function defineCustomElement$1() {
    ...
    const components = ["dga-progress-indicator-v3"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-progress-indicator-v3":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaProgressIndicator);
            }
            break;
    } });
}

const DgaProgressIndicatorV3 = DgaProgressIndicator;
const defineCustomElement = defineCustomElement$1;

export { DgaProgressIndicatorV3, defineCustomElement };
