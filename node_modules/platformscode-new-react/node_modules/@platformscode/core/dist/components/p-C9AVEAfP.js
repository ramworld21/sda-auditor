...
const DgaActionMenu = /*@__PURE__*/ proxyCustomElement(class DgaActionMenu extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return dgaActionMenuCss; }
}, [1, "dga-action-menu", {
        "open": [1540],
        "onClose": [16, "on-close"],
        "placement": [1]
...
function defineCustomElement() {
    ...
    const components = ["dga-action-menu"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-action-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaActionMenu);
            }
            break;
    } });
}

export { DgaActionMenu as D, defineCustomElement as d };
