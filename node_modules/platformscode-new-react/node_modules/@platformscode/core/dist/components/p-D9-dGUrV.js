...
const DgaNavHeaderLogos = /*@__PURE__*/ proxyCustomElement(class DgaNavHeaderLogos extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-nav-header-logos"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-nav-header-logos":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaNavHeaderLogos);
            }
            break;
    } });
}

export { DgaNavHeaderLogos as D, defineCustomElement as d };
