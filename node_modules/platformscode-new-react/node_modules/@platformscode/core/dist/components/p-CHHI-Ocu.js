...
const DgaCardContent = /*@__PURE__*/ proxyCustomElement(class DgaCardContent extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaCardContentCss; }
}, [1, "dga-card-content"]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dga-card-content"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-card-content":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaCardContent);
            }
            break;
    } });
}

export { DgaCardContent as D, defineCustomElement as d };
