...
const NdsChip = /*@__PURE__*/ proxyCustomElement(class NdsChip extends H {
    ...
    render() {
        return (h(Host, { key: '41cb83b12e53b13b9effe2f8609134cf019f0811', id: this.componentId, style: this.rootStyles }, h("span", { key: '0a313e962878a8350292a8461cd2fa38671dff70', tabindex: "0", class: `chip chip--${this.variant} chip--${this.size} ${this.rounded ? 'chip--rounded' : ''} ${this.disabled ? 'disabled' : ''} ${this.pressed ? 'pressed' : ''} ${this.selected ? 'selected' : ''}`, onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), "aria-disabled": this.disabled, onClick: () => {
                if (this.selected) {
            ...
            } }, h("slot", { key: '7c7975ffd21cfefdb4a6d647ed7cf3c39ceb3e8e', name: "trailing-icon" }, this.leadingIcon && (h("span", { key: '975ffb1841600f309f7e34fe12d4e8688ada70f4', class: "chip-icon" }, h("dga-icon-v2", Object.assign({ key: '00ba2d466ed9c9c338cbef68c26ed8cf23a3cef0', name: this.leadingIcon }, this.leadingIconProps))))), this.label, h("slot", { key: '56b1141e0abda87b51735a86750fde2bd6029587', name: "trailing-icon" }, this.trailingIcon && (h("span", { key: 'b081d7bfadfe8fda9c50fde82e26adb2e917693d', class: "chip-icon" }, h("dga-icon-v2", Object.assign({ key: 'fefcf7dcc6190cc859a700d69fec9ff0d00f0bf1', name: this.trailingIcon }, this.trailingIconProps))))))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["handleSxChange"]
    }; }
    static get style() { return ndsChipCss; }
}, [1, "nds-chip", {
        "label": [1],
        "variant": [1],
        "size": [1],
...
function defineCustomElement() {
    ...
    const components = ["nds-chip"];
    components.forEach(tagName => { switch (tagName) {
        case "nds-chip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NdsChip);
            }
            break;
    } });
}

export { NdsChip as N, defineCustomElement as d };
