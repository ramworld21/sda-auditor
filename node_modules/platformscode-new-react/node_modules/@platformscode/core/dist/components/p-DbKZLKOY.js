...
const NdsFloatingButton = /*@__PURE__*/ proxyCustomElement(class NdsFloatingButton extends H {
    ...
    render() {
        return (h("button", { key: '5296e6f22459d5fd8870dcd63f76a205121e079d', dir: this.RTL ? 'rtl' : 'ltr', disabled: this.disabled, class: `
            NdsFloatingButton-root
            ${this.inverted ? `NdsFloatingButton-${this.variant}--inverted` : `NdsFloatingButton-${this.variant}`}
            NdsFloatingButton-${this.size} `, onClick: event => this.handleClick(event) }, h("slot", { key: '752d58e131d01ddbda25102c52804ced4ad0edb1', name: "icon" }, this.icon && h("dga-icon-v2", Object.assign({ key: '8545da127ca19163a80e47edb3cf420423c3c386', name: this.icon }, this.iconProps))), !this.iconOnly && this.label && h("span", { key: 'a07be009d634e8d91b2fd1f2a4cbfa4e9dcf397b', class: "NdsFloatingButton-label" }, this.label)));
    }
    static get style() { return ndsFloatingButtonCss; }
}, [1, "nds-floating-button", {
        "label": [1],
        "RTL": [4, "r-t-l"],
        "variant": [1],
        "size": [1],
...
function defineCustomElement() {
    ...
    const components = ["nds-floating-button"];
    components.forEach(tagName => { switch (tagName) {
        case "nds-floating-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NdsFloatingButton);
            }
            break;
    } });
}

export { NdsFloatingButton as N, defineCustomElement as d };
