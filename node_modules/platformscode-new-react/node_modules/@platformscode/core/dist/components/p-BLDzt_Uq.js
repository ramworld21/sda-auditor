...
const DgaButton = /*@__PURE__*/ proxyCustomElement(class DgaButton extends H {
    ...
    renderIcon(iconName, iconProps) {
        return h("dga-icon", Object.assign({ name: iconName }, iconProps));
    }
    handleSxChange() {
        this.processStyling();
    }
    ...
    render() {
        const buttonId = this.btnId || `btn-${Math.random().toString(36).substr(2, 9)}`;
        const classList = [
            'dga-btn',
            `dga-btn--${this.size}`,
            `dga-btn--${this.variant}`,
            this.onColor ? `dga-btn--${this.variant}--on-color` : '',
            this.iconOnly ? 'dga-btn--icon' : '',
        ]
            .filter(Boolean)
            .join(' ');
        return (h(Host, { key: '69925fb79fca46e9a90ce6391b78930fc7a1c716', id: this.componentId, style: this.rootStyles }, h("button", { key: 'cf358170e29ccd38aaada49a356dd3670602981c', id: buttonId, type: this.type, class: classList, disabled: this.disabled, "aria-label": this.iconOnly && !this.label ? 'Button with icon' : this.label, role: "button", onClick: (event) => this.handleClick(event) }, this.iconOnly && this.iconType && (h("span", { key: 'e96d3a0395460624b623abbdb444f0646c336732', class: "dga-btn-icon", "aria-hidden": "true" }, this.renderIcon(this.iconType, this.iconProps))), this.leadIcon && this.leadIconType && (h("span", { key: '2a85f76f645804b2ffaa7c631012354436871d7e', class: "dga-btn-icon", "aria-hidden": "true" }, this.renderIcon(this.leadIconType, this.leadIconProps))), !this.iconOnly && this.label && h("span", { key: 'e7df88d685136fa8c140d257f54b191fc2e7fcb4', class: "dga-btn-label" }, this.label), this.trailIcon && this.trailIconType && (h("span", { key: '33ae7ad9f0297f5c01a2922b31987b2a559009b0', class: "dga-btn-icon", "aria-hidden": "true" }, this.renderIcon(this.trailIconType, this.trailIconProps))))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["handleSxChange"]
    }; }
    static get style() { return dgaButtonCss; }
}, [1, "dga-button", {
        "variant": [1],
        "size": [1],
        "label": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-button", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaButton);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaButton as D, defineCustomElement as d };
