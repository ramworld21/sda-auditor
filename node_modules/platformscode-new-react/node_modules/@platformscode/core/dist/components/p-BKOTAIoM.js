...
const RectangleSkeleton = /*@__PURE__*/ proxyCustomElement(class RectangleSkeleton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["dga-rectangle-skeleton"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-rectangle-skeleton":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RectangleSkeleton);
            }
            break;
    } });
}

export { RectangleSkeleton as R, defineCustomElement as d };
