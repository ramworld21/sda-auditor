...
const DgaChip = /*@__PURE__*/ proxyCustomElement(class DgaChip extends H {
    constructor() {
        ...
        this.onChange = () => { };
        this.pressed = false;
        this.isSelectedState = this.isSelected;
    ...
    render() {
        return (h(Host, { key: 'b1ea47c54e4139d4c00b2b6000ab03fddc513dce', id: this.componentId, style: this.rootStyles }, h("span", { key: '276f2cd90ea665e09b96c98af644b84cdc78ac9b', tabindex: "0", class: `chip chip--${this.variant} chip--${this.size} ${this.rounded ? 'chip--rounded' : ''} ${this.disabled ? 'disabled' : ''} ${this.pressed ? 'pressed' : ''} ${this.isSelected ? "selected" : ""}`, onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), "aria-disabled": this.disabled, onClick: () => {
                if (this.isSelected) {
            ...
            } }, this.leadIcon ? h("span", { class: "chip-icon" }, this.renderIcon(this.leadIcon, this.leadIconProps)) : '', this.label, this.trailIcon ? h("span", { class: "chip-icon" }, this.renderIcon(this.trailIcon, this.trailIconProps)) : '', h("slot", { key: 'a700eecd269df494102d234382aeae4a42f45a23' }))));
    }
    get el() { return this; }
    static get watchers() { return {
        "sx": ["handleSxChange"]
    }; }
    static get style() { return dgaChipCss; }
}, [1, "dga-chip", {
        "label": [1],
        "variant": [1],
        "size": [1],
...
function defineCustomElement() {
    ...
    const components = ["dga-chip", "dga-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-chip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaChip);
            }
            break;
        case "dga-icon":
            if (!customElements.get(tagName)) {
...
export { DgaChip as D, defineCustomElement as d };
