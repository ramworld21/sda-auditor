...
const DgaActions$1 = /*@__PURE__*/ proxyCustomElement(class DgaActions extends H {
    ...
    render() {
        ...
        return (h(Host, { key: '6803cc210304fad1552964069fe919e22277291a', style: styles }, h("slot", { key: '10acb9942424bfcf4360c17ee2428c94e5f12c8d' })));
    }
    static get style() { return dgaActionsCss; }
}, [1, "dga-actions", {
        "direction": [1],
        "gap": [1],
        "align": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["dga-actions"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-actions":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaActions$1);
            }
            break;
    } });
}

const DgaActions = DgaActions$1;
const defineCustomElement = defineCustomElement$1;

export { DgaActions, defineCustomElement };
