...
import { d as defineCustomElement$2 } from './p-BLDzt_Uq.js';
...
const DgaTabs = /*@__PURE__*/ proxyCustomElement(class DgaTabs extends H {
    constructor() {
        super();
        this.__registerHost();
        this.size = 'md';
    ...
    render() {
        var _a;
        return (h(Host, { key: 'cf608207eb889e64245950d2cc1a19bd8c7b7ab8', id: this.componentId, style: this.rootStyles }, h("ul", { key: '3a04ac3e5a467cf891b25698dcc5b42979331cf9', class: `dga-tabs-list dga-tabs-list--${this.orientation} ${this.divider ? 'dga-tabs-list--divider' : ''} ${this.flush ? 'flush' : ''} ${this.extraClass}` }, (_a = this.tabsList) === null || _a === void 0 ? void 0 :
            _a.slice(0, 5).map((tab, index) => (h("li", { key: index }, this.external ? (h("a", { href: tab.link, class: `dga-tabs-list__item dga-tabs-list__item--${this.size} ${this.activeTab === index ? 'dga-tabs-list__item--active' : ''} ${this.disabled ? 'disabled' : ''}`, onClick: e => {
                ...
                } }, (tab === null || tab === void 0 ? void 0 : tab.tabIcon) && h("div", { class: "dga-tabs-list__icon" }, this.renderIcon(tab === null || tab === void 0 ? void 0 : tab.tabIcon, tab === null || tab === void 0 ? void 0 : tab.iconProps)), h("div", { class: "dga-tabs-list__label" }, tab === null || tab === void 0 ? void 0 : tab.label)))))), this.orientation === 'horizontal' && this.tabsList.length > 5 && (h("li", { key: 'c22c5f055ae2324e10ed7d28c5473dc654c6de13', class: "breadcrumb-item ellipsis" }, h("dga-button", { key: '7663fda3c9ed1bb9871f7d6f434612af0a0dc36f', iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'MoreHorizontalCircle01Icon',
                size: 17,
                variant: 'solid',
            }, label: "Button", onClick: () => {
                this.toggleMenu();
            }, size: "md", variant: "subtle", disabled: this.disabled, "aria-haspopup": "true", "aria-expanded": this.isMenuOpen ? 'true' : 'false' }), this.isMenuOpen && (h("div", { key: 'f7ddf8175c459667931837257d5e33c69d9bf7f8', class: "breadcrumb-dropdown" }, h("dga-tabs", { key: '5d2a089302384ef642128d223e96f8d2cf9350f7', size: "md", orientation: "vertical",
            // tabIcons: true,
    ...
    static get style() { return dgaTabsCss; }
}, [0, "dga-tabs", {
        "size": [1],
        "orientation": [1],
        "external": [4],
...
function defineCustomElement() {
    ...
    const components = ["dga-tabs", "dga-button", "dga-icon", "dga-tabs"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-tabs":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaTabs);
            }
            break;
        case "dga-button":
            if (!customElements.get(tagName)) {
...
export { DgaTabs as D, defineCustomElement as d };
