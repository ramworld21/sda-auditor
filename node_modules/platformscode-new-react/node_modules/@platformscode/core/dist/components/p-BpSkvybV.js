...
const DgaMenuGroup = /*@__PURE__*/ proxyCustomElement(class DgaMenuGroup extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return dgaMenuGroupCss; }
}, [1, "dga-menu-group", {
...
function defineCustomElement() {
    ...
    const components = ["dga-menu-group"];
    components.forEach(tagName => { switch (tagName) {
        case "dga-menu-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DgaMenuGroup);
            }
            break;
    } });
}

export { DgaMenuGroup as D, defineCustomElement as d };
