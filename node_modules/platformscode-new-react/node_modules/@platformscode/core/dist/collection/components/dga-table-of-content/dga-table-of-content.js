...
const THRESHOLD = 10;
export class DgaTableOfContent {
    constructor() {
        this.sections = [];
        this.subTitle = 'sub';
        this.tocTitle = 'main';
    ...
    static get is() { return "dga-table-of-content"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["dga-table-of-content.scss"]
        };
    }
    static get styleUrls() {
        return {
            "$": ["dga-table-of-content.css"]
        };
    }
            ...
            "sections": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "TabType": {
                            "location": "local",
                            "path": "/Users/mohamedaboelezz/projects/Azm-X/platform-code-cross-platform-storybook/packages/core/src/components/dga-table-of-content/dga-table-of-content.tsx",
                            "id": "src/components/dga-table-of-content/dga-table-of-content.tsx::TabType"
                        }
                    }
                },
                "required": false,
