...
export class DgaTableBody {
    ...
    //     };
    render() {
        return (h("tbody", { key: 'a0713a4db7cc2551fe392a82136ae655f92df198' }, h("slot", { key: '113d40d6704388bd16e3e920caa9fb720d444e24' })));
    }
        ...
        return {
            ...
            "cells": {
                ...
                "complexType": {
                    ...
                    "resolved": "{ title: string; isSort: boolean; isFilter: boolean; sort?: \"up\" | \"down\"; propertyName: string; type: \"element\" | \"propertyName\"; El?: HTMLElement; elProperties?: string[]; colSpan?: number; }[]",
                    "references": {
                        "HTMLElement": {
                            "location": "global",
