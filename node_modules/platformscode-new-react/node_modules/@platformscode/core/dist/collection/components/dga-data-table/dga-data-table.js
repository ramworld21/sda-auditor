...
import { sortByUp02StrokeRoundedIcon, sortByDown02StrokeRoundedIcon, filterStrokeRoundedIcon } from "../../assets/icons/index";
export class DgaDataTable {
    ...
    render() {
        ...
        return (h("div", { key: 'ca80ee05b1e8811160d8b85bbb54f0208f77bfed', class: `table-wrapper ${this.contained ? 'table-contained' : ''}` }, h("table", { key: 'a8d003be75250e95b99ca4b3d1607e9401475556', class: ` azm-table ${this.contained ? 'table-contained' : ''}`, style: { direction: this.direction ? 'rtl' : 'ltr' } }, h("thead", { key: '53afb8f7b61363f1d562fa7085c87f1be580f5a2' }, h("tr", { key: 'dc7c8ff4a0f35ef093760750e82f6354e19d607e', class: `${this.rowDivider ? 'row-divider' : ''}` }, this.showSelectCheckBox && (h("th", { key: 'c00258e111a02335c07974e47aa5cc13d52a0dab', style: { width: '20px' } }, h("dga-checkbox", { key: '69b172e3261ed1cb4a6b1aa77cedf72ad03c3b20', showBorderOnFocusAndFocusOute: false, value: 'true', onChange: (event) => this.selectAll(event.target.checked) }))), this.cells.map((_a, index) => {
            var { sort, isSort, propertyName, type } = _a, header = __rest(_a, ["sort", "isSort", "propertyName", "type"]);
            return (h("th", { key: index }, h("span", null, h("span", { class: "text" }, header.title), h("span", { class: "icon-wrapper" }, isSort && sort == 'up' && type == 'propertyName' && (h("button", { class: "dga-btn dga-btn--sort dga-btn--icon dga-btn--md", onClick: () => this.sortData('up', propertyName, index) }, h("dga-icon", { icon: sortByUp02StrokeRoundedIcon, size: 16 }))), isSort && (!sort || sort == 'down') && type == 'propertyName' && (h("button", { class: "dga-btn dga-btn--sort dga-btn--icon dga-btn--md", onClick: () => this.sortData('down', propertyName, index) }, h("dga-icon", { icon: sortByDown02StrokeRoundedIcon, size: 16 }))), header.isFilter && (h("button", { class: "dga-btn dga-btn--sort dga-btn--icon dga-btn--md ", onClick: () => this.pressOnFilter && this.pressOnFilter(propertyName) }, h("dga-icon", { icon: filterStrokeRoundedIcon, size: 16 })))))));
        }))), h("tbody", { key: 'cc476bc9fc8888f2466bfdbef2711523b17e3de7' }, this.sortedData.map((row, rowIndex) => (h("tr", { class: `${this.rowDivider ? 'row-divider' : ''} ${this.alternate ? 'alternate' : ''} ${row.selected ? 'row-selected' : ''} `, key: rowIndex }, this.showSelectCheckBox && (h("td", null, h("dga-checkbox", { name: rowIndex + 'checkboxSelection', value: row.selected, id: rowIndex + 'checkboxSelection', showBorderOnFocusAndFocusOute: false, onChange: event => this.handleSelectedRowChanges(event.target.checked, rowIndex), checked: row.selected }))), this.cells.map((_a, cellIndex) => {
    ...
    static get is() { return "dga-data-table"; }
    static get properties() {
        return {
            "columns": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "IColumn": {
                            "location": "local",
                            "path": "/Users/mohamedaboelezz/projects/Azm-X/platform-code-cross-platform-storybook/packages/core/src/components/dga-data-table/dga-data-table.tsx",
            ...
            "showSelectCheckBox": {
                "type": "boolean",
                "attribute": "show-select-check-box",
                "mutable": false,
                "complexType": {
                    "original": "boolean",
                    "resolved": "boolean",
