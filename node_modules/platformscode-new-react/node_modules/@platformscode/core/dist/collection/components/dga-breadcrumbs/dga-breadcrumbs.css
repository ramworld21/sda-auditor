...
.dga-breadcrumb-item.active {
  color: var(--text-default-disabled);
}
.dga-breadcrumb-item:not(:first-child) {
  display: flex;
  align-items: center;
}
.dga-breadcrumb-item .disabled-link {
  cursor: text;
  color: #9da4ae;
}
.dga-breadcrumb-item .disabled-link:hover {
  text-decoration: none;
}
.dga-breadcrumb-item .disabled-link:hover .link__label {
  text-decoration: none;
}
.dga-breadcrumb-item.ellipsis .link {
  align-items: flex-end;
}
.dga-breadcrumb-icon {
  color: var(--text-default-disabled);
...
:is(html[lang=ar], html[dir=rtl]) .dga-breadcrumb-item:first-child {
  padding-right: 0;
  padding-left: 4px;
}

:is(html[lang=ar], html[dir=rtl]) .dga-breadcrumb-icon {
...
.dga-breadcrumb .link:visited {
  color: var(--link-neutral) !important;
}
.dga-breadcrumb .link.link_empty {
  cursor: text;
  color: #9da4ae !important;
}
.dga-breadcrumb .link.link_empty .link__label:hover {
  text-decoration: none !important;
}
.dga-breadcrumb .link.link_empty:hover {
  text-decoration: none !important;
}
.dga-breadcrumb .link:focus {
...
.dga-breadcrumb--rtl .dga-breadcrumb-dropdown {
  right: 0;
  left: auto;
}